...
public class CheckedFunction10Test {
    ...
    public void shouldCreateFromMethodReference() {
        ...
        assertThat(CheckedFunction10.of(type::methodReference)).isNotNull();
    }

    @Test
    public void shouldLiftPartialFunction() {
        assertThat(CheckedFunction10.lift((o1, o2, o3, o4, o5, o6, o7, o8, o9, o10) -> { while(true); })).isNotNull();
    }
    ...
    public void shouldConstant() throws Throwable {
        final CheckedFunction10<Object, Object, Object, Object, Object, Object, Object, Object, Object, Object, Object> f = CheckedFunction10.constant(6);
    ...
    public void shouldCurry() {
        final CheckedFunction10<Object, Object, Object, Object, Object, Object, Object, Object, Object, Object, Object> f = (o1, o2, o3, o4, o5, o6, o7, o8, o9, o10) -> null;
        final Function1<Object, Function1<Object, Function1<Object, Function1<Object, Function1<Object, Function1<Object, Function1<Object, Function1<Object, Function1<Object, CheckedFunction1<Object, Object>>>>>>>>>> curried = f.curried();
    ...
    public void shouldMemoize() throws Throwable {
        ...
        final CheckedFunction10<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> f = (i1, i2, i3, i4, i5, i6, i7, i8, i9, i10) -> i1 + i2 + i3 + i4 + i5 + i6 + i7 + i8 + i9 + i10 + integer.getAndIncrement();
        final CheckedFunction10<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> memo = f.memoized();
    ...
    public void shouldNotMemoizeAlreadyMemoizedFunction() throws Throwable {
        final CheckedFunction10<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> f = (i1, i2, i3, i4, i5, i6, i7, i8, i9, i10) -> null;
        final CheckedFunction10<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> memo = f.memoized();
    ...
    private static final CheckedFunction10<String, String, String, String, String, String, String, String, String, String, MessageDigest> digest = (s1, s2, s3, s4, s5, s6, s7, s8, s9, s10) -> MessageDigest.getInstance(s1 + s2 + s3 + s4 + s5 + s6 + s7 + s8 + s9 + s10);

    @Test
    public void shouldRecover() {
        Function10<String, String, String, String, String, String, String, String, String, String, MessageDigest> recover = digest.recover(throwable -> (s1, s2, s3, s4, s5, s6, s7, s8, s9, s10) -> null);
    ...
    public void shouldRecoverNonNull() {
        Function10<String, String, String, String, String, String, String, String, String, String, MessageDigest> recover = digest.recover(throwable -> null);
        MessageDigest md5 = recover.apply("M", "D", "5", "", "", "", "", "", "", "");
        assertThat(md5).isNotNull();
        assertThat(md5.getAlgorithm()).isEqualToIgnoringCase("MD5");
        assertThat(md5.getDigestLength()).isEqualTo(16);
        Try<MessageDigest> unknown = Function10.liftTry(recover).apply("U", "n", "k", "n", "o", "w", "n", "", "", "");
    ...
    public void shouldUncheckedWork() {
        Function10<String, String, String, String, String, String, String, String, String, String, MessageDigest> unchecked = digest.unchecked();
    ...
    public void shouldLiftTryPartialFunction() {
        Function10<String, String, String, String, String, String, String, String, String, String, Try<MessageDigest>> liftTry = CheckedFunction10.liftTry(digest);
    ...
    private static final CheckedFunction10<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> recurrent1 = (i1, i2, i3, i4, i5, i6, i7, i8, i9, i10) -> i1 <= 0 ? i1 : CheckedFunction10Test.recurrent2.apply(i1 - 1, i2, i3, i4, i5, i6, i7, i8, i9, i10) + 1;
    private static final CheckedFunction10<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> recurrent2 = CheckedFunction10Test.recurrent1.memoized();
    ...
    public void shouldNarrow() throws Throwable{
        final CheckedFunction10<Number, Number, Number, Number, Number, Number, Number, Number, Number, Number, String> wideFunction = (o1, o2, o3, o4, o5, o6, o7, o8, o9, o10) -> String.format("Numbers are: %s, %s, %s, %s, %s, %s, %s, %s, %s, %s", o1, o2, o3, o4, o5, o6, o7, o8, o9, o10);
        final CheckedFunction10<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, CharSequence> narrowFunction = CheckedFunction10.narrow(wideFunction);
