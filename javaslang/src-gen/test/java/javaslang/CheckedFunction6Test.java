...
public class CheckedFunction6Test {
    ...
    public void shouldRecover() {
        CheckedFunction6<String, String, String, String, String, String, MessageDigest> digest = (s1, s2, s3, s4, s5, s6) -> MessageDigest.getInstance(s1 + s2 + s3 + s4 + s5 + s6);
        Function6<String, String, String, String, String, String, MessageDigest> recover = digest.recover((tuple, throwable) -> null);
