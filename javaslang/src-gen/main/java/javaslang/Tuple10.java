 ...
 * @since 1.1.0
 */
public final class Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> implements Tuple, Comparable<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>, Serializable {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> comparator(Comparator<? super T1> t1Comp, Comparator<? super T2> t2Comp, Comparator<? super T3> t3Comp, Comparator<? super T4> t4Comp, Comparator<? super T5> t5Comp, Comparator<? super T6> t6Comp, Comparator<? super T7> t7Comp, Comparator<? super T8> t8Comp, Comparator<? super T9> t9Comp, Comparator<? super T10> t10Comp) {
        return (Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> & Serializable) (t1, t2) -> {
            ...
            final int check10 = t10Comp.compare(t1._10, t2._10);
            if (check10 != 0) {
                return check10;
            }
    ...
    private static <U1 extends Comparable<? super U1>, U2 extends Comparable<? super U2>, U3 extends Comparable<? super U3>, U4 extends Comparable<? super U4>, U5 extends Comparable<? super U5>, U6 extends Comparable<? super U6>, U7 extends Comparable<? super U7>, U8 extends Comparable<? super U8>, U9 extends Comparable<? super U9>, U10 extends Comparable<? super U10>> int compareTo(Tuple10<?, ?, ?, ?, ?, ?, ?, ?, ?, ?> o1, Tuple10<?, ?, ?, ?, ?, ?, ?, ?, ?, ?> o2) {
        ...
        final int check10 = t1._10.compareTo(t2._10);
        if (check10 != 0) {
            return check10;
        }
    ...
    @Override
    public int compareTo(Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> that) {
        return Tuple10.compareTo(this, that);
    }
     ...
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update1(T1 value) {
        return new Tuple10<>(value, _2, _3, _4, _5, _6, _7, _8, _9, _10);
    }
     ...
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update2(T2 value) {
        return new Tuple10<>(_1, value, _3, _4, _5, _6, _7, _8, _9, _10);
    }
     ...
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update3(T3 value) {
        return new Tuple10<>(_1, _2, value, _4, _5, _6, _7, _8, _9, _10);
    }
     ...
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update4(T4 value) {
        return new Tuple10<>(_1, _2, _3, value, _5, _6, _7, _8, _9, _10);
    }
     ...
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update5(T5 value) {
        return new Tuple10<>(_1, _2, _3, _4, value, _6, _7, _8, _9, _10);
    }
     ...
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update6(T6 value) {
        return new Tuple10<>(_1, _2, _3, _4, _5, value, _7, _8, _9, _10);
    }
     ...
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update7(T7 value) {
        return new Tuple10<>(_1, _2, _3, _4, _5, _6, value, _8, _9, _10);
    }
     ...
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update8(T8 value) {
        return new Tuple10<>(_1, _2, _3, _4, _5, _6, _7, value, _9, _10);
    }
     ...
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update9(T9 value) {
        return new Tuple10<>(_1, _2, _3, _4, _5, _6, _7, _8, value, _10);
    }

    /**
     * Getter of the 10th element of this tuple.
     *
    ...
    /**
     * Sets the 10th element of this tuple to the given {@code value}.
     *
     * @param value the new value
     * @return a copy of this tuple with a new value for the 10th element of this Tuple.
     */
    public Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> update10(T10 value) {
        return new Tuple10<>(_1, _2, _3, _4, _5, _6, _7, _8, _9, value);
    }
     ...
     * @param <U9> new type of the 9th component
     * @param <U10> new type of the 10th component
     * @return A new Tuple of same arity.
     * @throws NullPointerException if {@code mapper} is null
     */
    public <U1, U2, U3, U4, U5, U6, U7, U8, U9, U10> Tuple10<U1, U2, U3, U4, U5, U6, U7, U8, U9, U10> map(Function10<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, Tuple10<U1, U2, U3, U4, U5, U6, U7, U8, U9, U10>> mapper) {
     ...
     * @param f9 the mapper function of the 9th component
     * @param f10 the mapper function of the 10th component
     * @param <U1> new type of the 1st component
     * @param <U2> new type of the 2nd component
     * @param <U3> new type of the 3rd component
     * @param <U4> new type of the 4th component
    ...
    public <U1, U2, U3, U4, U5, U6, U7, U8, U9, U10> Tuple10<U1, U2, U3, U4, U5, U6, U7, U8, U9, U10> map(Function<? super T1, ? extends U1> f1, Function<? super T2, ? extends U2> f2, Function<? super T3, ? extends U3> f3, Function<? super T4, ? extends U4> f4, Function<? super T5, ? extends U5> f5, Function<? super T6, ? extends U6> f6, Function<? super T7, ? extends U7> f7, Function<? super T8, ? extends U8> f8, Function<? super T9, ? extends U9> f9, Function<? super T10, ? extends U10> f10) {
        ...
        Objects.requireNonNull(f9, "f9 is null");
        Objects.requireNonNull(f10, "f10 is null");
        return Tuple.of(f1.apply(_1), f2.apply(_2), f3.apply(_3), f4.apply(_4), f5.apply(_5), f6.apply(_6), f7.apply(_7), f8.apply(_8), f9.apply(_9), f10.apply(_10));
    }
     ...
     */
    public <U> Tuple10<U, T2, T3, T4, T5, T6, T7, T8, T9, T10> map1(Function<? super T1, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_1);
        return Tuple.of(u, _2, _3, _4, _5, _6, _7, _8, _9, _10);
    }
     ...
     */
    public <U> Tuple10<T1, U, T3, T4, T5, T6, T7, T8, T9, T10> map2(Function<? super T2, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_2);
        return Tuple.of(_1, u, _3, _4, _5, _6, _7, _8, _9, _10);
    }
     ...
     */
    public <U> Tuple10<T1, T2, U, T4, T5, T6, T7, T8, T9, T10> map3(Function<? super T3, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_3);
        return Tuple.of(_1, _2, u, _4, _5, _6, _7, _8, _9, _10);
    }
     ...
     */
    public <U> Tuple10<T1, T2, T3, U, T5, T6, T7, T8, T9, T10> map4(Function<? super T4, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_4);
        return Tuple.of(_1, _2, _3, u, _5, _6, _7, _8, _9, _10);
    }
     ...
     */
    public <U> Tuple10<T1, T2, T3, T4, U, T6, T7, T8, T9, T10> map5(Function<? super T5, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_5);
        return Tuple.of(_1, _2, _3, _4, u, _6, _7, _8, _9, _10);
    }
     ...
     */
    public <U> Tuple10<T1, T2, T3, T4, T5, U, T7, T8, T9, T10> map6(Function<? super T6, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_6);
        return Tuple.of(_1, _2, _3, _4, _5, u, _7, _8, _9, _10);
    }
     ...
     */
    public <U> Tuple10<T1, T2, T3, T4, T5, T6, U, T8, T9, T10> map7(Function<? super T7, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_7);
        return Tuple.of(_1, _2, _3, _4, _5, _6, u, _8, _9, _10);
    }
     ...
     */
    public <U> Tuple10<T1, T2, T3, T4, T5, T6, T7, U, T9, T10> map8(Function<? super T8, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_8);
        return Tuple.of(_1, _2, _3, _4, _5, _6, _7, u, _9, _10);
    }

    /**
     * Maps the 9th component of this tuple to a new value.
     *
     * @param <U> new type of the 9th component
     * @param mapper A mapping function
     * @return a new tuple based on this tuple and substituted 9th component
     */
    public <U> Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, U, T10> map9(Function<? super T9, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_9);
        return Tuple.of(_1, _2, _3, _4, _5, _6, _7, _8, u, _10);
    }

    /**
     * Maps the 10th component of this tuple to a new value.
     *
     * @param <U> new type of the 10th component
     * @param mapper A mapping function
     * @return a new tuple based on this tuple and substituted 10th component
     */
    public <U> Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, U> map10(Function<? super T10, ? extends U> mapper) {
        Objects.requireNonNull(mapper, "mapper is null");
        final U u = mapper.apply(_10);
        return Tuple.of(_1, _2, _3, _4, _5, _6, _7, _8, _9, u);
    }
     ...
     */
    public <U> U apply(Function10<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? extends U> f) {
     ...
     * Transforms this tuple to an object of type U.
     *
     * @deprecated Use {@link #apply(Function10)} instead, will be removed in 3.0.0
     * @param f Transformation which creates a new object of type U based on this tuple's contents.
     * @param <U> type of the transformation result
     * @return An object of type U
     * @throws NullPointerException if {@code f} is null
    ...
    public <U> U transform(Function10<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? extends U> f) {
        Objects.requireNonNull(f, "f is null");
        return f.apply(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10);
    }
