...
public interface Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> extends λ<R> {
    ...
    /**
     * Creates a {@code Function10} based on
     * <ul>
     ...
     * @return a {@code Function10}
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> of(Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> methodReference) {
    ...
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Option<R>> lift(Function10<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? extends R> partialFunction) {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Try<R>> liftTry(Function10<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? extends R> partialFunction) {
        return (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) -> Try.of(() -> partialFunction.apply(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10));
    }

    /**
     * Narrows the given {@code Function10<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? extends R>} to {@code Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R>}
     *
     * @param f A {@code Function10}
     * @param <R> return type
     * @param <T1> 1st argument
     * @param <T2> 2nd argument
     * @param <T3> 3rd argument
     ...
     * @param <T9> 9th argument
     * @param <T10> 10th argument
     * @return the given {@code f} instance as narrowed type {@code Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R>}
     */
    @SuppressWarnings("unchecked")
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> narrow(Function10<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? extends R> f) {
        return (Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R>) f;
    }
     ...
     */
    default Function9<T2, T3, T4, T5, T6, T7, T8, T9, T10, R> apply(T1 t1) {
     ...
     * @return a partial application of this function
     */
    default Function8<T3, T4, T5, T6, T7, T8, T9, T10, R> apply(T1 t1, T2 t2) {
     ...
     * @return a partial application of this function
     */
    default Function7<T4, T5, T6, T7, T8, T9, T10, R> apply(T1 t1, T2 t2, T3 t3) {
     ...
     * @return a partial application of this function
     */
    default Function6<T5, T6, T7, T8, T9, T10, R> apply(T1 t1, T2 t2, T3 t3, T4 t4) {
     ...
     * @return a partial application of this function
     */
    default Function5<T6, T7, T8, T9, T10, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) {
     ...
     * @return a partial application of this function
     */
    default Function4<T7, T8, T9, T10, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
     ...
     * @return a partial application of this function
     */
    default Function3<T8, T9, T10, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) {
     ...
     * @return a partial application of this function
     */
    default Function2<T9, T10, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) {
     ...
     * @return a partial application of this function
     */
    default Function1<T10, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9) {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> constant(R value) {
    ...
    @Override
    default Function10<T10, T9, T8, T7, T6, T5, T4, T3, T2, T1, R> reversed() {
        return (t10, t9, t8, t7, t6, t5, t4, t3, t2, t1) -> apply(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10);
    }

    @Override
    default Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>, R> cache = new HashMap<>();
            return (Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> & Memoized) (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10)
                    -> Memoized.of(cache, Tuple.of(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10), tupled());
        }
    }
