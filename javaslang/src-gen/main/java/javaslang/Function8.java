...
public interface Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> extends λ<R> {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> of(Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> methodReference) {
