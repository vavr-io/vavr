...
public interface CheckedFunction3<T1, T2, T3, R> extends λ<R> {
     ...
     */
    static <T1, T2, T3, R> Function3<T1, T2, T3, Option<R>> lift(CheckedFunction3<? super T1, ? super T2, ? super T3, R> partialFunction) {
     ...
     */
    static <T1, T2, T3, R> Function3<T1, T2, T3, Try<R>> liftTry(CheckedFunction3<? super T1, ? super T2, ? super T3, R> partialFunction) {
     ...
     */
    default Function3<T1, T2, T3, R> recover(Function<? super Throwable, ? extends Function3<? super T1, ? super T2, ? super T3, R>> recover) {
        Objects.requireNonNull(recover, "recover is null");
        return (t1, t2, t3) -> {
            try {
                return this.apply(t1, t2, t3);
            } catch (Throwable throwable) {
                final Function3<? super T1, ? super T2, ? super T3, R> func = recover.apply(throwable);
