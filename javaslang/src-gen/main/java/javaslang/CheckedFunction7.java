...
public interface CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, R> extends λ<R> {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, R> Function7<T1, T2, T3, T4, T5, T6, T7, Option<R>> lift(CheckedFunction7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, R> partialFunction) {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, R> Function7<T1, T2, T3, T4, T5, T6, T7, Try<R>> liftTry(CheckedFunction7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, R> partialFunction) {
     ...
     */
    default Function7<T1, T2, T3, T4, T5, T6, T7, R> recover(Function<? super Throwable, ? extends Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, R>> recover) {
        Objects.requireNonNull(recover, "recover is null");
        return (t1, t2, t3, t4, t5, t6, t7) -> {
            try {
                return this.apply(t1, t2, t3, t4, t5, t6, t7);
            } catch (Throwable throwable) {
                final Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, R> func = recover.apply(throwable);
    ...
    /**
     * Return unchecked function that will return this CheckedFunction7 result in correct case and throw runtime exception
    ...
    /**
     * Return unchecked function that will return this CheckedFunction7 result in correct case and throw exception
