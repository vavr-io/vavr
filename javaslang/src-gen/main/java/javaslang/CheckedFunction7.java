...
public interface CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, R> extends λ<R> {
     ...
     * @return a new Function7 that wraps this CheckedFunction7 by throwing a {@code RuntimeException} issued by the given {@code exceptionMapper} in the case of a failure
     */
     ...
     *
     * @return a new Function7 that wraps this CheckedFunction7 by throwing an {@code IllegalStateException} in the case of a failure
     */
