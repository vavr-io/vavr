...
public interface CheckedFunction2<T1, T2, R> extends λ<R> {
     ...
     *
     * @param wideFunction A {@code CheckedFunction2}
     * @param <R> return type
     * @param <T1> 1st argument
     * @param <T2> 2nd argument
     * @return the given {@code wideFunction} instance as narrowed type {@code CheckedFunction2<T1, T2, R>}
     */
    @SuppressWarnings("unchecked")
    static <T1, T2, R> CheckedFunction2<T1, T2, R> narrow(CheckedFunction2<? super T1, ? super T2, ? extends R> wideFunction) {
        return (CheckedFunction2<T1, T2, R>) wideFunction;
    }
