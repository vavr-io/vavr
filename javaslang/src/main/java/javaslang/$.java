...
class $ {
    ...
    @Unapply
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9> Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> Tuple9(Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> tuple9) { return tuple9; }
    @Unapply
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Tuple10(Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> tuple10) { return tuple10; }
