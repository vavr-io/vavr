...
public interface CheckedFunction9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> extends λ<R> {
     ...
     * reference</a> to a {@code CheckedFunction9}.
     *
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> CheckedFunction9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> lift(CheckedFunction9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> methodReference) {
     ...
     */
    default CheckedFunction8<T2, T3, T4, T5, T6, T7, T8, T9, R> apply(T1 t1) throws Throwable {
     ...
     * @throws Throwable if something goes wrong partially applying this function to the given arguments
     */
    default CheckedFunction7<T3, T4, T5, T6, T7, T8, T9, R> apply(T1 t1, T2 t2) throws Throwable {
     ...
     * @throws Throwable if something goes wrong partially applying this function to the given arguments
     */
    default CheckedFunction6<T4, T5, T6, T7, T8, T9, R> apply(T1 t1, T2 t2, T3 t3) throws Throwable {
     ...
     * @throws Throwable if something goes wrong partially applying this function to the given arguments
     */
    default CheckedFunction5<T5, T6, T7, T8, T9, R> apply(T1 t1, T2 t2, T3 t3, T4 t4) throws Throwable {
     ...
     * @throws Throwable if something goes wrong partially applying this function to the given arguments
     */
    default CheckedFunction4<T6, T7, T8, T9, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) throws Throwable {
     ...
     * @throws Throwable if something goes wrong partially applying this function to the given arguments
     */
    default CheckedFunction3<T7, T8, T9, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) throws Throwable {
     ...
     * @throws Throwable if something goes wrong partially applying this function to the given arguments
     */
    default CheckedFunction2<T8, T9, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) throws Throwable {
     ...
     * @throws Throwable if something goes wrong partially applying this function to the given arguments
     */
    default CheckedFunction1<T9, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) throws Throwable {
