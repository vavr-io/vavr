 ...
 */
@FunctionalInterface
public interface Consumer0 extends λ<Void> {
    ...
    @Override
    default Consumer0 curried() {
        return this;
    }

    @Override
    default Consumer1<Tuple0> tupled() {
        return t -> accept();
    }

    @Override
    default Consumer0 reversed() {
        return this;
    }

    /**
     * Returns a composed function that first applies this Consumer0 to the given arguments and then applies
     ...
     * this Consumer0 to the same arguments.
     *
     ...
     */
    default Consumer0 compose(Consumer0 before) {
