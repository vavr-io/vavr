 ...
 */
@FunctionalInterface
public interface Consumer8<T1, T2, T3, T4, T5, T6, T7, T8> extends λ<Void> {
    ...
    @Override
    default Function1<T1, Function1<T2, Function1<T3, Function1<T4, Function1<T5, Function1<T6, Function1<T7, Consumer1<T8>>>>>>>> curried() {
        return t1 -> t2 -> t3 -> t4 -> t5 -> t6 -> t7 -> t8 -> accept(t1, t2, t3, t4, t5, t6, t7, t8);
    }

    @Override
    default Consumer1<Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>> tupled() {
        return t -> accept(t._1, t._2, t._3, t._4, t._5, t._6, t._7, t._8);
    }

    @Override
    default Consumer8<T8, T7, T6, T5, T4, T3, T2, T1> reversed() {
        return (t8, t7, t6, t5, t4, t3, t2, t1) -> accept(t1, t2, t3, t4, t5, t6, t7, t8);
    }

    /**
     * Returns a composed function that first applies this Consumer8 to the given arguments and then applies
     ...
     * this Consumer8 to the same arguments.
     *
     ...
     */
    default Consumer8<T1, T2, T3, T4, T5, T6, T7, T8> compose(Consumer8<T1, T2, T3, T4, T5, T6, T7, T8> before) {
