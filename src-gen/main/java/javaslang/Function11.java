...
public interface Function11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, R> extends λ<R> {
     ...
     * reference</a> to a {@code Function11}.
     *
     ...
     * @return a {@code Function11}
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, R> Function11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, R> lift(Function11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, R> methodReference) {
