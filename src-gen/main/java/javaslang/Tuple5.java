...
public final class Tuple5<T1, T2, T3, T4, T5> implements Tuple, Comparable<Tuple5<T1, T2, T3, T4, T5>>, Serializable {
    ...
    public <U1, U2, U3, U4, U5> Tuple5<U1, U2, U3, U4, U5> flatMap(Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, Tuple5<U1, U2, U3, U4, U5>> f) {
    ...
    @Override
    public Seq<?> toSeq() {
        return List.ofAll(_1, _2, _3, _4, _5);
    }
