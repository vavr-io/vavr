...
/**
 * <p>Defines a 8-ary Functor by generalizing the map function which maps 8 elements.</p>
 *
 * All instances of the Functor8 interface should obey the two functor laws:
 * <ul>
 *     <li>{@code m.map(a -> a) ≡ m}</li>
 *     <li>{@code m.map(f.compose(g)) ≡ m.map(g).map(f)}</li>
 * </ul>
 * where {@code f, g ∈ Tuple8 → Tuple8}.
 *
...
public interface Functor8<T1, T2, T3, T4, T5, T6, T7, T8> {
     ...
     * @param f a 8-ary Function which maps the components of this Functor
     * @return a new Functor8 with 8 component types U1, U2, U3, U4, U5, U6, U7, U8.
     */
    <U1, U2, U3, U4, U5, U6, U7, U8> Functor8<U1, U2, U3, U4, U5, U6, U7, U8> map(Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, Tuple8<? extends U1, ? extends U2, ? extends U3, ? extends U4, ? extends U5, ? extends U6, ? extends U7, ? extends U8>> f);
