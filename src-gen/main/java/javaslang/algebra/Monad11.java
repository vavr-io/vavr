 ...
 * given
 * <ul>
 * <li>an object {@code m} of type {@code HigherKinded11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, M>}</li>
 * <li>an object {@code a} consisting of values of type {@code T1 ✕ T2 ✕ T3 ✕ T4 ✕ T5 ✕ T6 ✕ T7 ✕ T8 ✕ T9 ✕ T10 ✕ T11}</li>
 * <li>a constructor {@code unit} taking an {@code a} and producing an object of type {@code M}</li>
 * <li>a function {@code f: T1 ✕ T2 ✕ T3 ✕ T4 ✕ T5 ✕ T6 ✕ T7 ✕ T8 ✕ T9 ✕ T10 ✕ T11 → M}
 * </ul>
 *
...
public interface Monad11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, M extends HigherKinded11<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, M>> extends Functor11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>, HigherKinded11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, M> {
    ...
    /**
     * Returns the result of applying f to M's values of type T1,…,T11 and returns a new M with
     * values of type U1,…,U11.
     *
