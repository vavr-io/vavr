...
/**
 * <p>The <em>HigherKinded8</em> type declares a generic type constructor, which consists of
 * 8 inner/component types and one outer/container type.</p>
 * <p>HigherKinded8 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple8} implements HigherKind8 in order to override
 * {@link javaslang.algebra.Monad8#flatMap(javaslang.Function8)}.</p>
 *
 * See also
 * <ul>
...
public interface HigherKinded8<T1, T2, T3, T4, T5, T6, T7, T8, TYPE extends HigherKinded8<?, ?, ?, ?, ?, ?, ?, ?, TYPE>> {
