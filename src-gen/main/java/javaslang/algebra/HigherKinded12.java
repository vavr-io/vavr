...
/**
 * <p>The <em>HigherKinded12</em> type declares a generic type constructor, which consists of
 * 12 inner/component types and one outer/container type.</p>
 * <p>HigherKinded12 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple12} implements HigherKind12 in order to override
 * {@link javaslang.algebra.Monad12#flatMap(javaslang.Function12)}.</p>
 *
 * See also
 * <ul>
...
public interface HigherKinded12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TYPE extends HigherKinded12<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TYPE>> {
