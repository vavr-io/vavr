...
/**
 * <p>The <em>HigherKinded14</em> type declares a generic type constructor, which consists of
 * 14 inner/component types and one outer/container type.</p>
 * <p>HigherKinded14 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple14} implements HigherKind14 in order to override
 * {@link javaslang.algebra.Monad14#flatMap(javaslang.Function14)}.</p>
 *
 * See also
 * <ul>
...
public interface HigherKinded14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TYPE extends HigherKinded14<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TYPE>> {
