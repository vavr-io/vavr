...
/**
 * <p>The <em>HigherKinded5</em> type declares a generic type constructor, which consists of
 * 5 inner/component types and one outer/container type.</p>
 * <p>HigherKinded5 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple5} implements HigherKind5 in order to override
 * {@link javaslang.algebra.Monad5#flatMap(javaslang.Function5)}.</p>
 *
 * See also
 * <ul>
