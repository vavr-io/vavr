 ...
 * given
 * <ul>
 * <li>an object {@code m} of type {@code HigherKinded14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, M>}</li>
 * <li>an object {@code a} consisting of values of type {@code T1 ✕ T2 ✕ T3 ✕ T4 ✕ T5 ✕ T6 ✕ T7 ✕ T8 ✕ T9 ✕ T10 ✕ T11 ✕ T12 ✕ T13 ✕ T14}</li>
 * <li>a constructor {@code unit} taking an {@code a} and producing an object of type {@code M}</li>
 * <li>a function {@code f: T1 ✕ T2 ✕ T3 ✕ T4 ✕ T5 ✕ T6 ✕ T7 ✕ T8 ✕ T9 ✕ T10 ✕ T11 ✕ T12 ✕ T13 ✕ T14 → M}
 * </ul>
 *
 ...
 * @since 1.1.0
 */
public interface Monad14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, M extends HigherKinded14<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, M>> extends Functor14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>, HigherKinded14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, M> {

    /**
     * Returns the result of applying f to M's values of type T1,…,T14 and returns a new M with
     * values of type U1,…,U14.
     *
