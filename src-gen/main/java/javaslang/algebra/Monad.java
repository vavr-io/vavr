...
public interface Monad<M extends Kind1<M, ?>, T> extends Kind1<M, T>, Functor<T> {
    ...
    static <T, R> Lifted1<T, R> lift(Function<? super T, ? extends R> f) {
        return new Lifted1<T, R>() {
            @Override
            public <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T> mT) {
                return mT.map(f);
            }
        };
    }
    ...
    static <T1, T2, R> Lifted2<T1, T2, R> lift(BiFunction<? super T1, ? super T2, ? extends R> f) {
        return new Lifted2<T1, T2, R>() {
            @Override
            public <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> mT1, Monad<M, T2> mT2) {
                return mT1.flatMapM(t1 ->
    ...
    static <T1, T2, T3, R> Lifted3<T1, T2, T3, R> lift(Function3<? super T1, ? super T2, ? super T3, ? extends R> f) {
        return new Lifted3<T1, T2, T3, R>() {
            @Override
            public <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> mT1, Monad<M, T2> mT2, Monad<M, T3> mT3) {
                                                 return mT1.flatMapM(t1 ->
                mT2.flatMapM(t2 ->
    ...
    static <T1, T2, T3, T4, R> Lifted4<T1, T2, T3, T4, R> lift(Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> f) {
        return new Lifted4<T1, T2, T3, T4, R>() {
            @Override
            public <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> mT1, Monad<M, T2> mT2, Monad<M, T3> mT3, Monad<M, T4> mT4) {
                                                 return mT1.flatMapM(t1 ->
                mT2.flatMapM(t2 ->
                mT3.flatMapM(t3 ->
    ...
    static <T1, T2, T3, T4, T5, R> Lifted5<T1, T2, T3, T4, T5, R> lift(Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> f) {
        return new Lifted5<T1, T2, T3, T4, T5, R>() {
            @Override
            public <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> mT1, Monad<M, T2> mT2, Monad<M, T3> mT3, Monad<M, T4> mT4, Monad<M, T5> mT5) {
                                                 return mT1.flatMapM(t1 ->
                mT2.flatMapM(t2 ->
                mT3.flatMapM(t3 ->
                mT4.flatMapM(t4 ->
    ...
    static <T1, T2, T3, T4, T5, T6, R> Lifted6<T1, T2, T3, T4, T5, T6, R> lift(Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends R> f) {
        return new Lifted6<T1, T2, T3, T4, T5, T6, R>() {
            @Override
            public <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> mT1, Monad<M, T2> mT2, Monad<M, T3> mT3, Monad<M, T4> mT4, Monad<M, T5> mT5, Monad<M, T6> mT6) {
                                                 return mT1.flatMapM(t1 ->
                mT2.flatMapM(t2 ->
                mT3.flatMapM(t3 ->
                mT4.flatMapM(t4 ->
    ...
    static <T1, T2, T3, T4, T5, T6, T7, R> Lifted7<T1, T2, T3, T4, T5, T6, T7, R> lift(Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> f) {
        return new Lifted7<T1, T2, T3, T4, T5, T6, T7, R>() {
            @Override
            public <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> mT1, Monad<M, T2> mT2, Monad<M, T3> mT3, Monad<M, T4> mT4, Monad<M, T5> mT5, Monad<M, T6> mT6, Monad<M, T7> mT7) {
                                                 return mT1.flatMapM(t1 ->
                mT2.flatMapM(t2 ->
                mT3.flatMapM(t3 ->
                mT4.flatMapM(t4 ->
    ...
    static <T1, T2, T3, T4, T5, T6, T7, T8, R> Lifted8<T1, T2, T3, T4, T5, T6, T7, T8, R> lift(Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> f) {
        return new Lifted8<T1, T2, T3, T4, T5, T6, T7, T8, R>() {
            @Override
            public <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> mT1, Monad<M, T2> mT2, Monad<M, T3> mT3, Monad<M, T4> mT4, Monad<M, T5> mT5, Monad<M, T6> mT6, Monad<M, T7> mT7, Monad<M, T8> mT8) {
                                                 return mT1.flatMapM(t1 ->
                mT2.flatMapM(t2 ->
                mT3.flatMapM(t3 ->
                mT4.flatMapM(t4 ->
    ...
    interface Lifted1<T, R> {
        <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T> mT);
    }
    ...
    interface Lifted2<T1, T2, R> {
        <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> m1, Monad<M, T2> m2);
    }
    ...
    interface Lifted3<T1, T2, T3, R> {
        <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> m1, Monad<M, T2> m2, Monad<M, T3> m3);
    }
    ...
    interface Lifted4<T1, T2, T3, T4, R> {
        <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> m1, Monad<M, T2> m2, Monad<M, T3> m3, Monad<M, T4> m4);
    }
    ...
    interface Lifted5<T1, T2, T3, T4, T5, R> {
        <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> m1, Monad<M, T2> m2, Monad<M, T3> m3, Monad<M, T4> m4, Monad<M, T5> m5);
    }
    ...
    interface Lifted6<T1, T2, T3, T4, T5, T6, R> {
        <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> m1, Monad<M, T2> m2, Monad<M, T3> m3, Monad<M, T4> m4, Monad<M, T5> m5, Monad<M, T6> m6);
    }
    ...
    interface Lifted7<T1, T2, T3, T4, T5, T6, T7, R> {
        <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> m1, Monad<M, T2> m2, Monad<M, T3> m3, Monad<M, T4> m4, Monad<M, T5> m5, Monad<M, T6> m6, Monad<M, T7> m7);
    }
    ...
    interface Lifted8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
        <M extends Monad<M, ?>> Monad<M, R> apply(Monad<M, T1> m1, Monad<M, T2> m2, Monad<M, T3> m3, Monad<M, T4> m4, Monad<M, T5> m5, Monad<M, T6> m6, Monad<M, T7> m7, Monad<M, T8> m8);
    }
}