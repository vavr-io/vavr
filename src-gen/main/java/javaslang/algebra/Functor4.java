...
public interface Functor4<T1, T2, T3, T4> {
    ...
    default <U1, U2, U3, U4> Functor4<U1, U2, U3, U4> map(Function1<? super T1, ? extends U1> f1, Function1<? super T2, ? extends U2> f2, Function1<? super T3, ? extends U3> f3, Function1<? super T4, ? extends U4> f4) {
