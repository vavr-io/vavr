...
/**
 * <p>The <em>HigherKinded11</em> type declares a generic type constructor, which consists of
 * 11 inner/component types and one outer/container type.</p>
 * <p>HigherKinded11 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple11} implements HigherKind11 in order to override
 * {@link javaslang.algebra.Monad11#flatMap(javaslang.Function11)}.</p>
 *
 * See also
 * <ul>
...
public interface HigherKinded11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TYPE extends HigherKinded11<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TYPE>> {
