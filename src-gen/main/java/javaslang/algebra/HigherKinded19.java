...
/**
 * <p>The <em>HigherKinded19</em> type declares a generic type constructor, which consists of
 * 19 inner/component types and one outer/container type.</p>
 * <p>HigherKinded19 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple19} implements HigherKind19 in order to override
 * {@link javaslang.algebra.Monad19#flatMap(javaslang.Function19)}.</p>
 *
 * See also
 * <ul>
