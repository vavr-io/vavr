...
/**
 * Defines a 1-ary CheckedMonad by generalizing the flatMap function.
 * <p>
 * All instances of the CheckedMonad1 interface should obey the three control laws:
 * <ul>
 ...
 *
 * @param <T1> 1st component type of this checked monad
 * @param <M> placeholder for the type that implements this
 * @since 1.1.0
 */
public interface CheckedMonad1<T1, M extends HigherKinded1<?, M>> extends CheckedFunctor1<T1>, HigherKinded1<T1, M> {
     ...
     * @param f a checked function that maps the monad values to a new monad instance
     * @return a new CheckedMonad1 instance of component types U1,…,U1 and container type M
     */
    <U1, MONAD extends HigherKinded1<U1, M>> CheckedMonad1<U1, M> flatMap(CheckedFunction1<? super T1, MONAD> f);

    @Override
    <U1> CheckedMonad1<U1, M> map(CheckedFunction1<? super T1, ? extends U1> f);
