...
/**
 * <p>The <em>HigherKinded7</em> type declares a generic type constructor, which consists of
 * 7 inner/component types and one outer/container type.</p>
 * <p>HigherKinded7 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple7} implements HigherKind7 in order to override
 * {@link javaslang.algebra.Monad7#flatMap(javaslang.Function7)}.</p>
 *
 * See also
 * <ul>
...
public interface HigherKinded7<T1, T2, T3, T4, T5, T6, T7, TYPE extends HigherKinded7<?, ?, ?, ?, ?, ?, ?, TYPE>> {
