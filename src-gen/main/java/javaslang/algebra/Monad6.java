 ...
 * given
 * <ul>
 * <li>an object {@code m} of type {@code HigherKinded6<T1, T2, T3, T4, T5, T6, M>}</li>
 * <li>an object {@code a} consisting of values of type {@code T1 ✕ T2 ✕ T3 ✕ T4 ✕ T5 ✕ T6}</li>
 * <li>a constructor {@code unit} taking an {@code a} and producing an object of type {@code M}</li>
 * <li>a function {@code f: T1 ✕ T2 ✕ T3 ✕ T4 ✕ T5 ✕ T6 → M}
 * </ul>
 *
...
public interface Monad6<T1, T2, T3, T4, T5, T6, M extends HigherKinded6<?, ?, ?, ?, ?, ?, M>> extends Functor6<T1, T2, T3, T4, T5, T6>, HigherKinded6<T1, T2, T3, T4, T5, T6, M> {
    ...
    /**
     * Returns the result of applying f to M's values of type T1,…,T6 and returns a new M with
     * values of type U1,…,U6.
     *
    ...
    @Override
    <U1, U2, U3, U4, U5, U6> Monad6<U1, U2, U3, U4, U5, U6, M> map(Function1<? super T1, ? extends U1> f1, Function1<? super T2, ? extends U2> f2, Function1<? super T3, ? extends U3> f3, Function1<? super T4, ? extends U4> f4, Function1<? super T5, ? extends U5> f5, Function1<? super T6, ? extends U6> f6);
}