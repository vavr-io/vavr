 ...
 * given
 * <ul>
 * <li>an object {@code m} of type {@code HigherKinded2<T1, T2, M>}</li>
 * <li>an object {@code a} consisting of values of type {@code T1 ✕ T2}</li>
 * <li>a constructor {@code unit} taking an {@code a} and producing an object of type {@code M}</li>
 * <li>a function {@code f: T1 ✕ T2 → M}
 * </ul>
 *
...
public interface Monad2<T1, T2, M extends HigherKinded2<?, ?, M>> extends Functor2<T1, T2>, HigherKinded2<T1, T2, M> {
    ...
    /**
     * Returns the result of applying f to M's values of type T1,…,T2 and returns a new M with
     * values of type U1,…,U2.
     *
    ...
    @Override
    <U1, U2> Monad2<U1, U2, M> map(Function1<? super T1, ? extends U1> f1, Function1<? super T2, ? extends U2> f2);
}