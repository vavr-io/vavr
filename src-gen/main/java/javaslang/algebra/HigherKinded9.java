...
/**
 * <p>The <em>HigherKinded9</em> type declares a generic type constructor, which consists of
 * 9 inner/component types and one outer/container type.</p>
 * <p>HigherKinded9 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple9} implements HigherKind9 in order to override
 * {@link javaslang.algebra.Monad9#flatMap(javaslang.Function9)}.</p>
 *
 * See also
 * <ul>
...
public interface HigherKinded9<T1, T2, T3, T4, T5, T6, T7, T8, T9, TYPE extends HigherKinded9<?, ?, ?, ?, ?, ?, ?, ?, ?, TYPE>> {
