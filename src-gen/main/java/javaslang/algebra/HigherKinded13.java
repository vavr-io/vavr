...
/**
 * <p>The <em>HigherKinded13</em> type declares a generic type constructor, which consists of
 * 13 inner/component types and one outer/container type.</p>
 * <p>HigherKinded13 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple13} implements HigherKind13 in order to override
 * {@link javaslang.algebra.Monad13#flatMap(javaslang.Function13)}.</p>
 *
 * See also
 * <ul>
...
public interface HigherKinded13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TYPE extends HigherKinded13<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TYPE>> {
