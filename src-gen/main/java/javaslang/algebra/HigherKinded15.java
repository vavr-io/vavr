...
/**
 * <p>The <em>HigherKinded15</em> type declares a generic type constructor, which consists of
 * 15 inner/component types and one outer/container type.</p>
 * <p>HigherKinded15 is used to approximately simulate higher-kinded/higher-order types, which cannot be
 * expressed with Java.</p>
 * <p>Example: {@linkplain javaslang.Tuple15} implements HigherKind15 in order to override
 * {@link javaslang.algebra.Monad15#flatMap(javaslang.Function15)}.</p>
 *
 * See also
 * <ul>
...
public interface HigherKinded15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TYPE extends HigherKinded15<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TYPE>> {
