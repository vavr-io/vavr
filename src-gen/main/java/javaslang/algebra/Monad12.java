...
public interface Monad12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, M extends HigherKinded12<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, M>> extends Functor12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>, HigherKinded12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, M> {
    ...
    <U1, U2, U3, U4, U5, U6, U7, U8, U9, U10, U11, U12, MONAD extends HigherKinded12<U1, U2, U3, U4, U5, U6, U7, U8, U9, U10, U11, U12, M>> Monad12<U1, U2, U3, U4, U5, U6, U7, U8, U9, U10, U11, U12, M> flatMap(javaslang.Function12<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? super T11, ? super T12, MONAD> f);
}