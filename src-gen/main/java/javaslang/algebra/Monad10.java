 ...
 * given
 * <ul>
 * <li>an object {@code m} of type {@code HigherKinded10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, M>}</li>
 * <li>an object {@code a} consisting of values of type {@code T1 ✕ T2 ✕ T3 ✕ T4 ✕ T5 ✕ T6 ✕ T7 ✕ T8 ✕ T9 ✕ T10}</li>
 * <li>a constructor {@code unit} taking an {@code a} and producing an object of type {@code M}</li>
 * <li>a function {@code f: T1 ✕ T2 ✕ T3 ✕ T4 ✕ T5 ✕ T6 ✕ T7 ✕ T8 ✕ T9 ✕ T10 → M}
 * </ul>
 *
...
public interface Monad10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, M extends HigherKinded10<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, M>> extends Functor10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>, HigherKinded10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, M> {
    ...
    /**
     * Returns the result of applying f to M's values of type T1,…,T10 and returns a new M with
     * values of type U1,…,U10.
     *
    ...
    @Override
    <U1, U2, U3, U4, U5, U6, U7, U8, U9, U10> Monad10<U1, U2, U3, U4, U5, U6, U7, U8, U9, U10, M> map(Function10<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, Tuple10<? extends U1, ? extends U2, ? extends U3, ? extends U4, ? extends U5, ? extends U6, ? extends U7, ? extends U8, ? extends U9, ? extends U10>> f);

    @Override
    <U1, U2, U3, U4, U5, U6, U7, U8, U9, U10> Monad10<U1, U2, U3, U4, U5, U6, U7, U8, U9, U10, M> map(Function1<? super T1, ? extends U1> f1, Function1<? super T2, ? extends U2> f2, Function1<? super T3, ? extends U3> f3, Function1<? super T4, ? extends U4> f4, Function1<? super T5, ? extends U5> f5, Function1<? super T6, ? extends U6> f6, Function1<? super T7, ? extends U7> f7, Function1<? super T8, ? extends U8> f8, Function1<? super T9, ? extends U9> f9, Function1<? super T10, ? extends U10> f10);
}