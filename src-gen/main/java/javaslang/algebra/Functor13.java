...
/**
 * <p>Defines a 13-ary Functor by generalizing the map function which maps 13 elements.</p>
 *
 * All instances of the Functor13 interface should obey the two functor laws:
 * <ul>
 *     <li>{@code m.map(a -> a) ≡ m}</li>
 *     <li>{@code m.map(f.compose(g)) ≡ m.map(g).map(f)}</li>
 * </ul>
 * where {@code f, g ∈ Tuple13 → Tuple13}.
 *
...
public interface Functor13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> {
     ...
     * @param f a 13-ary Function which maps the components of this Functor
     * @return a new Functor13 with 13 component types U1, U2, U3, U4, U5, U6, U7, U8, U9, U10, U11, U12, U13.
     */
    <U1, U2, U3, U4, U5, U6, U7, U8, U9, U10, U11, U12, U13> Functor13<U1, U2, U3, U4, U5, U6, U7, U8, U9, U10, U11, U12, U13> map(Function13<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? super T11, ? super T12, ? super T13, Tuple13<? extends U1, ? extends U2, ? extends U3, ? extends U4, ? extends U5, ? extends U6, ? extends U7, ? extends U8, ? extends U9, ? extends U10, ? extends U11, ? extends U12, ? extends U13>> f);
