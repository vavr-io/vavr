...
public interface Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> extends λ<R> {
     ...
     * expression</a> to a {@code Function8}.
     * <p>
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> lift(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> methodReference) {
     ...
     */
    default boolean isApplicableToTypes(Class<?> type1, Class<?> type2, Class<?> type3, Class<?> type4, Class<?> type5, Class<?> type6, Class<?> type7, Class<?> type8) {
    ...
    default Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> memoized() {
        if (this instanceof Memoized) {
            ...
            return (Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> & Memoized) (t1, t2, t3, t4, t5, t6, t7, t8) -> cache.computeIfAbsent(Tuple.of(t1, t2, t3, t4, t5, t6, t7, t8), tupled::apply);
        }
    }
    ...
    /**
     * Represents the type of a {@code Function} which consists of 8 <em>parameter 8 types</em>
