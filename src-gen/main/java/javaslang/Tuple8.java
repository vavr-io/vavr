...
public class Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> implements Tuple, Monad8<T1, T2, T3, T4, T5, T6, T7, T8, Tuple8<?, ?, ?, ?, ?, ?, ?, ?>> {
    ...
    @Override
    public <U1, U2, U3, U4, U5, U6, U7, U8, MONAD extends HigherKinded8<U1, U2, U3, U4, U5, U6, U7, U8, Tuple8<?, ?, ?, ?, ?, ?, ?, ?>>> Tuple8<U1, U2, U3, U4, U5, U6, U7, U8> flatMap(javaslang.Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, MONAD> f) {
        return (Tuple8<U1, U2, U3, U4, U5, U6, U7, U8>) f.apply(_1, _2, _3, _4, _5, _6, _7, _8);
    }

    @SuppressWarnings("unchecked")
    @Override
    public <U1, U2, U3, U4, U5, U6, U7, U8> Tuple8<U1, U2, U3, U4, U5, U6, U7, U8> map(javaslang.Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, Tuple8<? extends U1, ? extends U2, ? extends U3, ? extends U4, ? extends U5, ? extends U6, ? extends U7, ? extends U8>> f) {
