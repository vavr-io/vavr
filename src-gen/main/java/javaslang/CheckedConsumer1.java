 ...
 */
@FunctionalInterface
public interface CheckedConsumer1<T1> extends λ<Void> {
    ...
    @Override
    default CheckedConsumer1<T1> curried() {
        return this;
    }

    @Override
    default CheckedConsumer1<Tuple1<T1>> tupled() {
        return t -> accept(t._1);
    }

    @Override
    default CheckedConsumer1<T1> reversed() {
        return this;
    }

    /**
     * Returns a composed function that first applies this CheckedConsumer1 to the given arguments and then applies
     ...
     */
    default CheckedConsumer1<T1> andThen(CheckedConsumer1<T1> after) {
     ...
     * this CheckedConsumer1 to the same arguments.
     *
     ...
     */
    default CheckedConsumer1<T1> compose(CheckedConsumer1<T1> before) {
