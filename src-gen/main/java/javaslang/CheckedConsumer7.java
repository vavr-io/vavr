 ...
 */
@FunctionalInterface
public interface CheckedConsumer7<T1, T2, T3, T4, T5, T6, T7> extends λ<Void> {
    ...
    @Override
    default CheckedFunction1<T1, CheckedFunction1<T2, CheckedFunction1<T3, CheckedFunction1<T4, CheckedFunction1<T5, CheckedFunction1<T6, CheckedConsumer1<T7>>>>>>> curried() {
        return t1 -> t2 -> t3 -> t4 -> t5 -> t6 -> t7 -> accept(t1, t2, t3, t4, t5, t6, t7);
    }

    @Override
    default CheckedConsumer1<Tuple7<T1, T2, T3, T4, T5, T6, T7>> tupled() {
        return t -> accept(t._1, t._2, t._3, t._4, t._5, t._6, t._7);
    }

    @Override
    default CheckedConsumer7<T7, T6, T5, T4, T3, T2, T1> reversed() {
        return (t7, t6, t5, t4, t3, t2, t1) -> accept(t1, t2, t3, t4, t5, t6, t7);
    }

    /**
     * Returns a composed function that first applies this CheckedConsumer7 to the given arguments and then applies
     ...
     */
    default CheckedConsumer7<T1, T2, T3, T4, T5, T6, T7> andThen(CheckedConsumer7<T1, T2, T3, T4, T5, T6, T7> after) {
     ...
     * this CheckedConsumer7 to the same arguments.
     *
     ...
     */
    default CheckedConsumer7<T1, T2, T3, T4, T5, T6, T7> compose(CheckedConsumer7<T1, T2, T3, T4, T5, T6, T7> before) {
