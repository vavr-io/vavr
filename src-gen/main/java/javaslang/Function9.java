...
public interface Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> extends λ<R> {
     ...
     * reference</a> to a {@code Function9}.
     *
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> lift(Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> methodReference) {
