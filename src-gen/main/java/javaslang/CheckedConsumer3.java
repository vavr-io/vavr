 ...
 */
@FunctionalInterface
public interface CheckedConsumer3<T1, T2, T3> extends λ<Void> {
    ...
    @Override
    default CheckedFunction1<T1, CheckedFunction1<T2, CheckedConsumer1<T3>>> curried() {
    ...
    @Override
    default CheckedConsumer3<T3, T2, T1> reversed() {
        return (t3, t2, t1) -> accept(t1, t2, t3);
    }

    /**
     * Returns a composed function that first applies this CheckedConsumer3 to the given arguments and then applies
     ...
     */
    default CheckedConsumer3<T1, T2, T3> andThen(CheckedConsumer3<T1, T2, T3> after) {
     ...
     * this CheckedConsumer3 to the same arguments.
     *
     ...
     */
    default CheckedConsumer3<T1, T2, T3> compose(CheckedConsumer3<T1, T2, T3> before) {
