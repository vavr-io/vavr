...
public interface CheckedFunction10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> extends λ<R> {
     ...
     * reference</a> to a {@code CheckedFunction10}.
     *
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> CheckedFunction10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> lift(CheckedFunction10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> methodReference) {
