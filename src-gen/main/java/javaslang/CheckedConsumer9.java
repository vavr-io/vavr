 ...
 */
@FunctionalInterface
public interface CheckedConsumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends λ<Void> {
    ...
    @Override
    default CheckedFunction1<T1, CheckedFunction1<T2, CheckedFunction1<T3, CheckedFunction1<T4, CheckedFunction1<T5, CheckedFunction1<T6, CheckedFunction1<T7, CheckedFunction1<T8, CheckedConsumer1<T9>>>>>>>>> curried() {
        return t1 -> t2 -> t3 -> t4 -> t5 -> t6 -> t7 -> t8 -> t9 -> accept(t1, t2, t3, t4, t5, t6, t7, t8, t9);
    }

    @Override
    default CheckedConsumer1<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> tupled() {
        return t -> accept(t._1, t._2, t._3, t._4, t._5, t._6, t._7, t._8, t._9);
    }

    @Override
    default CheckedConsumer9<T9, T8, T7, T6, T5, T4, T3, T2, T1> reversed() {
        return (t9, t8, t7, t6, t5, t4, t3, t2, t1) -> accept(t1, t2, t3, t4, t5, t6, t7, t8, t9);
    }

    /**
     * Returns a composed function that first applies this CheckedConsumer9 to the given arguments and then applies
     ...
     */
    default CheckedConsumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9> andThen(CheckedConsumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9> after) {
     ...
     * this CheckedConsumer9 to the same arguments.
     *
     ...
     */
    default CheckedConsumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9> compose(CheckedConsumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9> before) {
