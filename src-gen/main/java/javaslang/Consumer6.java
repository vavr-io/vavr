 ...
 */
@FunctionalInterface
public interface Consumer6<T1, T2, T3, T4, T5, T6> extends λ<Void> {
    ...
    @Override
    default Function1<T1, Function1<T2, Function1<T3, Function1<T4, Function1<T5, Consumer1<T6>>>>>> curried() {
        return t1 -> t2 -> t3 -> t4 -> t5 -> t6 -> accept(t1, t2, t3, t4, t5, t6);
    }

    @Override
    default Consumer1<Tuple6<T1, T2, T3, T4, T5, T6>> tupled() {
        return t -> accept(t._1, t._2, t._3, t._4, t._5, t._6);
    }

    @Override
    default Consumer6<T6, T5, T4, T3, T2, T1> reversed() {
        return (t6, t5, t4, t3, t2, t1) -> accept(t1, t2, t3, t4, t5, t6);
    }

    /**
     * Returns a composed function that first applies this Consumer6 to the given arguments and then applies
     ...
     * this Consumer6 to the same arguments.
     *
     ...
     */
    default Consumer6<T1, T2, T3, T4, T5, T6> compose(Consumer6<T1, T2, T3, T4, T5, T6> before) {
