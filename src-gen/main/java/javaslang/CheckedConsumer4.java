 ...
 */
@FunctionalInterface
public interface CheckedConsumer4<T1, T2, T3, T4> extends λ<Void> {
    ...
    @Override
    default CheckedFunction1<T1, CheckedFunction1<T2, CheckedFunction1<T3, CheckedConsumer1<T4>>>> curried() {
        return t1 -> t2 -> t3 -> t4 -> accept(t1, t2, t3, t4);
    }

    @Override
    default CheckedConsumer1<Tuple4<T1, T2, T3, T4>> tupled() {
        return t -> accept(t._1, t._2, t._3, t._4);
    }

    @Override
    default CheckedConsumer4<T4, T3, T2, T1> reversed() {
        return (t4, t3, t2, t1) -> accept(t1, t2, t3, t4);
    }

    /**
     * Returns a composed function that first applies this CheckedConsumer4 to the given arguments and then applies
     ...
     */
    default CheckedConsumer4<T1, T2, T3, T4> andThen(CheckedConsumer4<T1, T2, T3, T4> after) {
     ...
     * this CheckedConsumer4 to the same arguments.
     *
     ...
     */
    default CheckedConsumer4<T1, T2, T3, T4> compose(CheckedConsumer4<T1, T2, T3, T4> before) {
