...
@FunctionalInterface
public interface X9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> extends Lambda<R> {
    ...
    @Override
    default X1<T1, X1<T2, X1<T3, X1<T4, X1<T5, X1<T6, X1<T7, X1<T8, X1<T9, R>>>>>>>>> curried() {
        return t1 -> t2 -> t3 -> t4 -> t5 -> t6 -> t7 -> t8 -> t9 -> apply(t1, t2, t3, t4, t5, t6, t7, t8, t9);
    }

    @Override
    default X1<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>, R> tupled() {
        return t -> apply(t._1, t._2, t._3, t._4, t._5, t._6, t._7, t._8, t._9);
    }

    @Override
    default X9<T9, T8, T7, T6, T5, T4, T3, T2, T1, R> reversed() {
        return (t9, t8, t7, t6, t5, t4, t3, t2, t1) -> apply(t1, t2, t3, t4, t5, t6, t7, t8, t9);
    }

    @Override
    default <V> X9<T1, T2, T3, T4, T5, T6, T7, T8, T9, V> andThen(Function<? super R, ? extends V> after) {
