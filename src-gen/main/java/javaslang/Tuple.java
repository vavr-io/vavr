...
public interface Tuple extends ValueObject {
     ...
     */
    static class Tuple1<T1> implements Tuple {
     ...
     */
    static class Tuple3<T1, T2, T3> implements Tuple {
     ...
     */
    static class Tuple4<T1, T2, T3, T4> implements Tuple {
     ...
     */
    static class Tuple5<T1, T2, T3, T4, T5> implements Tuple {
     ...
     */
    static class Tuple6<T1, T2, T3, T4, T5, T6> implements Tuple {
     ...
     */
    static class Tuple7<T1, T2, T3, T4, T5, T6, T7> implements Tuple {
     ...
     */
    static class Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> implements Tuple {
    ...
    /**
     * Implementation of a pair, a tuple containing 9 elements.
     */
    static class Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Tuple {
     ...
     */
    static class Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> implements Tuple {
     ...
     */
    static class Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> implements Tuple {
     ...
     */
    static class Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> implements Tuple {
     ...
     */
    static class Tuple13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> implements Tuple {
