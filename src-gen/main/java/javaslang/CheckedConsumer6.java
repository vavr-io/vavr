...
/**
 * Represents a consumer with 6 arguments.
 * <p>
 ...
 */
@FunctionalInterface
public interface CheckedConsumer6<T1, T2, T3, T4, T5, T6> extends λ<Void> {
    ...
    /**
     * Accepts 6 arguments and returns nothing.
     *
     * @param t1 argument 1
     * @param t2 argument 2
     * @param t3 argument 3
    ...
    @Override
    default CheckedFunction1<T1, CheckedFunction1<T2, CheckedFunction1<T3, CheckedFunction1<T4, CheckedFunction1<T5, CheckedConsumer1<T6>>>>>> curried() {
        return t1 -> t2 -> t3 -> t4 -> t5 -> t6 -> accept(t1, t2, t3, t4, t5, t6);
    }

    @Override
    default CheckedConsumer1<Tuple6<T1, T2, T3, T4, T5, T6>> tupled() {
        return t -> accept(t._1, t._2, t._3, t._4, t._5, t._6);
    }

    @Override
    default CheckedConsumer6<T6, T5, T4, T3, T2, T1> reversed() {
        return (t6, t5, t4, t3, t2, t1) -> accept(t1, t2, t3, t4, t5, t6);
    }

    /**
     * Returns a composed function that first applies this CheckedConsumer6 to the given arguments and then applies
     ...
     */
    default CheckedConsumer6<T1, T2, T3, T4, T5, T6> andThen(CheckedConsumer6<T1, T2, T3, T4, T5, T6> after) {
     ...
     * this CheckedConsumer6 to the same arguments.
     *
     ...
     */
    default CheckedConsumer6<T1, T2, T3, T4, T5, T6> compose(CheckedConsumer6<T1, T2, T3, T4, T5, T6> before) {
        Objects.requireNonNull(before, "before is null");
        return (t1, t2, t3, t4, t5, t6) -> { before.accept(t1, t2, t3, t4, t5, t6); accept(t1, t2, t3, t4, t5, t6); };
    }
}