 ...
 */
@FunctionalInterface
public interface CheckedConsumer5<T1, T2, T3, T4, T5> extends λ<Void> {
    ...
    @Override
    default CheckedFunction1<T1, CheckedFunction1<T2, CheckedFunction1<T3, CheckedFunction1<T4, CheckedConsumer1<T5>>>>> curried() {
        return t1 -> t2 -> t3 -> t4 -> t5 -> accept(t1, t2, t3, t4, t5);
    }

    @Override
    default CheckedConsumer1<Tuple5<T1, T2, T3, T4, T5>> tupled() {
        return t -> accept(t._1, t._2, t._3, t._4, t._5);
    }

    @Override
    default CheckedConsumer5<T5, T4, T3, T2, T1> reversed() {
        return (t5, t4, t3, t2, t1) -> accept(t1, t2, t3, t4, t5);
    }

    /**
     * Returns a composed function that first applies this CheckedConsumer5 to the given arguments and then applies
     ...
     */
    default CheckedConsumer5<T1, T2, T3, T4, T5> andThen(CheckedConsumer5<T1, T2, T3, T4, T5> after) {
     ...
     * this CheckedConsumer5 to the same arguments.
     *
     ...
     */
    default CheckedConsumer5<T1, T2, T3, T4, T5> compose(CheckedConsumer5<T1, T2, T3, T4, T5> before) {
