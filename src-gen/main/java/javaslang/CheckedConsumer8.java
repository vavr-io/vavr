...
/**
 * Represents a consumer with 8 arguments.
 * <p>
 ...
 */
@FunctionalInterface
public interface CheckedConsumer8<T1, T2, T3, T4, T5, T6, T7, T8> extends λ<Void> {
    ...
    /**
     * Accepts 8 arguments and returns nothing.
     *
     * @param t1 argument 1
     * @param t2 argument 2
     * @param t3 argument 3
    ...
    @Override
    default CheckedFunction1<T1, CheckedFunction1<T2, CheckedFunction1<T3, CheckedFunction1<T4, CheckedFunction1<T5, CheckedFunction1<T6, CheckedFunction1<T7, CheckedConsumer1<T8>>>>>>>> curried() {
        return t1 -> t2 -> t3 -> t4 -> t5 -> t6 -> t7 -> t8 -> accept(t1, t2, t3, t4, t5, t6, t7, t8);
    }

    @Override
    default CheckedConsumer1<Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>> tupled() {
        return t -> accept(t._1, t._2, t._3, t._4, t._5, t._6, t._7, t._8);
    }

    @Override
    default CheckedConsumer8<T8, T7, T6, T5, T4, T3, T2, T1> reversed() {
        return (t8, t7, t6, t5, t4, t3, t2, t1) -> accept(t1, t2, t3, t4, t5, t6, t7, t8);
    }

    /**
     * Returns a composed function that first applies this CheckedConsumer8 to the given arguments and then applies
     ...
     */
    default CheckedConsumer8<T1, T2, T3, T4, T5, T6, T7, T8> andThen(CheckedConsumer8<T1, T2, T3, T4, T5, T6, T7, T8> after) {
     ...
     * this CheckedConsumer8 to the same arguments.
     *
     ...
     */
    default CheckedConsumer8<T1, T2, T3, T4, T5, T6, T7, T8> compose(CheckedConsumer8<T1, T2, T3, T4, T5, T6, T7, T8> before) {
        Objects.requireNonNull(before, "before is null");
        return (t1, t2, t3, t4, t5, t6, t7, t8) -> { before.accept(t1, t2, t3, t4, t5, t6, t7, t8); accept(t1, t2, t3, t4, t5, t6, t7, t8); };
    }
}