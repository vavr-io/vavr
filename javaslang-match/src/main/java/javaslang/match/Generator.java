...
//        final String params = IntStream.rangeClosed(1, variation.size()).boxed().map(i -> "p" + i).collect(joining(", "));
//        return "Pattern" + resultArity + "." + typeHint + "create(" + params + ", " + annotatedType + "::" + methodName + ");";
//        /*
//        final StringBuilder builder = new StringBuilder();
