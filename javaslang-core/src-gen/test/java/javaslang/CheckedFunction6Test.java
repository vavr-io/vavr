...
public class CheckedFunction6Test {
    ...
    public void shouldRecognizeNonApplicabilityToType1() {
        final CheckedFunction6<Number, Number, Number, Number, Number, Number, Number> f = (i1, i2, i3, i4, i5, i6) -> null;
    ...
    public void testTypesEquals() {
        final CheckedFunction6<Integer, Integer, Integer, Integer, Integer, Integer, Integer> f1 = (i1, i2, i3, i4, i5, i6) -> null;
