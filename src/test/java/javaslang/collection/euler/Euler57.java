...
public class Euler57 {
     ...
     * <p>1 + 1/2 = 3/2 = 1.5</p>
     * <p>1 + 1/(2 + 1/2) = 7/5 = 1.4</p>
     * <p>1 + 1/(2 + 1/(2 + 1/2)) = 17/12 = 1.41666...</p>
     * <p>1 + 1/(2 + 1/(2 + 1/(2 + 1/2))) = 41/29 = 1.41379...</p>
     ...
     * <p>See also <a href="https://projecteuler.net/problem=57">projecteuler.net problem 57</a>.</p>
     */
    @Test
    ...
    private static Stream<Tuple2<BigDecimal,BigDecimal>> fractions() {
        return Stream.gen(Tuple.of(BigDecimal.ONE, BigDecimal.ONE), Euler57::it);
    }
