...
public interface CheckedFunctor1Laws {
    ...
    // m.map(id) ≡ id
    default <T> CheckResult checkCheckedFunctorIdentity(Arbitrary<? extends CheckedFunctor1<T>> functors) {
    ...
    default <T, U, V> CheckResult checkCheckedFunctorComposition(Arbitrary<? extends CheckedFunctor1<T>> functors,
                                                          Arbitrary<CheckedFunction1<? super T, ? extends U>> fs,
                                                          Arbitrary<CheckedFunction1<? super U, ? extends V>> gs) {
