...
public class EitherTest {
	...
	@Test
	public void shouldDelegateDefaultGetToRightProjection() {
		final Either<Integer, String> either = new Right<>("test");
		assertThat(either.get()).isEqualTo(either.right().get());
	}

	@Test
	public void shouldDelegateDefaultOrElseToRightProjection() {
		final Either<Integer, String> either = new Right<>("test");
		assertThat(either.orElse("")).isEqualTo(either.right().orElse(""));
	}

	@Test
	public void shouldDelegateDefaultOrElseGetToRightProjection() {
		final Either<Integer, String> either = new Right<>("test");
		assertThat(either.orElseGet(() -> "")).isEqualTo(either.right().orElseGet(() -> ""));
	}

	@Test
	public void shouldDelegateDefaultOrElseThrowWithSupplierToRightProjection() {
		final Either<Integer, String> either = new Right<>("test");
		assertThat(either.orElseThrow(() -> null)).isEqualTo(either.right().orElseThrow(() -> null));
	}

	@Test
	public void shouldDelegateDefaultOrElseThrowWithFunctionToRightProjection() {
		final Either<Integer, String> either = new Right<>("test");
		assertThat(either.orElseThrow(i -> null)).isEqualTo(either.right().orElseThrow(i -> null));
	}

	@Test
	public void shouldDelegateDefaultFilterToRightProjection() {
		final Either<Integer, String> either = new Right<>("test");
		assertThat(either.filter(s -> true)).isEqualTo(either.right().filter(s -> true));
	}

	@Test
	public void shouldDelegateDefaultFlatMapToRightProjection() {
		final Either<Integer, String> either = new Right<>("test");
		assertThat(either.flatMap(s -> new Right<>(s))).isEqualTo(either.right().flatMap(s -> new Right<>(s)));
	}

	@Test
	public void shouldDelegateDefaultForEachToRightProjection() {
		final Either<Integer, String> either = new Right<>("test");
	...
	@Test
	public void shouldDelegateDefaultMapToRightProjection() {
		final Either<Integer, String> either = new Right<>("test");
		assertThat(either.map(s -> s)).isEqualTo(either.right().map(s -> s));
	}
