...
public class LenientValidationTest extends AbstractValueTest {
    ...
    // -- LenientValidation.fromMultiErrorValidation

    @Test
    public void shouldCreateFromValidMultiErrorValidation() {
        assertThat(LenientValidation.fromMultiErrorValidation(Validation.valid("ok")))
            .isEqualTo(LenientValidation.valid("ok"));
    }

    @Test
    public void shouldCreateFromInvalidMultiErrorValidation() {
        assertThat(LenientValidation.fromMultiErrorValidation(Validation.invalid(List.of("error-1", "error-2"))))
    ...
    // -- LenientValidation.fromEither

    @Test
    public void shouldCreateValidFromRight() {
        assertThat(LenientValidation.fromEither(Either.right("ok"))).isEqualTo(LenientValidation.valid("ok"));
    }

    @Test
    public void shouldCreateInvalidFromLeft() {
        assertThat(LenientValidation.fromEither(Either.left("error"))).isEqualTo(LenientValidation.invalid(List.of("error")));
    }

    // -- LenientValidation.fromTry

    @Test
    public void shouldCreateValidFromSuccess() {
        assertThat(LenientValidation.fromTry(Try.success("ok"))).isEqualTo(LenientValidation.valid("ok"));
    }

    @Test
    public void shouldCreateInvalidFromFailure() {
        Exception ex = new RuntimeException("error");
        assertThat(LenientValidation.fromTry(Try.failure(ex)))
            .isEqualTo(LenientValidation.invalid(List.of(ex)));
    }
