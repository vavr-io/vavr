...
public abstract class AbstractTraversableTest extends AbstractValueTest {
    ...
    public void shouldUnzipNonNilWithTwoUnzippers() {
        ...
        assertThat(actual.map(Value::toArray, Value::toArray)).isEqualTo(expected.map(Value::toArray, Value::toArray));
    }
    ...
    public void shouldUnzip3NonNilWithThreeUnzippers() {
        ...
        assertThat(actual.map(Value::toArray, Value::toArray, Value::toArray)).isEqualTo(expected.map(Value::toArray, Value::toArray, Value::toArray));
    }
