...
public class Prop {
	...
	public static class ForAll1<T1> {
		...
		public Prop suchThat(Function1<T1, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
	...
	public static class ForAll2<T1, T2> {
		...
		public Prop suchThat(Function2<T1, T2, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
	...
	public static class ForAll3<T1, T2, T3> {
		...
		public Prop suchThat(Function3<T1, T2, T3, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll4<T1, T2, T3, T4> {
		...
		public Prop suchThat(Function4<T1, T2, T3, T4, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll5<T1, T2, T3, T4, T5> {
		...
		public Prop suchThat(Function5<T1, T2, T3, T4, T5, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll6<T1, T2, T3, T4, T5, T6> {
		...
		public Prop suchThat(Function6<T1, T2, T3, T4, T5, T6, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll7<T1, T2, T3, T4, T5, T6, T7> {
		...
		public Prop suchThat(Function7<T1, T2, T3, T4, T5, T6, T7, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll8<T1, T2, T3, T4, T5, T6, T7, T8> {
		...
		public Prop suchThat(Function8<T1, T2, T3, T4, T5, T6, T7, T8, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
		...
		public Prop suchThat(Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
		...
		public Prop suchThat(Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
		...
		public Prop suchThat(Function11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> {
		...
		public Prop suchThat(Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
	...
	public static class ForAll13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> {
		...
		public Prop suchThat(Function13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Boolean> predicate) {
			return new Prop(() -> {
				for (T1 t1 : t1s) {
					for (T2 t2 : t2s) {
						for (T3 t3 : t3s) {
