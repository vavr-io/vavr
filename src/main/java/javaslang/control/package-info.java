 ...
 * <p>
 * The Option control is a replacement for {@linkplain java.util.Optional}. An Option is either Some(value) or None.
 ...
 * <strong>Try</strong>
 * <p>
 * Exceptions are handled with the Try control which is either a Success, containing a result, or a Failure, containing an Exception.
