...
public interface SequencedData {
    ...
    public static <K extends SequencedData> boolean seqEquals(@NonNull K a, @NonNull K b) {
        return a.getSequenceNumber() == b.getSequenceNumber();
    }

    public static <K extends SequencedData> BitmapIndexedNode<K> seqRemove(@NonNull BitmapIndexedNode<K> seqRoot, @Nullable IdentityObject mutator,
    ...
    public static <K extends SequencedData> BitmapIndexedNode<K> seqUpdate(@NonNull BitmapIndexedNode<K> seqRoot, @Nullable IdentityObject mutator,
                                                                           @NonNull K key, @NonNull ChangeEvent<K> details,
    ...
    public static <K extends SequencedData> int seqHash(K e) {
