...
/**
 * Array is an immutable Traversable wrapper for {@code Object[]} containing elements of type {@code
 * T}.
 *
...
public final class Array<T> implements IndexedSeq<T>, Serializable {
   ...
   * java.util.stream.Stream#collect(java.util.stream.Collector)} to obtain a {@link Array}.
   *
  ...
  /**
   * Narrows a {@code Array<? extends T>} to {@code Array<T>} via a type-safe cast. Safe here
   * because the array is immutable and no elements can be added that would violate the type
   * (covariance)
   *
   ...
   * Creates an Array of the given elements.
   *
   * <p>If the iteration order of the given elements is stable, the resulting Array will maintain
   * that same order.
   *
   * @param <T> Component type of the Array.
  ...
  /**
   * Creates an Array of char numbers starting from {@code from}, extending to {@code toExclusive -
   * 1}.
   *
   * <p>Examples:
   *
  ...
  /**
   * Creates an Array of double numbers starting from {@code from}, extending to {@code toExclusive
   * - 1}, with {@code step}.
   *
   * <p>Examples:
   *
  ...
  /**
   * Creates an Array of int numbers starting from {@code from}, extending to {@code toExclusive -
   * 1}.
   *
   * <p>Examples:
   *
  ...
  /**
   * Creates an Array of long numbers starting from {@code from}, extending to {@code toExclusive -
   * 1}.
   *
   * <p>Examples:
   *
  ...
  /**
   * Creates an Array of double numbers starting from {@code from}, extending to {@code
   ...
   *     <p>ex: {@code Array.transpose(Array(Array(1,2,3), Array(4,5,6))) → Array(Array(1,4),
   *     Array(2,5), Array(3,6)) }
   */
  ...
  /**
   * Creates an Array from a seed value and a function. The function takes the seed at first. The
   * function should return {@code None} when it's done generating the Array, otherwise {@code Some}
   * {@code Tuple} of the element for the next call and the value to add to the resulting Array.
   *
   * <p>Example:
   *
   * <pre>{@code
   ...
   * @throws NullPointerException if {@code f} is null
   */
  public static <T, U> Array<U> unfoldRight(
   ...
   * @throws NullPointerException if {@code f} is null
   */
  public static <T, U> Array<U> unfoldLeft(
   ...
   * @throws NullPointerException if {@code f} is null
   */
  public static <T> Array<T> unfold(
  ...
  @Override
  public <U extends Comparable<? super U>> Array<T> sortBy(
  ...
  @Override
  public <U> Array<Tuple2<T, U>> zipAll(
