...
public interface SortedMap<K, V> extends Map<K, V>, Ordered<K> {
  ...
  /**
   * Narrows a widened {@code SortedMap<? extends K, ? extends V>} to {@code SortedMap<K, V>} by
  ...
  /**
   * Same as {@link #bimap(Function, Function)}, using a specific comparator for keys of the
   * codomain of the given {@code keyMapper}.
   *
  ...
  /**
   * Same as {@link #flatMap(BiFunction)} but using a specific comparator for values of the codomain
   * of the given {@code mapper}.
   *
  ...
  /**
   * Same as {@link #map(BiFunction)}, using a specific comparator for keys of the codomain of the
   * given {@code mapper}.
   *
   * @param keyComparator A comparator for keys of type U
   * @param <K2> key's component type of the map result
  ...
  @Override
  <C> Map<C, ? extends SortedMap<K, V>> groupBy(
