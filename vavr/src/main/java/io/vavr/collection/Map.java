 ...
 *
 * <p>Represents a collection of key-value pairs with immutable operations. Supports typical map
 * operations such as querying, updating, filtering, transforming, and iterating over entries.
 * Provides convenient methods for converting to standard Java maps and for working with default
 * values.
 *
 * @param <K> Key type
 * @param <V> Value type
...
public interface Map<K, V> extends Traversable<Tuple2<K, V>>, PartialFunction<K, V>, Serializable {
  ...
  /**
   * Narrows a widened {@code Map<? extends K, ? extends V>} to {@code Map<K, V>} by performing a
   * type-safe cast. This is eligible because immutable/read-only collections are covariant.
   *
   ...
   *
   * <p>When imported statically, this method enables constructing maps in a readable and type-safe
   * way, for example:
   *
   * <pre>{@code
   * HashMap.ofEntries(
  ...
  /**
   * Turns this {@code Map} into a {@link PartialFunction} which is defined at a specific index, if
   * this {@code Map} contains the given key. When applied to a defined key, the partial function
   * will return the value of this {@code Map} that is associated with the key.
   *
  ...
  @Override
  default <R> Seq<R> collect(
      @NonNull PartialFunction<? super Tuple2<K, V>, ? extends R> partialFunction) {
    return io.vavr.collection.Vector.ofAll(iterator().<R>collect(partialFunction));
  }

  /**
   * Maps this {@code Map} to a new {@code Map} with different component type by applying a function
   * to its elements.
   *
   * @param <K2> key's component type of the map result
   * @param <V2> value's component type of the map result
   * @param keyMapper a {@code Function} that maps the keys of type {@code K} to keys of type {@code
   *     K2}
   * @param valueMapper a {@code Function} that the values of type {@code V} to values of type
   *     {@code V2}
   * @return a new {@code Map}
   * @throws NullPointerException if {@code keyMapper} or {@code valueMapper} is null
   */
  <K2, V2> Map<K2, V2> bimap(
   ...
   * @return the {@link Tuple2} of current or modified map and existing or computed value associated
   *     with the specified key
   */
  Tuple2<V, ? extends Map<K, V>> computeIfAbsent(
   ...
   * @return the {@link Tuple2} of current or modified map and the {@code Some} of the value
   *     associated with the specified key, or {@code None} if none
   */
  ...
  /**
   * Returns <code>true</code> if this map maps one or more keys to the specified value. This
   * operation will require time linear in the map size.
   *
  ...
  /**
   * Returns a new Map consisting of all elements with keys which do not satisfy the given
   * predicate.
   *
   * @param predicate the predicate used to test keys of elements
   * @return a new Map
  ...
  /**
   * Returns a new Map consisting of all elements with values which do not satisfy the given
   * predicate.
   *
   * @param predicate the predicate used to test values of elements
   * @return a new Map
  ...
  @SuppressWarnings("unchecked")
  @Override
  default <U> Seq<U> flatMap(
      @NonNull Function<? super Tuple2<K, V>, ? extends Iterable<? extends U>> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    return iterator().flatMap(mapper).toStream();
  }

  @Override
  default <U> U foldRight(
      U zero, @NonNull BiFunction<? super Tuple2<K, V>, ? super U, ? extends U> f) {
  ...
  /**
   * Returns the {@code Some} of value to which the specified key is mapped, or {@code None} if this
   * map contains no mapping for the key.
   *
   * @param key the key whose associated value is to be returned
   * @return the {@code Some} of value to which the specified key is mapped, or {@code None} if this
   *     map contains no mapping for the key
   */
  Option<V> get(K key);

  /**
   * Returns the value associated with a key, or a default value if the key is not contained in the
   * map.
   *
   * @param key the key
   ...
   *
   * @return a function that takes a key k and returns its value in a Some if found, otherwise a
   *     None.
   */
   ...
   *
   * <p>Please use {@link #map(BiFunction)} if the result has to be of type {@code Map}.
   *
   * @param mapper A mapper
   * @param <U> Component type
   ...
   * @param <K2> key's component type of the map result
   * @param <V2> value's component type of the map result
   * @param mapper a {@code Function} that maps entries of type {@code (K, V)} to entries of type
   *     {@code (K2, V2)}
   * @return a new {@code Map}
   * @throws NullPointerException if {@code mapper} is null
   */
   ...
   *
   * <p>The size of the result map may be smaller if {@code keyMapper} maps two or more distinct
   * keys to the same new key. In this case the value at the {@code latest} of the original keys is
   * retained. Order of keys is predictable in {@code TreeMap} (by comparator) and {@code
   * LinkedHashMap} (insertion-order) and not predictable in {@code HashMap}.
   *
  ...
  /**
   * Maps the keys of this {@code Map} while preserving the corresponding values and applying a
   * value merge function on collisions.
   *
   * <p>The size of the result map may be smaller if {@code keyMapper} maps two or more distinct
   * keys to the same new key. In this case the associated values will be combined using {@code
   * valueMerge}.
   *
   * @param <K2> the new key type
   * @param keyMapper a {@code Function} that maps keys of type {@code V} to keys of type {@code V2}
   ...
   * @param valueMapper a {@code Function} that maps values of type {@code V} to values of type
   *     {@code V2}
   * @return a new {@code Map}
   ...
   *
   * <p>If collisions occur, the value of {@code this} map is taken.
   *
   ...
   * Creates a new map which by merging the entries of {@code this} map and {@code that} map.
   *
   * <p>Uses the specified collision resolution function if two keys are the same. The collision
   * resolution function will always take the first argument from <code>this</code> map and the
   * second from <code>that</code> map.
   *
  ...
  /**
   * Associates the specified value with the specified key in this map. If the map previously
   * contained a mapping for the key, the merge function is used to combine the previous value to
   * the value to be inserted, and the result of that call is inserted in the map.
   *
   ...
   * @return A new Map containing these elements without the entry specified by that key.
   */
   ...
   * @return A new Map containing these elements without the entries specified by that keys.
   */
  ...
  @Override
  default <U> Seq<U> scanLeft(
      U zero, @NonNull BiFunction<? super U, ? super Tuple2<K, V>, ? extends U> operation) {
    return io.vavr.collection.Collections.scanLeft(
        this, zero, operation, io.vavr.collection.Iterator::toVector);
  }

  @Override
  default <U> Seq<U> scanRight(
      U zero, @NonNull BiFunction<? super Tuple2<K, V>, ? super U, ? extends U> operation) {
  ...
  /**
   * Converts this Vavr {@code Map} to a {@code java.util.Map} while preserving characteristics like
   * insertion order ({@code LinkedHashMap}) and sort order ({@code SortedMap}).
   *
  ...
  /**
   * Unzips the entries of this {@code Map} by treating each key-value pair as an element, and
   * splitting them into two separate {@code Seq} collections - one for keys and one for values.
   *
   * @return a {@code Tuple2} containing two {@code Seq} collections: first with all keys, second
   *     with all values
   */
  ...
  /**
   * Unzips the entries of this {@code Map} by mapping each key-value pair to a tuple. The unzipper
   * function transforms each entry into a {@code Tuple2}, and then all first elements are collected
   * into the first {@code Seq} and all second elements into the second {@code Seq}.
   *
  ...
  default <T1, T2> Tuple2<Seq<T1>, Seq<T2>> unzip(
      @NonNull BiFunction<? super K, ? super V, Tuple2<? extends T1, ? extends T2>> unzipper) {
  ...
  @Override
  default <T1, T2> Tuple2<Seq<T1>, Seq<T2>> unzip(
      @NonNull Function<? super Tuple2<K, V>, Tuple2<? extends T1, ? extends T2>> unzipper) {
    Objects.requireNonNull(unzipper, "unzipper is null");
    return iterator().unzip(unzipper).map(Stream::ofAll, Stream::ofAll);
  }

  /**
   * Unzips the entries of this {@code Map} by mapping each key-value pair to a triple. The unzipper
   * function transforms each entry into a {@code Tuple3}, and then elements are distributed to
   * respective {@code Seq} collections by their position in the tuple: all first elements into the
   * first {@code Seq}, all second elements into the second {@code Seq}, and all third elements into
   * the third {@code Seq}.
   *
  ...
  default <T1, T2, T3> Tuple3<Seq<T1>, Seq<T2>, Seq<T3>> unzip3(
      @NonNull BiFunction<? super K, ? super V, Tuple3<? extends T1, ? extends T2, ? extends T3>>
          unzipper) {
    Objects.requireNonNull(unzipper, "unzipper is null");
  ...
  @Override
  default <T1, T2, T3> Tuple3<Seq<T1>, Seq<T2>, Seq<T3>> unzip3(
      @NonNull Function<? super Tuple2<K, V>, Tuple3<? extends T1, ? extends T2, ? extends T3>>
          unzipper) {
    Objects.requireNonNull(unzipper, "unzipper is null");
  ...
  /**
   * Turns this map from a partial function into a total function that returns a value computed by
   * defaultFunction for all keys absent from the map.
   *
  ...
  /**
   * Turns this map from a partial function into a total function that returns defaultValue for all
   * keys absent from the map.
   *
  ...
  @Override
  default <U> Seq<Tuple2<Tuple2<K, V>, U>> zipAll(
      @NonNull Iterable<? extends U> that, Tuple2<K, V> thisElem, U thatElem) {
    Objects.requireNonNull(that, "that is null");
  ...
  @Override
  default <U> Seq<U> zipWithIndex(
      @NonNull BiFunction<? super Tuple2<K, V>, ? super Integer, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
  ...
  @Override
  <C> Map<C, ? extends Map<K, V>> groupBy(
  ...
  @Override
  Tuple2<? extends Map<K, V>, ? extends Map<K, V>> partition(
   ...
   * @return a new map containing key mapped to value if key was contained before. The old map
   *     otherwise.
   */
   ...
   * @return a new map containing key mapped to newValue if key was contained before and oldValue
   *     matched. The old map otherwise.
   */
  ...
  @Override
  io.vavr.collection.Iterator<? extends Map<K, V>> slideBy(
  ...
  @Override
  Tuple2<? extends Map<K, V>, ? extends Map<K, V>> span(
      @NonNull Predicate<? super Tuple2<K, V>> predicate);
