 ...
 *
 * <p>Specific SortedSet operations:
 *
 * <ul>
 *   <li>{@link #comparator()}
 *   <li>{@link #flatMap(Comparator, Function)}
 *   <li>{@link #map(Comparator, Function)}
 * </ul>
 *
...
public interface SortedSet<T> extends Set<T>, Ordered<T> {
  ...
  /**
   * Narrows a widened {@code SortedSet<? extends T>} to {@code SortedSet<T>} by performing a
  ...
  /**
   * Same as {@link #flatMap(Function)} but using a specific comparator for values of the codomain
   ...
   */
  <U> SortedSet<U> flatMap(
      @NonNull Comparator<? super U> comparator,
      Function<? super T, ? extends Iterable<? extends U>> mapper);

  /**
   * Same as {@link #map(Function)} but using a specific comparator for values of the codomain of
  ...
  @Override
  Tuple2<? extends SortedSet<T>, ? extends SortedSet<T>> partition(
  ...
  @Override
  Tuple2<? extends SortedSet<T>, ? extends SortedSet<T>> span(
      @NonNull Predicate<? super T> predicate);
  ...
  @Override
  <T1, T2> Tuple2<? extends SortedSet<T1>, ? extends SortedSet<T2>> unzip(
      @NonNull Function<? super T, Tuple2<? extends T1, ? extends T2>> unzipper);

  @Override
  <T1, T2, T3>
      Tuple3<? extends SortedSet<T1>, ? extends SortedSet<T2>, ? extends SortedSet<T3>> unzip3(
