...
public final class Vector<T> implements IndexedSeq<T>, Serializable {
     ...
     */
    public static Vector<Boolean> ofAll(@NonNull boolean... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return ofAll(BitMappedTrie.ofAll(elements));
    }
     ...
     * @throws NullPointerException if elements is null
     */
    public static Vector<Byte> ofAll(@NonNull byte... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return ofAll(BitMappedTrie.ofAll(elements));
    }
     ...
     * @throws NullPointerException if elements is null
     */
    public static Vector<Character> ofAll(@NonNull char... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return ofAll(BitMappedTrie.ofAll(elements));
    }
     ...
     * @throws NullPointerException if elements is null
     */
    public static Vector<Double> ofAll(@NonNull double... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return ofAll(BitMappedTrie.ofAll(elements));
    }
     ...
     * @throws NullPointerException if elements is null
     */
    public static Vector<Float> ofAll(@NonNull float... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return ofAll(BitMappedTrie.ofAll(elements));
    }
     ...
     * @throws NullPointerException if elements is null
     */
    public static Vector<Integer> ofAll(@NonNull int... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return ofAll(BitMappedTrie.ofAll(elements));
    }
     ...
     * @throws NullPointerException if elements is null
     */
    public static Vector<Long> ofAll(@NonNull long... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return ofAll(BitMappedTrie.ofAll(elements));
    }
     ...
     * @throws NullPointerException if elements is null
     */
    public static Vector<Short> ofAll(@NonNull short... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return ofAll(BitMappedTrie.ofAll(elements));
    }
