...
/**
 * Vector is the default Seq implementation that provides effectively constant time access to any
 * element. Many other operations (e.g. `tail`, `drop`, `slice`) are also effectively constant.
 *
 * <p>The implementation is based on a `bit-mapped trie`, a very wide and shallow tree (i.e. depth ≤
 * 6).
 *
...
public final class Vector<T> implements IndexedSeq<T>, Serializable {
  ...
  private Vector<T> wrap(@NonNull BitMappedTrie<T> trie) {
    return (trie == this.trie) ? this : ofAll(trie);
  }

  private static <T> Vector<T> ofAll(@NonNull BitMappedTrie<T> trie) {
   ...
   * java.util.stream.Stream#collect(Collector)} to obtain a {@link Vector}.
   *
   * @param <T> Component type of the Vector.
  ...
  /**
   * Narrows a {@code Vector<? extends T>} to {@code Vector<T>} via a type-safe cast. Safe here
   * because the vector is immutable and no elements can be added that would violate the type
   * (covariance)
   *
  ...
  public static <T> Vector<T> of(T @NonNull ... elements) {
    Objects.requireNonNull(elements, "elements is null");
    return ofAll(BitMappedTrie.ofAll(elements));
  }

  /**
   * Returns a Vector containing {@code n} values of a given Function {@code f} over a range of
   ...
   * @return A Vector of size {@code n}, where each element contains the result supplied by {@code
   *     s}.
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T> Vector<T> ofAll(@NonNull Iterable<? extends T> iterable) {
   ...
   * @return A Vector containing the given elements in the same order.
   */
  public static <T> Vector<T> ofAll(java.util.stream.@NonNull Stream<? extends T> javaStream) {
   ...
   */
  public static Vector<Boolean> ofAll(boolean @NonNull ... elements) {
    Objects.requireNonNull(elements, "elements is null");
    return ofAll(BitMappedTrie.ofAll(elements));
  }
   ...
   * @throws NullPointerException if elements is null
   */
  public static Vector<Byte> ofAll(byte @NonNull ... elements) {
    Objects.requireNonNull(elements, "elements is null");
    return ofAll(BitMappedTrie.ofAll(elements));
  }
   ...
   * @throws NullPointerException if elements is null
   */
  public static Vector<Character> ofAll(char @NonNull ... elements) {
    Objects.requireNonNull(elements, "elements is null");
    return ofAll(BitMappedTrie.ofAll(elements));
  }
   ...
   * @throws NullPointerException if elements is null
   */
  public static Vector<Double> ofAll(double @NonNull ... elements) {
    Objects.requireNonNull(elements, "elements is null");
    return ofAll(BitMappedTrie.ofAll(elements));
  }
   ...
   * @throws NullPointerException if elements is null
   */
  public static Vector<Float> ofAll(float @NonNull ... elements) {
    Objects.requireNonNull(elements, "elements is null");
    return ofAll(BitMappedTrie.ofAll(elements));
  }
   ...
   * @throws NullPointerException if elements is null
   */
  public static Vector<Integer> ofAll(int @NonNull ... elements) {
    Objects.requireNonNull(elements, "elements is null");
    return ofAll(BitMappedTrie.ofAll(elements));
  }
   ...
   * @throws NullPointerException if elements is null
   */
  public static Vector<Long> ofAll(long @NonNull ... elements) {
    Objects.requireNonNull(elements, "elements is null");
    return ofAll(BitMappedTrie.ofAll(elements));
  }
   ...
   * @throws NullPointerException if elements is null
   */
  public static Vector<Short> ofAll(short @NonNull ... elements) {
    Objects.requireNonNull(elements, "elements is null");
    return ofAll(BitMappedTrie.ofAll(elements));
  }

  /**
   * Creates a Vector of char numbers starting from {@code from}, extending to {@code toExclusive -
   * 1}.
   *
   * <p>Examples:
   *
  ...
  public static Vector<Character> rangeBy(char from, char toExclusive, int step) {
    return ofAll(
        ArrayType.<char[]>asPrimitives(char.class, Iterator.rangeBy(from, toExclusive, step)));
  }

  /**
   * Creates a Vector of double numbers starting from {@code from}, extending up to (but not
  ...
  public static Vector<Double> rangeBy(double from, double toExclusive, double step) {
    return ofAll(
        ArrayType.<double[]>asPrimitives(double.class, Iterator.rangeBy(from, toExclusive, step)));
  }
  ...
  public static Vector<Integer> rangeBy(int from, int toExclusive, int step) {
    return ofAll(
        ArrayType.<int[]>asPrimitives(int.class, Iterator.rangeBy(from, toExclusive, step)));
  }
  ...
  public static Vector<Long> rangeBy(long from, long toExclusive, long step) {
    return ofAll(
        ArrayType.<long[]>asPrimitives(long.class, Iterator.rangeBy(from, toExclusive, step)));
  }
  ...
  public static Vector<Character> rangeClosed(char from, char toInclusive) {
    return ofAll(
        ArrayType.<char[]>asPrimitives(char.class, Iterator.rangeClosed(from, toInclusive)));
  }
  ...
  public static Vector<Character> rangeClosedBy(char from, char toInclusive, int step) {
    return ofAll(
        ArrayType.<char[]>asPrimitives(
            char.class, Iterator.rangeClosedBy(from, toInclusive, step)));
  }

  /**
   * Creates a Vector of double numbers starting from {@code from}, extending to {@code
  ...
  public static Vector<Double> rangeClosedBy(double from, double toInclusive, double step) {
    return ofAll(
        ArrayType.<double[]>asPrimitives(
            double.class, Iterator.rangeClosedBy(from, toInclusive, step)));
  }
  ...
  public static Vector<Integer> rangeClosedBy(int from, int toInclusive, int step) {
    return ofAll(
        ArrayType.<int[]>asPrimitives(int.class, Iterator.rangeClosedBy(from, toInclusive, step)));
  }
  ...
  public static Vector<Long> rangeClosed(long from, long toInclusive) {
    return ofAll(
        ArrayType.<long[]>asPrimitives(long.class, Iterator.rangeClosed(from, toInclusive)));
  }
  ...
  public static Vector<Long> rangeClosedBy(long from, long toInclusive, long step) {
    return ofAll(
        ArrayType.<long[]>asPrimitives(
            long.class, Iterator.rangeClosedBy(from, toInclusive, step)));
  }
   ...
   *     <p>ex: {@code Vector.transpose(Vector(Vector(1,2,3), Vector(4,5,6))) → Vector(Vector(1,4),
   *     Vector(2,5), Vector(3,6)) }
   */
  public static <T> Vector<Vector<T>> transpose(@NonNull Vector<Vector<T>> matrix) {
    return io.vavr.collection.Collections.transpose(matrix, Vector::ofAll, Vector::of);
  }

  /**
   * Creates a Vector from a seed value and a function. The function takes the seed at first. The
   * function should return {@code None} when it's done generating the Vector, otherwise {@code
   ...
   * @throws NullPointerException if {@code f} is null
   */
  public static <T, U> Vector<U> unfoldRight(
   ...
   * Creates a Vector from a seed value and a function. The function takes the seed at first. The
   * function should return {@code None} when it's done generating the Vector, otherwise {@code
   * Some} {@code Tuple} of the value to add to the resulting Vector and the element for the next
   * call.
   *
   * <p>Example:
   *
   ...
   * @throws NullPointerException if {@code f} is null
   */
  public static <T, U> Vector<U> unfoldLeft(
   ...
   * @throws NullPointerException if {@code f} is null
   */
  public static <T> Vector<T> unfold(
  ...
  @Override
  public Vector<T> appendAll(@NonNull Iterable<? extends T> iterable) {
    Objects.requireNonNull(iterable, "iterable is null");
    if (isEmpty()) {
  ...
  @Override
  public <R> Vector<R> collect(@NonNull PartialFunction<? super T, ? extends R> partialFunction) {
  ...
  @Override
  public Vector<T> distinctBy(@NonNull Comparator<? super T> comparator) {
  ...
  @Override
  public <U> Vector<T> distinctBy(@NonNull Function<? super T, ? extends U> keyExtractor) {
  ...
  @Override
  public Vector<T> distinctByKeepLast(@NonNull Comparator<? super T> comparator) {
    Objects.requireNonNull(comparator, "comparator is null");
    return ofAll(iterator().distinctByKeepLast(comparator));
  }

  @Override
  public <U> Vector<T> distinctByKeepLast(@NonNull Function<? super T, ? extends U> keyExtractor) {
    Objects.requireNonNull(keyExtractor, "keyExtractor is null");
  ...
  @Override
  public Vector<T> dropUntil(@NonNull Predicate<? super T> predicate) {
    return io.vavr.collection.Collections.dropUntil(this, predicate);
  }

  @Override
  public Vector<T> dropWhile(@NonNull Predicate<? super T> predicate) {
  ...
  @Override
  public Vector<T> dropRightUntil(@NonNull Predicate<? super T> predicate) {
    return io.vavr.collection.Collections.dropRightUntil(this, predicate);
  }

  @Override
  public Vector<T> dropRightWhile(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
    return dropRightUntil(predicate.negate());
  }

  @Override
  public Vector<T> filter(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
    return wrap(trie.filter(predicate));
  }

  @Override
  public Vector<T> reject(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
  ...
  @Override
  public <C> Map<C, Vector<T>> groupBy(@NonNull Function<? super T, ? extends C> classifier) {
  ...
  @Override
  public <U> Vector<U> map(@NonNull Function<? super T, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
  ...
  @Override
  public Vector<T> orElse(@NonNull Iterable<? extends T> other) {
    return isEmpty() ? ofAll(other) : this;
  }

  @Override
  public Vector<T> orElse(@NonNull Supplier<? extends Iterable<? extends T>> supplier) {
  ...
  @Override
  public Tuple2<Vector<T>, Vector<T>> partition(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
  ...
  @Override
  public Vector<T> peek(@NonNull Consumer<? super T> action) {
  ...
  @Override
  public Vector<T> prependAll(@NonNull Iterable<? extends T> iterable) {
    Objects.requireNonNull(iterable, "iterable is null");
    if (isEmpty()) {
      return ofAll(iterable);
    }
  ...
  @Override
  public Vector<T> removeFirst(@NonNull Predicate<T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
    for (int i = 0; i < length(); i++) {
  ...
  @Override
  public Vector<T> removeLast(@NonNull Predicate<T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
  ...
  @Override
  public Vector<T> removeAll(@NonNull Iterable<? extends T> elements) {
    return io.vavr.collection.Collections.removeAll(this, elements);
  }

  @Override
  @Deprecated
  public Vector<T> removeAll(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
  ...
  @Override
  public Vector<T> retainAll(@NonNull Iterable<? extends T> elements) {
  ...
  @Override
  public Iterator<Vector<T>> slideBy(@NonNull Function<? super T, ?> classifier) {
  ...
  @Override
  public Vector<T> sorted(@NonNull Comparator<? super T> comparator) {
    Objects.requireNonNull(comparator, "comparator is null");
    return isEmpty() ? this : toJavaStream().sorted(comparator).collect(collector());
  }

  @Override
  public <U extends Comparable<? super U>> Vector<T> sortBy(
      @NonNull Function<? super T, ? extends U> mapper) {
    return sortBy(U::compareTo, mapper);
  }

  @Override
  public <U> Vector<T> sortBy(
  ...
  @Override
  public Tuple2<Vector<T>, Vector<T>> span(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
  ...
  @Override
  public Tuple2<Vector<T>, Vector<T>> splitAt(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
  ...
  @Override
  public Tuple2<Vector<T>, Vector<T>> splitAtInclusive(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
    for (int i = 0; i < length(); i++) {
      final T value = get(i);
  ...
  @Override
  public Vector<T> takeUntil(@NonNull Predicate<? super T> predicate) {
    return io.vavr.collection.Collections.takeUntil(this, predicate);
  }

  @Override
  public Vector<T> takeWhile(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
  ...
  @Override
  public Vector<T> takeRightUntil(@NonNull Predicate<? super T> predicate) {
    return io.vavr.collection.Collections.takeRightUntil(this, predicate);
  }

  @Override
  public Vector<T> takeRightWhile(@NonNull Predicate<? super T> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
  ...
  @Override
  public <U> Vector<Tuple2<T, U>> zip(@NonNull Iterable<? extends U> that) {
    return zipWith(that, Tuple::of);
  }

  @Override
  public <U, R> Vector<R> zipWith(
  ...
  @Override
  public <U> Vector<Tuple2<T, U>> zipAll(
  ...
  @Override
  public <U> Vector<U> zipWithIndex(
