...
public final class LinkedHashSet<T> implements Set<T>, Serializable {
     ...
     */
    @SafeVarargs
    public static <T> LinkedHashSet<T> of(@NonNull T... elements) {
    ...
    @Override
    public <U, R> LinkedHashSet<R> zipWith(@NonNull Iterable<? extends U> that, BiFunction<? super T, ? super U, ? extends R> mapper) {
