...
public final class LinkedHashSet<T> implements Set<T>, Serializable {
   ...
   * java.util.stream.Stream#collect(Collector)} to obtain a {@link LinkedHashSet}.
   *
  ...
  /**
   * Narrows a {@code LinkedHashSet<? extends T>} to {@code LinkedHashSet<T>} via a type-safe cast.
   * Safe here because the set is immutable and no elements can be added that would violate the type
   * (covariance)
   *
  ...
  /**
   * Returns a LinkedHashSet containing {@code n} values of a given Function {@code f} over a range
   ...
   */
  public static <T> LinkedHashSet<T> tabulate(
  ...
  /**
   * Returns a LinkedHashSet containing tuples returned by {@code n} calls to a given Supplier
   * {@code s}.
   *
   * @param <T> Component type of the LinkedHashSet
   * @param n The number of elements in the LinkedHashSet
   * @param s The Supplier computing element values
   * @return A LinkedHashSet of size {@code n}, where each element contains the result supplied by
   *     {@code s}.
  ...
  /**
   * Creates a LinkedHashSet that contains the elements of the given {@link
   ...
   */
  public static <T> LinkedHashSet<T> ofAll(
  ...
  /**
   * Creates a LinkedHashSet of int numbers starting from {@code from}, extending to {@code
   * toExclusive - 1}.
   *
   * <p>Examples:
   *
  ...
  /**
   * Creates a LinkedHashSet of char numbers starting from {@code from}, extending to {@code
   * toExclusive - 1}.
   *
   * <p>Examples:
   *
  ...
  /**
   * Creates a LinkedHashSet of double numbers starting from {@code from}, extending to {@code
   * toExclusive - 1}, with {@code step}.
   *
   * <p>Examples:
   *
  ...
  /**
   * Creates a LinkedHashSet of long numbers starting from {@code from}, extending to {@code
   * toExclusive - 1}.
   *
   * <p>Examples:
   *
  ...
  /**
   * Adds all of the given elements to this set, replacing existing one if they are not already
   * contained.
   *
   * <p>Note that this method has a worst-case quadratic complexity.
   *
   * @param elements The elements to be added.
   * @return A new set containing all elements of this set and the given {@code elements}, if not
   *     already contained.
   */
  @Override
  ...
  @Override
  public <R> LinkedHashSet<R> collect(
  ...
  @Override
  public <U> LinkedHashSet<U> flatMap(
      @NonNull Function<? super T, ? extends Iterable<? extends U>> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    if (isEmpty()) {
      return empty();
    } else {
      final LinkedHashMap<U, Object> that =
          foldLeft(LinkedHashMap.empty(), (tree, t) -> addAll(tree, mapper.apply(t)));
      return new LinkedHashSet<>(that);
    }
  }
  ...
  @Override
  public <C> Map<C, LinkedHashSet<T>> groupBy(
  ...
  @Override
  public Tuple2<LinkedHashSet<T>, LinkedHashSet<T>> partition(
  ...
  @Override
  public <U> LinkedHashSet<U> scanRight(
  ...
  /**
   * Adds all of the elements of {@code elements} to this set, replacing existing ones if they
   * already present.
   *
   * <p>Note that this method has a worst-case quadratic complexity.
   *
   * <p>See also {@link #addAll(Iterable)}.
   *
  ...
  public <T1, T2, T3> Tuple3<LinkedHashSet<T1>, LinkedHashSet<T2>, LinkedHashSet<T3>> unzip3(
    ...
    return Tuple.of(
        LinkedHashSet.ofAll(t._1), LinkedHashSet.ofAll(t._2), LinkedHashSet.ofAll(t._3));
  }
  ...
  @Override
  public <U, R> LinkedHashSet<R> zipWith(
      @NonNull Iterable<? extends U> that,
      @NonNull BiFunction<? super T, ? super U, ? extends R> mapper) {
  ...
  @Override
  public <U> LinkedHashSet<Tuple2<T, U>> zipAll(
  ...
  @Override
  public <U> LinkedHashSet<U> zipWithIndex(
  ...
  private static <T> LinkedHashMap<T, Object> addAll(
