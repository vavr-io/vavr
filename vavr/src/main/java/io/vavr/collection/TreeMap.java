 ...
 *
 * <p>Provides efficient sorted key access and typical map operations in a functional style.
 *
...
public final class TreeMap<K, V> implements SortedMap<K, V>, Serializable {
   ...
   *
   * <p>The natural comparator is used to compare TreeMap keys.
   *
  ...
  public static <K extends Comparable<? super K>, V>
      Collector<Tuple2<K, V>, ArrayList<Tuple2<K, V>>, TreeMap<K, V>> collector() {
   ...
   * java.util.stream.Stream#collect(java.util.stream.Collector)} to obtain a {@link TreeMap}.
   *
   * <p>The natural comparator is used to compare TreeMap keys.
   *
   ...
   * @return A {@link TreeMap} Collector.
   */
  public static <K extends Comparable<? super K>, V, T extends V>
      Collector<T, ArrayList<T>, TreeMap<K, V>> collector(
   ...
   * @return A {@link TreeMap} Collector.
   */
  public static <K extends Comparable<? super K>, V, T>
      Collector<T, ArrayList<T>, TreeMap<K, V>> collector(
          @NonNull Function<? super T, ? extends K> keyMapper,
  ...
  /**
   * Narrows a {@code TreeMap<? extends K, ? extends V>} to {@code TreeMap<K, V>} via a type-safe
   * cast. Safe here because the map is immutable and no elements can be added that would violate
   * the type (covariance)
   *
  ...
  /**
   * Returns a singleton {@code TreeMap}, i.e. a {@code TreeMap} of one entry. The underlying key
   * comparator is the natural comparator of K.
   *
   * @param <K> The key type
   * @param <V> The value type
   ...
   */
  public static <K extends Comparable<? super K>, V> TreeMap<K, V> of(
      @NonNull Tuple2<? extends K, ? extends V> entry) {
   ...
   * @return A new Map
   */
  public static <T, K extends Comparable<? super K>, V> TreeMap<K, V> ofAll(
   ...
   * @return A new Map
   */
  public static <T, K, V> TreeMap<K, V> ofAll(
   ...
   * @return A new Map containing the given map
   */
  public static <K, V> TreeMap<K, V> ofAll(
      @NonNull Comparator<? super K> keyComparator,
      java.util.@NonNull Map<? extends K, ? extends V> map) {
    Objects.requireNonNull(map, "map is null");
  ...
  public static <K extends Comparable<? super K>, V> TreeMap<K, V> of(
    ...
    return createFromPairs(
        EntryComparator.natural(), k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6);
  }
  ...
  public static <K extends Comparable<? super K>, V> TreeMap<K, V> of(
    ...
    return createFromPairs(
        EntryComparator.natural(), k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6, k7, v7);
  }
  ...
  public static <K, V> TreeMap<K, V> of(
      ...
      V v5) {
    return createFromPairs(
        EntryComparator.of(keyComparator), k1, v1, k2, v2, k3, v3, k4, v4, k5, v5);
  }
  ...
  public static <K, V> TreeMap<K, V> of(
      ...
      V v6) {
    return createFromPairs(
        EntryComparator.of(keyComparator), k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6);
  }
  ...
  public static <K, V> TreeMap<K, V> tabulate(
      Comparator<? super K> keyComparator,
      int n,
      @NonNull Function<? super Integer, ? extends Tuple2<? extends K, ? extends V>> f) {
  ...
  /**
   * Returns a TreeMap containing {@code n} values of a given Function {@code f} over a range of
   * integer values from 0 to {@code n - 1}. The underlying key comparator is the natural comparator
   * of K.
   *
   * @param <K> The key type
   * @param <V> The value type
   ...
   */
  public static <K extends Comparable<? super K>, V> TreeMap<K, V> tabulate(
  ...
  public static <K, V> TreeMap<K, V> fill(
      @NonNull Comparator<? super K> keyComparator,
      int n,
      @NonNull Supplier<? extends Tuple2<? extends K, ? extends V>> s) {
   ...
   */
  public static <K extends Comparable<? super K>, V> TreeMap<K, V> fill(
  ...
  @Override
  public <K2, V2> TreeMap<K2, V2> bimap(
      @NonNull Comparator<? super K2> keyComparator,
      @NonNull Function<? super K, ? extends K2> keyMapper,
  ...
  @Override
  public Tuple2<V, TreeMap<K, V>> computeIfAbsent(
  ...
  @Override
  public <U> TreeMap<K, V> distinctBy(
  ...
  @Override
  public <K2, V2> TreeMap<K2, V2> flatMap(
  ...
  @Override
  public <C> Map<C, TreeMap<K, V>> groupBy(
  ...
  @Override
  public <K2, V2> TreeMap<K2, V2> map(
  ...
  /**
   * Returns this {@code TreeMap} if it is nonempty, otherwise {@code TreeMap} created from
   * iterable, using existing comparator.
   *
   * @param other An alternative {@code Traversable}
   * @return this {@code TreeMap} if it is nonempty, otherwise {@code TreeMap} created from
   *     iterable, using existing comparator.
   */
  @Override
  ...
  /**
   * Returns this {@code TreeMap} if it is nonempty, otherwise {@code TreeMap} created from result
   * of evaluating supplier, using existing comparator.
   *
   * @param supplier An alternative {@code Traversable}
   * @return this {@code TreeMap} if it is nonempty, otherwise {@code TreeMap} created from result
   *     of evaluating supplier, using existing comparator.
   */
  @Override
  public TreeMap<K, V> orElse(
      @NonNull Supplier<? extends Iterable<? extends Tuple2<K, V>>> supplier) {
    return isEmpty() ? ofEntries(comparator(), supplier.get()) : this;
  }

  @Override
  public Tuple2<TreeMap<K, V>, TreeMap<K, V>> partition(
  ...
  @Override
  public Tuple2<TreeMap<K, V>, TreeMap<K, V>> span(
      @NonNull Predicate<? super Tuple2<K, V>> predicate) {
  ...
  private static <K, K2, V, V2> TreeMap<K2, V2> bimap(
      @NonNull TreeMap<K, V> map,
      @NonNull EntryComparator<K2, V2> entryComparator,
  ...
  private static <K, V, K2, V2> TreeMap<K2, V2> flatMap(
      @NonNull TreeMap<K, V> map,
      @NonNull EntryComparator<K2, V2> entryComparator,
      BiFunction<? super K, ? super V, ? extends Iterable<Tuple2<K2, V2>>> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    return createTreeMap(
        entryComparator, map.entries.iterator().flatMap(entry -> mapper.apply(entry._1, entry._2)));
  }

  private static <K, K2, V, V2> TreeMap<K2, V2> map(
      @NonNull TreeMap<K, V> map,
      @NonNull EntryComparator<K2, V2> entryComparator,
  ...
  private static <K, V>
      Collector<Tuple2<K, V>, ArrayList<Tuple2<K, V>>, TreeMap<K, V>> createCollector(
    ...
    final Function<ArrayList<Tuple2<K, V>>, TreeMap<K, V>> finisher =
        list -> createTreeMap(entryComparator, list);
  ...
  private static <K, V, T> Collector<T, ArrayList<T>, TreeMap<K, V>> createCollector(
    ...
    final Function<ArrayList<T>, TreeMap<K, V>> finisher =
        arr ->
            createTreeMap(
                entryComparator,
  ...
  private static <K, K2, V, V2> TreeMap<K2, V2> createTreeMap(
      @NonNull EntryComparator<K2, V2> entryComparator,
      @NonNull Iterable<Tuple2<K, V>> entries,
  ...
  @SuppressWarnings("unchecked")
  private static <K, V> TreeMap<K, V> createFromMap(
      @NonNull EntryComparator<K, V> entryComparator,
      java.util.@NonNull Map<? extends K, ? extends V> map) {
    Objects.requireNonNull(map, "map is null");
    RedBlackTree<Tuple2<K, V>> tree = RedBlackTree.empty(entryComparator);
  ...
  @SuppressWarnings("unchecked")
  private static <K, V> TreeMap<K, V> createFromTuple(
      @NonNull EntryComparator<K, V> entryComparator,
      @NonNull Tuple2<? extends K, ? extends V> entry) {
    Objects.requireNonNull(entry, "entry is null");
  ...
  @SuppressWarnings("unchecked")
  private static <K, V> TreeMap<K, V> createFromTuples(
      @NonNull EntryComparator<K, V> entryComparator,
      @NonNull Tuple2<? extends K, ? extends V> @NonNull ... entries) {
    Objects.requireNonNull(entries, "entries is null");
    RedBlackTree<Tuple2<K, V>> tree = RedBlackTree.empty(entryComparator);
  ...
  @SafeVarargs
  private static <K, V> TreeMap<K, V> createFromMapEntries(
      @NonNull EntryComparator<K, V> entryComparator,
      java.util.Map.@NonNull Entry<? extends K, ? extends V> @NonNull ... entries) {
    Objects.requireNonNull(entries, "entries is null");
    RedBlackTree<Tuple2<K, V>> tree = RedBlackTree.empty(entryComparator);
  ...
  @SuppressWarnings("unchecked")
  private static <K, V> TreeMap<K, V> createFromPairs(
      @NonNull EntryComparator<K, V> entryComparator, @NonNull Object @NonNull ... pairs) {
    RedBlackTree<Tuple2<K, V>> tree = RedBlackTree.empty(entryComparator);
