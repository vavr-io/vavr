...
public final class TreeMap<K, V> implements SortedMap<K, V>, Serializable {
    ...
    @SafeVarargs
    public static <K extends Comparable<? super K>, V> TreeMap<K, V> ofEntries(@NonNull Tuple2<? extends K, ? extends V> @NonNull ... entries) {
    ...
    @SafeVarargs
    public static <K, V> TreeMap<K, V> ofEntries(@NonNull Comparator<? super K> keyComparator, @NonNull Tuple2<? extends K, ? extends V> @NonNull ... entries) {
    ...
    @SuppressWarnings("varargs")
    @SafeVarargs
    public static <K extends Comparable<? super K>, V> TreeMap<K, V> ofEntries(java.util.Map.@NonNull Entry<? extends K, ? extends V> @NonNull ... entries) {
    ...
    @SuppressWarnings("varargs")
    @SafeVarargs
    public static <K, V> TreeMap<K, V> ofEntries(@NonNull Comparator<? super K> keyComparator, java.util.Map.@NonNull Entry<? extends K, ? extends V> @NonNull ... entries) {
    ...
    @SuppressWarnings("unchecked")
    private static <K, V> TreeMap<K, V> createFromTuples(@NonNull EntryComparator<K, V> entryComparator, @NonNull Tuple2<? extends K, ? extends V> @NonNull ... entries) {
        Objects.requireNonNull(entries, "entries is null");
        RedBlackTree<Tuple2<K, V>> tree = RedBlackTree.empty(entryComparator);
    ...
    @SafeVarargs
    private static <K, V> TreeMap<K, V> createFromMapEntries(@NonNull EntryComparator<K, V> entryComparator, java.util.Map.@NonNull Entry<? extends K, ? extends V> @NonNull ... entries) {
        Objects.requireNonNull(entries, "entries is null");
        RedBlackTree<Tuple2<K, V>> tree = RedBlackTree.empty(entryComparator);
