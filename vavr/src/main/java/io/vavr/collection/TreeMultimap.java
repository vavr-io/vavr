 ...
 */
public final class TreeMultimap<K, V> extends AbstractMultimap<K, V, TreeMultimap<K, V>>
    implements Serializable, SortedMultimap<K, V> {

  private static final long serialVersionUID = 1L;

  /**
   * Returns a builder for TreeMultimap instances where values are stored in a sequence. Values for
  ...
  /**
   * Returns a builder for TreeMultimap instances where values are stored in a set. Values for each
  ...
  /**
   * Returns a builder for TreeMultimap instances where values are stored in a sorted set. Values
  ...
  /**
   * Returns a builder for TreeMultimap instances where values are stored in a sorted set with a
  ...
  public static class Builder<V> {
     ...
     * @return A new empty TreeMultimap.
     */
    public <K, V2 extends V> TreeMultimap<K, V2> empty(
    ...
    /**
     * Creates a {@code TreeMultimap} of the given entries. The underlying key comparator is the
     * natural comparator of K.
     *
     * @param <K> The key type
     * @param <V2> The value type
     ...
     */
    public <K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> ofEntries(
     ...
     * @return A new TreeMultimap containing the given entries.
     */
    public <K, V2 extends V> TreeMultimap<K, V2> ofEntries(
        @NonNull Comparator<? super K> keyComparator,
    ...
    @SafeVarargs
    public final <K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> ofEntries(
    ...
    @SuppressWarnings({"unchecked", "varargs"})
    @SafeVarargs
    public final <K, V2 extends V> TreeMultimap<K, V2> ofEntries(
        @NonNull Comparator<? super K> keyComparator,
        Tuple2<? extends K, ? extends V2> @NonNull ... entries) {
      Objects.requireNonNull(keyComparator, "keyComparator is null");
      Objects.requireNonNull(entries, "entries is null");
      TreeMultimap<K, V2> result = empty(keyComparator);
      for (Tuple2<? extends K, ? extends V2> entry : entries) {
     ...
     */
    public <K, V2 extends V> TreeMultimap<K, V2> ofAll(
        @NonNull Comparator<? super K> keyComparator,
     ...
     * @return A new Multimap containing the given map entries
     */
    public <K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> ofAll(
        java.util.@NonNull Map<? extends K, ? extends V2> map) {
     ...
     */
    public <T, K, V2 extends V> TreeMultimap<K, V2> ofAll(
        @NonNull Comparator<? super K> keyComparator,
     ...
     * @return A new Multimap
     */
    public <T, K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> ofAll(
        java.util.stream.@NonNull Stream<? extends T> stream,
        @NonNull Function<? super T, ? extends K> keyMapper,
        @NonNull Function<? super T, ? extends V2> valueMapper) {
    ...
    /**
     * Returns a TreeMultimap containing {@code n} values of a given Function {@code f} over a range
     * of integer values from 0 to {@code n - 1}. The underlying key comparator is the natural
     * comparator of K.
     *
     * @param <K> The key type
     * @param <V2> The value type
    ...
    public <K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> tabulate(
     ...
     */
    @SuppressWarnings("unchecked")
    public <K, V2 extends V> TreeMultimap<K, V2> tabulate(
        @NonNull Comparator<? super K> keyComparator,
        int n,
        @NonNull Function<? super Integer, ? extends Tuple2<? extends K, ? extends V2>> f) {
      Objects.requireNonNull(keyComparator, "keyComparator is null");
     ...
     * @return A TreeMultimap of size {@code n}, where each element contains the result supplied by
     *     {@code s}.
     * @throws NullPointerException if {@code s} is null
     */
    @SuppressWarnings("unchecked")
    public <K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> fill(
     ...
     */
    @SuppressWarnings("unchecked")
    public <K, V2 extends V> TreeMultimap<K, V2> fill(
        Comparator<? super K> keyComparator,
        int n,
        @NonNull Supplier<? extends Tuple2<? extends K, ? extends V2>> s) {
      Objects.requireNonNull(keyComparator, "keyComparator is null");
    ...
    /**
     * Returns a TreeMultimap containing {@code n} times the given {@code element} The underlying
     * key comparator is the natural comparator of K.
     *
     * @param <K> The key type
     * @param <V2> The value type
     * @param n The number of elements in the TreeMultimap
     * @param element The element
     * @return A TreeMultimap of size {@code 1}, where each element contains {@code n} values of
     *     {@code element._2}.
     */
    @SuppressWarnings("unchecked")
    public <K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> fill(
    ...
    public <K, V2 extends V> TreeMultimap<K, V2> fill(
        Comparator<? super K> keyComparator,
        int n,
        @NonNull Tuple2<? extends K, ? extends V2> element) {
      Objects.requireNonNull(keyComparator, "keyComparator is null");
     ...
     * @return A new Multimap containing the given entries
     */
    public <K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> of(
        K k1, V2 v1, K k2, V2 v2) {
     ...
     */
    public <K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> of(
        K k1, V2 v1, K k2, V2 v2, K k3, V2 v3) {
    ...
    public <K extends Comparable<? super K>, V2 extends V> TreeMultimap<K, V2> of(
      ...
      return of(
          Comparators.naturalComparator(), k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6, k7, v7);
    }
     ...
     * @return A new Multimap containing the given entry
     */
    public <K, V2 extends V> TreeMultimap<K, V2> of(
        @NonNull Comparator<? super K> keyComparator, K key, V2 value) {
     ...
     */
    public <K, V2 extends V> TreeMultimap<K, V2> of(
        @NonNull Comparator<? super K> keyComparator, K k1, V2 v1, K k2, V2 v2) {
     ...
     */
    public <K, V2 extends V> TreeMultimap<K, V2> of(
        @NonNull Comparator<? super K> keyComparator, K k1, V2 v1, K k2, V2 v2, K k3, V2 v3) {
    ...
    public <K, V2 extends V> TreeMultimap<K, V2> of(
        ...
        K k9,
        V2 v9) {
      return of(keyComparator, k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6, k7, v7, k8, v8)
          .put(k9, v9);
    }
    ...
    public <K, V2 extends V> TreeMultimap<K, V2> of(
        ...
        V2 v10) {
      return of(
              keyComparator, k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6, k7, v7, k8, v8, k9, v9)
          .put(k10, v10);
    }

    /**
     * Returns a singleton {@code TreeMultimap}, i.e. a {@code TreeMultimap} of one entry using a
     * specific key comparator.
     *
     * @param <K> The key type
     * @param <V2> The value type
     * @param keyComparator The comparator used to sort the entries by their key.
     ...
     */
    public <K, V2 extends V> TreeMultimap<K, V2> of(
        @NonNull Comparator<? super K> keyComparator, Tuple2<? extends K, ? extends V2> entry) {
      final TreeMultimap<K, V2> e = empty(keyComparator);
     ...
     * java.util.stream.Stream#collect(Collector)} to obtain a {@link TreeMultimap}.
     *
     * <p>The natural comparator is used to compare TreeMultimap keys.
     *
     * @param <K> The key type
     * @param <V2> The value type
     * @return A {@link TreeMultimap} Collector.
     */
    public <K extends Comparable<? super K>, V2 extends V>
        Collector<Tuple2<K, V2>, ArrayList<Tuple2<K, V2>>, TreeMultimap<K, V2>> collector() {
    ...
    public <K, V2 extends V>
      ...
      final Function<ArrayList<Tuple2<K, V2>>, TreeMultimap<K, V2>> finisher =
   ...
   *
   * <p>CAUTION: If {@code K} is narrowed, the underlying {@code Comparator} might fail!
   *
