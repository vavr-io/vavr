...
/**
 * An immutable {@code HashMap} implementation based on a <a
 * href="https://en.wikipedia.org/wiki/Hash_array_mapped_trie">Hash array mapped trie (HAMT)</a>.
 *
 * @param <K> Key type
 * @param <V> Value type
...
public final class HashMap<K, V> implements Map<K, V>, Serializable {
   ...
   * java.util.stream.Stream#collect(java.util.stream.Collector)} to obtain a {@link HashMap}.
   *
   ...
   * @return A {@link HashMap} Collector.
   */
  public static <K, V, T extends V> Collector<T, ArrayList<T>, HashMap<K, V>> collector(
  ...
  public static <K, V, T> Collector<T, ArrayList<T>, HashMap<K, V>> collector(
    ...
    final Function<ArrayList<T>, HashMap<K, V>> finisher =
        arr ->
            HashMap.ofEntries(
  ...
  /**
   * Narrows a {@code HashMap<? extends K, ? extends V>} to {@code HashMap<K, V>} via a type-safe
   ...
   * @return A new Map
   */
  public static <T, K, V> HashMap<K, V> ofAll(
  ...
  /**
   * Returns an HashMap containing {@code n} values of a given Function {@code f} over a range of
   ...
   */
  @SuppressWarnings("unchecked")
  public static <K, V> HashMap<K, V> tabulate(
   ...
   * @return An HashMap of size {@code n}, where each element contains the result supplied by {@code
   *     s}.
   * @throws NullPointerException if {@code s} is null
   */
  @SuppressWarnings("unchecked")
  public static <K, V> HashMap<K, V> fill(
   ...
   */
  @SafeVarargs
  public static <K, V> HashMap<K, V> ofEntries(
  ...
  @Override
  public <K2, V2> HashMap<K2, V2> bimap(
  ...
  @Override
  public Tuple2<V, HashMap<K, V>> computeIfAbsent(
  ...
  @Override
  public <U> HashMap<K, V> distinctBy(
  ...
  @Override
  public <K2, V2> HashMap<K2, V2> flatMap(
  ...
  @Override
  public <C> Map<C, HashMap<K, V>> groupBy(
  ...
  @Override
  public <K2, V2> HashMap<K2, V2> map(
  ...
  @Override
  public <K2> HashMap<K2, V> mapKeys(
      @NonNull Function<? super K, ? extends K2> keyMapper,
  ...
  @Override
  public Tuple2<HashMap<K, V>, HashMap<K, V>> span(
      @NonNull Predicate<? super Tuple2<K, V>> predicate) {
