...
public final class HashMap<K, V> implements Map<K, V>, Serializable {
     ...
     */
    @SafeVarargs
    public static <K, V> HashMap<K, V> ofEntries(java.util.Map.@NonNull Entry<? extends K, ? extends V>... entries) {
     ...
     */
    @SafeVarargs
    public static <K, V> HashMap<K, V> ofEntries(@NonNull Tuple2<? extends K, ? extends V>... entries) {
        Objects.requireNonNull(entries, "entries is null");
        HashArrayMappedTrie<K, V> trie = HashArrayMappedTrie.empty();
    ...
    @Override
    public <K2, V2> HashMap<K2, V2> bimap(@NonNull Function<? super K, ? extends K2> keyMapper, Function<? super V, ? extends V2> valueMapper) {
        Objects.requireNonNull(keyMapper, "keyMapper is null");
        Objects.requireNonNull(valueMapper, "valueMapper is null");
    ...
    @Override
    public <K2> HashMap<K2, V> mapKeys(@NonNull Function<? super K, ? extends K2> keyMapper, BiFunction<? super V, ? super V, ? extends V> valueMerge) {
    ...
    @Override
    public HashMap<K, V> replace(@NonNull Tuple2<K, V> currentElement, Tuple2<K, V> newElement) {
