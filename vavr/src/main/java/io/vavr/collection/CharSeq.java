...
/**
 * The CharSeq (read: character sequence) collection essentially is a rich String wrapper having all
 * operations we know from the functional Vavr collections.
 *
 * <p><strong>Note:</strong>Because CharSeq represents a sequence of primitive characters (i.e. a
 * String), it breaks the Liskov Substitution Principle in the way, that the CharSeq cannot contain
 * {@code null} elements. In future version of Java, CharSeq should extend IndexedSeq&lt;char&gt;
 * instead.
 *
 * @author Ruslan Sennov, Daniel Dietrich
 */
public final class CharSeq
    implements CharSequence, IndexedSeq<Character>, Serializable, Comparable<CharSeq> {
   ...
   * java.util.stream.Stream#collect(java.util.stream.Collector)} to obtain a {@link CharSeq}.
   *
  ...
  public static Collector<Character, ArrayList<Character>, CharSeq> collector() {
    ...
    final BinaryOperator<ArrayList<Character>> combiner =
        (left, right) -> {
          left.addAll(right);
          return left;
        };
   ...
   *
   * <p>The resulting string has the same iteration order as the given iterable of elements if the
  ...
  /**
   * Returns a CharSeq containing {@code n} values of a given Function {@code f} over a range of
   ...
   * @return A CharSeq of size {@code n}, where each element contains the result supplied by {@code
   *     s}.
  ...
  /**
   * Creates a CharSeq starting from character {@code from}, extending to character {@code
   * toExclusive - 1}.
   *
   * <p>Examples:
   *
   ...
   * @param toExclusive the successor of the last character
   * @param step the step
   * @return a range of characters from {@code from} (inclusive) to {@code toExclusive} (exclusive)
   *     by {@code step}, or an empty CharSeq if the parameters would result in an empty range
   */
   ...
   * @param toInclusive the last character
   * @param step the step
   * @return a range of characters as specified or the empty range if {@code step * (from -
   *     toInclusive) > 0}.
   * @throws IllegalArgumentException if {@code step} is zero
   */
  public static CharSeq rangeClosedBy(char from, char toInclusive, int step) {
    return new CharSeq(
        io.vavr.collection.Iterator.rangeClosedBy(from, toInclusive, step).mkString());
  }

  /**
   * Creates a CharSeq from a seed value and a function. The function takes the seed at first. The
   * function should return {@code None} when it's done generating the CharSeq, otherwise {@code
   * Some} {@code Tuple} of the element for the next call and the value to add to the resulting
   * CharSeq.
   *
   * <p>Example:
   *
   ...
   * @throws NullPointerException if {@code f} is null
   */
  public static <T> CharSeq unfoldRight(
      T seed, Function<? super T, Option<Tuple2<? extends Character, ? extends T>>> f) {
   ...
   * Creates a CharSeq from a seed value and a function. The function takes the seed at first. The
   * function should return {@code None} when it's done generating the CharSeq, otherwise {@code
   * Some} {@code Tuple} of the value to add to the resulting CharSeq and the element for the next
   * call.
   *
   * <p>Example:
   *
   ...
   * @throws NullPointerException if {@code f} is null
   */
  public static <T> CharSeq unfoldLeft(
      T seed, Function<? super T, Option<Tuple2<? extends T, ? extends Character>>> f) {
   ...
   *
   * <p>Example: {@code CharSeq.of("ja").repeat(13) = "jajajajajajajajajajajajaja"}
   *
   * @param times Repetition count
  ...
  @Override
  public <R> IndexedSeq<R> collect(
      @NonNull PartialFunction<? super Character, ? extends R> partialFunction) {
  ...
  @Override
  public <U> CharSeq distinctByKeepLast(
      @NonNull Function<? super Character, ? extends U> keyExtractor) {
    Objects.requireNonNull(keyExtractor, "keyExtractor is null");
  ...
  @Override
  public <U> IndexedSeq<U> flatMap(
      @NonNull Function<? super Character, ? extends Iterable<? extends U>> mapper) {
  ...
  /**
   * FlatMaps this {@code CharSeq} to a new {@code CharSeq} by applying a {@code CharFunction} to
   * each character, which returns a {@code CharSequence}, and concatenating the results.
   *
   * <p>This is a specialized version of {@link #flatMap(Function)} for primitive characters that
   * returns a {@code CharSeq} instead of an {@code IndexedSeq<Character>}.
   *
  ...
  public CharSeq insert(int index, Character element) {
    ...
    if (index > length()) {
      throw new IndexOutOfBoundsException(
          "insert(" + index + ", e) on String of length " + length());
    }
    final char c = element;
  ...
  public CharSeq insertAll(int index, @NonNull Iterable<? extends Character> elements) {
    ...
    if (index > length()) {
      throw new IndexOutOfBoundsException(
          "insertAll(" + index + ", elements) on String of length " + length());
    }
  ...
  /**
   * Maps this {@code CharSeq} to a new {@code CharSeq} by applying a {@code CharUnaryOperator} to
   * each character.
   *
   * <p>This is a specialized version of {@link #map(Function)} for primitive characters that
   * returns a {@code CharSeq} instead of an {@code IndexedSeq<Character>}.
   *
  ...
  public CharSeq scan(
      Character zero,
      @NonNull BiFunction<? super Character, ? super Character, ? extends Character> operation) {
    return io.vavr.collection.Collections.scanLeft(
        this, zero, operation, io.vavr.collection.Iterator::toCharSeq);
  }

  @Override
  public <U> IndexedSeq<U> scanLeft(
      U zero, @NonNull BiFunction<? super U, ? super Character, ? extends U> operation) {
    return io.vavr.collection.Collections.scanLeft(
        this, zero, operation, io.vavr.collection.Iterator::toVector);
  }

  @Override
  public <U> IndexedSeq<U> scanRight(
      U zero, @NonNull BiFunction<? super Character, ? super U, ? extends U> operation) {
    return io.vavr.collection.Collections.scanRight(
        this, zero, operation, io.vavr.collection.Iterator::toVector);
  }
  ...
  @Override
  public io.vavr.collection.Iterator<CharSeq> slideBy(
      @NonNull Function<? super Character, ?> classifier) {
  ...
  @Override
  public <U extends Comparable<? super U>> CharSeq sortBy(
      @NonNull Function<? super Character, ? extends U> mapper) {
    return sortBy(U::compareTo, mapper);
  }

  @Override
  public <U> CharSeq sortBy(
      @NonNull Comparator<? super U> comparator, Function<? super Character, ? extends U> mapper) {
  ...
  public <T1, T2> Tuple2<IndexedSeq<T1>, IndexedSeq<T2>> unzip(
      @NonNull Function<? super Character, Tuple2<? extends T1, ? extends T2>> unzipper) {
  ...
  public <T1, T2, T3> Tuple3<IndexedSeq<T1>, IndexedSeq<T2>, IndexedSeq<T3>> unzip3(
      @NonNull Function<? super Character, Tuple3<? extends T1, ? extends T2, ? extends T3>>
          unzipper) {
    Objects.requireNonNull(unzipper, "unzipper is null");
    IndexedSeq<T1> xs = Vector.empty();
    IndexedSeq<T2> ys = Vector.empty();
  ...
  @Override
  public CharSeq update(
      int index, @NonNull Function<? super Character, ? extends Character> updater) {
  ...
  @Override
  public <U, R> IndexedSeq<R> zipWith(
      @NonNull Iterable<? extends U> that,
      BiFunction<? super Character, ? super U, ? extends R> mapper) {
  ...
  @Override
  public <U> IndexedSeq<Tuple2<Character, U>> zipAll(
      @NonNull Iterable<? extends U> that, Character thisElem, U thatElem) {
    Objects.requireNonNull(that, "that is null");
  ...
  @Override
  public <U> IndexedSeq<U> zipWithIndex(
      @NonNull BiFunction<? super Character, ? super Integer, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    IndexedSeq<U> result = Vector.empty();
    for (int i = 0; i < length(); i++) {
  ...
  @Override
  public Tuple2<CharSeq, CharSeq> splitAtInclusive(
      @NonNull Predicate<? super Character> predicate) {
    Objects.requireNonNull(predicate, "predicate is null");
    if (isEmpty()) {
      return Tuple.of(EMPTY, EMPTY);
    }
   ...
   *
   * <p>If the {@code char} value specified by the index is a <a
   ...
   *
   * <p>If the {@code char} value specified at the given index is in the high-surrogate range, the
   * following index is less than the length of this {@code CharSeq}, and the {@code char} value at
   * the following index is in the low-surrogate range, then the supplementary code point
  ...
  /**
   * Returns the number of Unicode code points in the specified text range of this {@code CharSeq}.
   ...
   *     larger than the length of this {@code CharSeq}, or {@code beginIndex} is larger than {@code
   *     endIndex}.
   */
  ...
  /**
   * Returns the index within this {@code CharSeq} that is offset from the given {@code index} by
   ...
   *     this {@code CharSeq}, or if {@code codePointOffset} is positive and the substring starting
   ...
   * copied is at index {@code srcEnd-1} (thus the total number of characters to be copied is {@code
  ...
  /**
   * Encodes this {@code CharSeq} into a sequence of bytes using the named charset, storing the
  ...
  /**
   * Encodes this {@code CharSeq} into a sequence of bytes using the given {@linkplain
   ...
   * only if this {@code CharSeq} represents the same sequence of characters as the specified {@code
   ...
   * @return {@code true} if this {@code CharSeq} represents the same sequence of characters as the
   ...
   * only if this {@code CharSeq} represents the same sequence of char values as the specified
   ...
   * @return {@code true} if this {@code CharSeq} represents the same sequence of char values as the
  ...
  /**
   * Compares this {@code CharSeq} to another {@code CharSeq}, ignoring case considerations. Two
   * strings are considered equal ignoring case if they are of the same length and corresponding
   * characters in the two strings are equal ignoring case.
   *
   * <p>Two characters {@code c1} and {@code c2} are considered the same ignoring case if at least
   * one of the following is true:
   *
   * <ul>
   *   <li>The two characters are the same (as compared by the {@code ==} operator)
   *   <li>Applying the method {@link Character#toUpperCase(char)} to each character produces the
   *       same result
   *   <li>Applying the method {@link Character#toLowerCase(char)} to each character produces the
   *       same result
   * </ul>
   *
   ...
   *     CharSeq} ignoring case; {@code false} otherwise
   * @see #equals(Object)
   */
   ...
   * character in the strings. The character sequence represented by this {@code CharSeq} object is
   * compared lexicographically to the character sequence represented by the argument string. The
   * result is a negative integer if this {@code CharSeq} object lexicographically precedes the
   * argument string. The result is a positive integer if this {@code CharSeq} object
   ...
   * return {@code true}.
   *
   * <p>This is the definition of lexicographic ordering. If two strings are different, then either
   ...
   * <i>k</i> has the smaller value, as determined by using the &lt; operator, lexicographically
   * precedes the other string. In this case, {@code compareTo} returns the difference of the two
   * character values at position {@code k} in the two string -- that is, the value:
   *
   * <blockquote>
   *
   * <pre>
   ...
   * integer whose sign is that of calling {@code compareTo} with normalized versions of the strings
   * where case differences have been eliminated by calling {@code
   ...
   *
   * <p>A substring of this {@code CharSeq} object is compared to a substring of the argument other.
   * The result is true if these substrings represent identical character sequences. The substring
   * of this {@code CharSeq} object to be compared begins at index {@code toffset} and has length
   * {@code len}. The substring of other to be compared begins at index {@code ooffset} and has
   * length {@code len}. The result is {@code false} if and only if at least one of the following is
   * true:
   *
   * <ul>
   *   <li>{@code toffset} is negative.
   *   <li>{@code ooffset} is negative.
   *   <li>{@code toffset+len} is greater than the length of this {@code CharSeq} object.
   *   <li>{@code ooffset+len} is greater than the length of the other argument.
   *   <li>There is some nonnegative integer <i>k</i> less than {@code len} such that: {@code
   *       this.charAt(toffset + }<i>k</i>{@code ) != other.charAt(ooffset + } <i>k</i>{@code )}
   * </ul>
   *
   ...
   * Tests if two string regions are equal.
   *
   * <p>A substring of this {@code CharSeq} object is compared to a substring of the argument {@code
   * other}. The result is {@code true} if these substrings represent character sequences that are
   * the same, ignoring case if and only if {@code ignoreCase} is true. The substring of this {@code
   * CharSeq} object to be compared begins at index {@code toffset} and has length {@code len}. The
   * substring of {@code other} to be compared begins at index {@code ooffset} and has length {@code
   * len}. The result is {@code false} if and only if at least one of the following is true:
   *
   * <ul>
   *   <li>{@code toffset} is negative.
   *   <li>{@code ooffset} is negative.
   *   <li>{@code toffset+len} is greater than the length of this {@code CharSeq} object.
   *   <li>{@code ooffset+len} is greater than the length of the other argument.
   *   <li>{@code ignoreCase} is {@code false} and there is some nonnegative integer <i>k</i> less
  ...
  public boolean regionMatches(
      boolean ignoreCase, int toffset, CharSeq other, int ooffset, int len) {
   ...
   *     {@code CharSeq} object; otherwise the result is the same as the result of the expression
   *     <pre>
   ...
   *     {@code true} will be returned if the argument is an empty string or is equal to this {@code
   *     CharSeq} object as determined by the {@link #equals(Object)} method.
   */
   ...
   *     result will be {@code true} if the argument is the empty string or is equal to this {@code
   *     CharSeq} object as determined by the {@link #equals(Object)} method.
   */
   ...
   * CharSeq} object, then the index (in Unicode code units) of the first such occurrence is
   ...
   *
   * <p>If a character with value {@code ch} occurs in the character sequence represented by this
   * {@code CharSeq} object at an index no smaller than {@code fromIndex}, then the index of the
   ...
   * @return the index of the first occurrence of the character in the character sequence
   *     represented by this object that is greater than or equal to {@code fromIndex}, or {@code
  ...
  /**
   * Returns the index of the first occurrence of the given element as an {@code Option}, starting
   ...
   *
   * is true. In either case, if no such character occurs in this string, then {@code -1} is
   * returned. The {@code CharSeq} is searched backwards starting at the last character.
   *
   * @param ch a character (Unicode code point).
  ...
  /**
   * Returns the index of the last occurrence of the given element as an {@code Option}, starting
   * the search at the specified index.
   *
   * @param ch a character (Unicode code point).
   * @param fromIndex the index to start the search from.
   ...
   * @return the specified substring.
   * @throws IndexOutOfBoundsException if the {@code beginIndex} is negative, or {@code endIndex} is
   *     larger than the length of this {@code CharSeq} object, or {@code beginIndex} is larger than
   *     {@code endIndex}.
   */
   ...
   *
   * <p>If the length of the argument string is {@code 0}, then this {@code CharSeq} object is
   * returned. Otherwise, a {@code CharSeq} object is returned that represents a character sequence
   * that is the concatenation of the character sequence represented by this {@code CharSeq} object
   ...
   * </blockquote>
   *
   * @param str the {@code CharSeq} that is concatenated to the end of this {@code CharSeq}.
   ...
   * href="https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html#sum">regular
   * expression</a>.
   *
   ...
   * <blockquote>
   *
   * {@code {@link Pattern}.{@link Pattern#compile(String) compile}(<i>regex</i>).{@link
   * Pattern#matcher(CharSequence) matcher}(<i>str</i>).{@link java.util.regex.Matcher#replaceFirst
   ...
   * string; see {@link java.util.regex.Matcher#replaceFirst}. Use {@link
   * java.util.regex.Matcher#quoteReplacement} to suppress the special meaning of these characters,
   * if desired.
   *
   * @param regex the regular expression to which this string is to be matched
   ...
   *
   * {@code {@link Pattern}.{@link Pattern#compile(String) compile}(<i>regex</i>).{@link
   * Pattern#matcher(CharSequence) matcher}(<i>str</i>).{@link java.util.regex.Matcher#replaceAll
   * replaceAll}(<i>repl</i>) }
   *
   * </blockquote>
   *
   * Note that backslashes ({@code \}) and dollar signs ({@code $}) in the replacement string may
   * cause the results to be different than if it were being treated as a literal replacement
   * string; see {@link java.util.regex.Matcher#replaceAll Matcher.replaceAll}. Use {@link
   * java.util.regex.Matcher#quoteReplacement} to suppress the special meaning of these characters,
   * if desired.
   *
   * @param regex the regular expression to which this string is to be matched
   ...
   * expression</a>.
   *
   * <p>This method works as if by invoking the two-argument {@link #split(String, int)} method with
   * the given expression and a limit argument of zero. Trailing empty strings are therefore not
   * included in the resulting {@link Seq}.
   *
   ...
   * @return the Seq of strings computed by splitting this string around matches of the given
   *     regular expression
   * @throws PatternSyntaxException if the regular expression's syntax is invalid
   * @see Pattern
   */
   ...
   * therefore affects the length of the resulting array. If the limit <i>n</i> is greater than zero
   * then the pattern will be applied at most <i>n</i>&nbsp;-&nbsp;1 times, the array's length will
   * be no greater than <i>n</i>, and the array's last entry will contain all input beyond the last
   * matched delimiter. If <i>n</i> is non-positive then the pattern will be applied as many times
   * as possible and the array can have any length. If <i>n</i> is zero then the pattern will be
   * applied as many times as possible, the array can have any length, and trailing empty strings
   * will be discarded.
   *
   * <p>The string {@code "boo:and:foo"}, for example, yields the following results with these
   * parameters:
   ...
   * </blockquote>
   *
   * An invocation of this method of the form <i>str.</i>{@code split(}<i>regex</i>{@code
  ...
  /**
   * Converts all of the characters in this {@code CharSeq} to lower case using the rules of the
   ...
   * resulting {@code CharSeq} may be a different length than the original {@code CharSeq}.
   *
   * <p>Examples of lowercase mappings are in the following table:
   *
   * <table border="1">
   ...
   *
   * <p><b>Note:</b> This method is locale sensitive, and may produce unexpected results if used for
  ...
  /**
   * Converts all of the characters in this {@code CharSeq} to upper case using the rules of the
   * given {@code Locale}. Case mapping is based on the Unicode Standard version specified by the
   * {@link Character Character} class. Since case mappings are not always 1:1 char mappings, the
   * resulting {@code CharSeq} may be a different length than the original {@code CharSeq}.
   *
   * <p>Examples of locale-sensitive and 1:M case mappings are in the following table.
   *
   * <table border="1">
   ...
   * LETTER I WITH DOT ABOVE character. To obtain correct results for locale insensitive strings,
   * use {@code toUpperCase(Locale.ROOT)}.
   *
   * @return the {@code CharSeq}, converted to uppercase.
   * @see String#toUpperCase(Locale)
   */
  ...
  /**
   * Converts the first character in this {@code CharSeq} to upper case using the rules of the given
   * {@code Locale}. If the {@code CharSeq} is empty, it won't have any effect. Case mapping is
   * based on the Unicode Standard version specified by the {@link Character Character} class. Since
   * case mappings are not always 1:1 char mappings, the resulting {@code CharSeq} may be a
   * different length than the original {@code CharSeq}.
   *
   * <p>Examples of locale-sensitive and 1:M case mappings are in the following table.
   *
   * <table border="1">
  ...
  /**
   * Converts the first character in this {@code CharSeq} to upper case using the rules of the
   * default locale. If the {@code CharSeq} is empty, it won't have any effect. This method is
   * equivalent to {@code capitalize(Locale.getDefault())}.
   *
   * <p><b>Note:</b> This method is locale sensitive, and may produce unexpected results if used for
   * strings that are intended to be interpreted locale independently. Examples are programming
   * language identifiers, protocol keys, and HTML tags. For instance, {@code "title".toUpperCase()}
   ...
   *
   * <p>If this {@code CharSeq} object represents an empty character sequence, or the first and last
   * characters of character sequence represented by this {@code CharSeq} object both have codes
   * greater than {@code '\u005Cu0020'} (the space character), then a reference to this {@code
   * CharSeq} object is returned.
   *
   * <p>Otherwise, if there is no character with a code greater than {@code '\u005Cu0020'} in the
   * string, then a {@code CharSeq} object representing an empty string is returned.
   *
   * <p>Otherwise, let <i>k</i> be the index of the first character in the string whose code is
   * greater than {@code '\u005Cu0020'}, and let <i>m</i> be the index of the last character in the
   * string whose code is greater than {@code '\u005Cu0020'}. A {@code CharSeq} object is returned,
   * representing the substring of this string that begins with the character at index <i>k</i> and
   * ends with the character at index <i>m</i>-that is, the result of {@code this.substring(k, m +
   * 1)}.
   *
   * <p>This method may be used to trim whitespace (as defined above) from the beginning and end of
   * a string.
   *
  ...
  /**
   * Parses this {@code CharSeq} as a signed byte in the specified radix by calling {@link
  ...
  /**
   * Parses this {@code CharSeq} as a signed decimal int by calling {@link
  ...
  /**
   * Parses this {@code CharSeq} as a signed int in the specified radix by calling {@link
  ...
  /**
   * Parses this {@code CharSeq} as a unsigned decimal int by calling {@link
  ...
  /**
   * Parses this {@code CharSeq} as a unsigned int in the specified radix by calling {@link
  ...
  /**
   * Parses this {@code CharSeq} as a signed long in the specified radix by calling {@link
  ...
  /**
   * Parses this {@code CharSeq} as a unsigned decimal long by calling {@link
   ...
   * @throws NumberFormatException If this {@code CharSeq} does not contain a parsable unsigned
   *     long.
   */
  ...
  /**
   * Parses this {@code CharSeq} as a unsigned long in the specified radix by calling {@link
  ...
  /**
   * Parses this {@code CharSeq} as a signed decimal short by calling {@link
  ...
  /**
   * Parses this {@code CharSeq} as a signed short in the specified radix by calling {@link
  ...
  /**
   * Converts this {@code CharSeq} to a {@code Byte} in the specified radix by calling {@link
  ...
  /**
   * Converts this {@code CharSeq} to an {@code Integer} in the specified radix by calling {@link
  ...
  /**
   * Converts this {@code CharSeq} to a {@code Long} in the specified radix by calling {@link
  ...
  /**
   * Converts this {@code CharSeq} to a {@code Short} in the specified radix by calling {@link
   ...
   * char}-valued result. This is the primitive type specialization of {@link
   * java.util.function.UnaryOperator} for {@code char}.
   *
  ...
  /**
   * Represents a function that accepts a {@code char}-valued argument and produces a result. This
   * is the {@code char}-consuming primitive specialization for {@link java.util.function.Function}.
   *
