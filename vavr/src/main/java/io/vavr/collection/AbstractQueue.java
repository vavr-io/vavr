...
abstract class AbstractQueue<T, Q extends AbstractQueue<T, Q>> implements Traversable<T> {
   ...
   * Removes an element from this Queue.
   *
   * @return {@code None} if this Queue is empty, otherwise {@code Some} {@code Tuple} containing
   *     the first element and the remaining elements of this Queue
   */
   ...
   *
   * @return {@code None} if this Queue is empty, otherwise a {@code Some} containing the first
   *     element
   */
