 ...
 */
public final class LinkedHashMultimap<K, V> extends AbstractMultimap<K, V, LinkedHashMultimap<K, V>>
  ...
  public static class Builder<V> {
     ...
     */
    public <K, V2 extends V> LinkedHashMultimap<K, V2> ofEntries(
     ...
     */
    @SafeVarargs
    public final <K, V2 extends V> LinkedHashMultimap<K, V2> ofEntries(
     ...
     */
    public <K, V2 extends V> LinkedHashMultimap<K, V2> ofAll(
     ...
     */
    public <T, K, V2 extends V> LinkedHashMultimap<K, V2> ofAll(
    ...
    /**
     * Returns a LinkedHashMultimap containing {@code n} values of a given Function {@code f} over a
     * range of integer values from 0 to {@code n - 1}.
     *
     * @param <K> The key type
     * @param <V2> The value type
    ...
    public <K, V2 extends V> LinkedHashMultimap<K, V2> tabulate(
    ...
    /**
     * Returns a LinkedHashMultimap containing {@code n} values supplied by a given Supplier {@code
     * s}.
     *
     * @param <K> The key type
     * @param <V2> The value type
     ...
     * @return A LinkedHashMultimap of size {@code n}, where each element contains the result
     *     supplied by {@code s}.
     * @throws NullPointerException if {@code s} is null
     */
    @SuppressWarnings("unchecked")
    public <K, V2 extends V> LinkedHashMultimap<K, V2> fill(
     ...
     * @return A LinkedHashMultimap of size {@code 1}, where each element contains {@code n} values
     *     of {@code element._2}.
     */
    @SuppressWarnings("unchecked")
    public <K, V2 extends V> LinkedHashMultimap<K, V2> fill(
     ...
     * @return A new Multimap containing the given entries
     */
    public <K, V2 extends V> LinkedHashMultimap<K, V2> of(
    ...
    /**
     * Creates a LinkedHashMultimap of the given key-value pair. Returns a singleton {@code
     * LinkedHashMultimap}, i.e. a {@code LinkedHashMultimap} of one entry.
     *
     * @param <K> The key type
     * @param <V2> The value type
     ...
     * java.util.stream.Stream#collect(Collector)} to obtain a {@link LinkedHashMultimap}.
     *
     * @param <K> The key type
     * @param <V2> The value type
  ...
  /**
   * Narrows a {@code LinkedHashMultimap<? extends K, ? extends V>} to {@code LinkedHashMultimap<K,
   * V>} via a type-safe cast. Safe here because the multimap is immutable and no elements can be
   * added that would violate the type (covariance)
   *
   ...
   */
  @SuppressWarnings("unchecked")
  public static <K, V> LinkedHashMultimap<K, V> narrow(
      LinkedHashMultimap<? extends K, ? extends V> map) {
  ...
  @Override
  protected <K2, V2> LinkedHashMultimap<K2, V2> createFromMap(
      @NonNull Map<K2, Traversable<V2>> back) {
