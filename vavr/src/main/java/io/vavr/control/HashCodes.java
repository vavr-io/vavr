...
/**
 * Utility that allows to compute hashcodes without var-arg conversion into arrays for common types
 * of vavr.
 *
...
class HashCodes {
   ...
   *
   * <p>The hashcode is equivalent to the hashcode of a {@link java.util.List} containing the two
   * given values.
   *
   * <p>More formally, it returns the value {@code 31 * (31 + hash(v1)) + hash(v2)}.
   *
   ...
   *
   * <p>The hashcode is equivalent to the hashcode of a {@link java.util.List} containing the given
   * values.
   *
   * @param v1 the first value to hash
   * @param v2 the second value to hash
   ...
   */
  static int hash(
      Object v1, Object v2, Object v3, Object v4, Object v5, Object v6, Object v7, Object v8) {
    int result = 1;
    result = 31 * result + hash(v1);
    result = 31 * result + hash(v2);
    result = 31 * result + hash(v3);
