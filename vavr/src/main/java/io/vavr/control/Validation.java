...
/**
 * An implementation similar to Scalaz's <a
 * href="http://eed3si9n.com/learning-scalaz/Validation.html">Validation</a> control.
 *
 * <p>The {@code Validation} type is an applicative functor, not a Monad. While a Monad
 * short-circuits on the first error, an applicative functor accumulates all errors, making it
 * particularly useful for validation scenarios where all errors should be reported.
 *
 * <pre>{@code
 ...
 * @author Eric Nelson
 * @see <a
 *     href="https://github.com/scalaz/scalaz/blob/series/7.3.x/core/src/main/scala/scalaz/Validation.scala">
...
public interface Validation<E, T> extends Value<T>, Serializable {
   ...
   * @param <E> error type
   * @param <T> value type
   * @return A {@code Valid(either.get())} if either is a Right, otherwise {@code
   *     Invalid(either.getLeft())}.
   ...
   * @return A valid Validation of a sequence of values if all Validation instances are valid or an
   *     invalid Validation containing an accumulated List of errors.
   * @throws NullPointerException if values is null
   */
  static <E, T> Validation<Seq<E>, Seq<T>> sequence(
      @NonNull Iterable<? extends Validation<? extends Seq<? extends E>, ? extends T>> values) {
  ...
  /**
   * Maps the values of an iterable to a sequence of mapped values into a single {@code Validation}
   * by transforming an {@code Iterable<? extends T>} into a {@code Validation<Seq<U>>}.
   *
  ...
  static <E, T, U> Validation<Seq<E>, Seq<U>> traverse(
      ...
      @NonNull Function<? super T, ? extends Validation<? extends Seq<? extends E>, ? extends U>>
          mapper) {
    Objects.requireNonNull(values, "values is null");
  ...
  /**
   * Narrows a widened {@code Validation<? extends E, ? extends T>} to {@code Validation<E, T>} by
  ...
  /**
   * Decides which {@code Validation<E, T>} to return, depending on the test value - if it's true,
   * the result will be a {@link Validation.Valid}, if it's false - the result will be a {@link
   * Validation.Invalid}
   *
   ...
   * @param <E> Type of error
   * @param <T> Type of valid value
   * @return {@code Validation<E, T>} with valid value or error, depending on the test condition
   *     evaluation
   * @throws NullPointerException if any of the arguments is null
   */
  static <E, T> Validation<E, T> cond(
      boolean test, @NonNull Supplier<? extends T> valid, @NonNull Supplier<? extends E> error) {
  ...
  static <E, T1, T2> Builder<E, T1, T2> combine(
      @NonNull Validation<E, T1> validation1, @NonNull Validation<E, T2> validation2) {
   ...
   */
  static <E, T1, T2, T3> Builder3<E, T1, T2, T3> combine(
      @NonNull Validation<E, T1> validation1,
      @NonNull Validation<E, T2> validation2,
      @NonNull Validation<E, T3> validation3) {
    Objects.requireNonNull(validation1, "validation1 is null");
    Objects.requireNonNull(validation2, "validation2 is null");
   ...
   */
  static <E, T1, T2, T3, T4> Builder4<E, T1, T2, T3, T4> combine(
      @NonNull Validation<E, T1> validation1,
      @NonNull Validation<E, T2> validation2,
      @NonNull Validation<E, T3> validation3,
      @NonNull Validation<E, T4> validation4) {
    Objects.requireNonNull(validation1, "validation1 is null");
    Objects.requireNonNull(validation2, "validation2 is null");
    Objects.requireNonNull(validation3, "validation3 is null");
   ...
   * @throws NullPointerException if validation1, validation2, validation3, validation4 or
   *     validation5 is null
   */
  static <E, T1, T2, T3, T4, T5> Builder5<E, T1, T2, T3, T4, T5> combine(
      @NonNull Validation<E, T1> validation1,
      @NonNull Validation<E, T2> validation2,
      @NonNull Validation<E, T3> validation3,
      @NonNull Validation<E, T4> validation4,
      @NonNull Validation<E, T5> validation5) {
    Objects.requireNonNull(validation1, "validation1 is null");
    Objects.requireNonNull(validation2, "validation2 is null");
    Objects.requireNonNull(validation3, "validation3 is null");
    Objects.requireNonNull(validation4, "validation4 is null");
   ...
   * @throws NullPointerException if validation1, validation2, validation3, validation4, validation5
   *     or validation6 is null
   */
  static <E, T1, T2, T3, T4, T5, T6> Builder6<E, T1, T2, T3, T4, T5, T6> combine(
      @NonNull Validation<E, T1> validation1,
      @NonNull Validation<E, T2> validation2,
      @NonNull Validation<E, T3> validation3,
      @NonNull Validation<E, T4> validation4,
      @NonNull Validation<E, T5> validation5,
      @NonNull Validation<E, T6> validation6) {
    Objects.requireNonNull(validation1, "validation1 is null");
    Objects.requireNonNull(validation2, "validation2 is null");
    Objects.requireNonNull(validation3, "validation3 is null");
    Objects.requireNonNull(validation4, "validation4 is null");
    ...
    return new Builder6<>(
        validation1, validation2, validation3, validation4, validation5, validation6);
  }
   ...
   * @throws NullPointerException if validation1, validation2, validation3, validation4,
   *     validation5, validation6 or validation7 is null
   */
  static <E, T1, T2, T3, T4, T5, T6, T7> Builder7<E, T1, T2, T3, T4, T5, T6, T7> combine(
      @NonNull Validation<E, T1> validation1,
      @NonNull Validation<E, T2> validation2,
      @NonNull Validation<E, T3> validation3,
      @NonNull Validation<E, T4> validation4,
      @NonNull Validation<E, T5> validation5,
      @NonNull Validation<E, T6> validation6,
      @NonNull Validation<E, T7> validation7) {
    Objects.requireNonNull(validation1, "validation1 is null");
    Objects.requireNonNull(validation2, "validation2 is null");
    Objects.requireNonNull(validation3, "validation3 is null");
    Objects.requireNonNull(validation4, "validation4 is null");
    ...
    return new Builder7<>(
        validation1, validation2, validation3, validation4, validation5, validation6, validation7);
  }
   ...
   * @throws NullPointerException if validation1, validation2, validation3, validation4,
   *     validation5, validation6, validation7 or validation8 is null
   */
  static <E, T1, T2, T3, T4, T5, T6, T7, T8> Builder8<E, T1, T2, T3, T4, T5, T6, T7, T8> combine(
      @NonNull Validation<E, T1> validation1,
      @NonNull Validation<E, T2> validation2,
      @NonNull Validation<E, T3> validation3,
      @NonNull Validation<E, T4> validation4,
      ...
      @NonNull Validation<E, T6> validation6,
      @NonNull Validation<E, T7> validation7,
      @NonNull Validation<E, T8> validation8) {
    Objects.requireNonNull(validation1, "validation1 is null");
    Objects.requireNonNull(validation2, "validation2 is null");
    Objects.requireNonNull(validation3, "validation3 is null");
    Objects.requireNonNull(validation4, "validation4 is null");
  ...
  /**
   * Returns this {@code Validation} if it is valid, otherwise return the result of evaluating
   * supplier.
   *
   * @param supplier An alternative {@code Validation} supplier
   * @return this {@code Validation} if it is valid, otherwise return the result of evaluating
   *     supplier.
   */
  @SuppressWarnings("unchecked")
  default Validation<E, T> orElse(
      @NonNull Supplier<Validation<? extends E, ? extends T>> supplier) {
  ...
  /**
   * Gets the value of this {@code Validation} if is a {@code Valid} or throws if this is an {@code
   * Invalid}.
   *
  ...
  /**
   * Gets the error of this Validation if it is an {@code Invalid} or throws if this is a {@code
   * Valid}.
   *
   ...
   *
   * @return {@code Either.right(get())} if this is valid, otherwise {@code
   *     Either.left(getError())}.
   */
  ...
  /**
   * Performs the given action for the value contained in {@code Valid}, or does nothing if this is
   * an {@code Invalid}.
   *
   ...
   * @return {@code ifValid.apply(get())} if this is valid, otherwise {@code
   *     ifInvalid.apply(getError())}.
   * @throws NullPointerException if one of the given mappers {@code ifInvalid} or {@code ifValid}
   *     is null
   */
  default <U> U fold(
      @NonNull Function<? super E, ? extends U> ifInvalid,
      @NonNull Function<? super T, ? extends U> ifValid) {
  ...
  /**
   * Flip the valid/invalid values for this Validation. If this is a Valid&lt;E,T&gt;, returns
   * Invalid&lt;T,E&gt;. Or if this is an Invalid&lt;E,T&gt;, return a Valid&lt;T,E&gt;.
   *
  ...
  /**
   * Whereas map only performs a mapping on a valid Validation, and mapError performs a mapping on
   * an invalid Validation, bimap allows you to provide mapping actions for both, and will give you
   * the result based on what type of Validation this is. Without this, you would have to do
   * something like:
   *
   * <p>validation.map(...).mapError(...);
   *
  ...
  default <E2, T2> Validation<E2, T2> bimap(
      @NonNull Function<? super E, ? extends E2> errorMapper,
      @NonNull Function<? super T, ? extends T2> valueMapper) {
  ...
  /**
   * Applies a function f to the error of this Validation if this is an Invalid. Otherwise does
   * nothing if this is a Valid.
   *
  ...
  /**
   * Applies a validation containing a function to this validation's value, combining errors if both
   * are invalid. This is the applicative functor's ap operation for Validation.
   *
   * @param <U> type of the result of applying the function
   * @param validation the validation containing the function to apply
   * @return a valid Validation with the result if both are valid, otherwise an invalid Validation
   *     with accumulated errors
   * @throws NullPointerException if validation is null
   */
  default <U> Validation<Seq<E>, U> ap(
      @NonNull Validation<Seq<E>, ? extends Function<? super T, ? extends U>> validation) {
  ...
  /**
   * Combines two {@code Validation}s to form a {@link Builder}, which can then be used to perform
   * further combines, or apply a function to it in order to transform the {@link Builder} into a
   * {@code Validation}.
   *
  ...
  /**
   * Filters this {@code Validation} by testing a predicate on the value. If this is an Invalid or
   * if the predicate matches, returns Some of this Validation, otherwise returns None.
   *
   * @param predicate A predicate to test the value
   * @return {@code Some(this)} if this is an Invalid or the predicate matches, otherwise {@code
   *     None}
   ...
   */
  @SuppressWarnings("unchecked")
  default <U> Validation<E, U> flatMap(
      @NonNull Function<? super T, ? extends Validation<E, ? extends U>> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
  ...
  final class Valid<E, T> implements Validation<E, T>, Serializable {
    ...
    public boolean equals(Object obj) {
      return (obj == this)
          || (obj instanceof Valid && Objects.equals(value, ((Valid<?, ?>) obj).value));
    }
  ...
  final class Invalid<E, T> implements Validation<E, T>, Serializable {
    ...
    public boolean equals(Object obj) {
      return (obj == this)
          || (obj instanceof Invalid && Objects.equals(error, ((Invalid<?, ?>) obj).error));
    }
  ...
  /**
   * A builder that holds two Validation instances, used for combining validations and applying
  ...
  final class Builder<E, T1, T2> {
    ...
    /**
     * Applies a binary function to the values of the two validations held by this builder. If all
     * validations are valid, the function is applied. Otherwise, errors are accumulated.
     *
  ...
  /**
   * A builder that holds three Validation instances, used for combining validations and applying
  ...
  final class Builder3<E, T1, T2, T3> {
    ...
    /**
     * Applies a ternary function to the values of the three validations held by this builder. If
     * all validations are valid, the function is applied. Otherwise, errors are accumulated.
     *
     * @param <R> type of the result
     * @param f the function to apply
     * @return a Validation with the result or accumulated errors
  ...
  /**
   * A builder that holds four Validation instances, used for combining validations and applying
  ...
  final class Builder4<E, T1, T2, T3, T4> {
    ...
    /**
     * Applies a quaternary function to the values of the four validations held by this builder. If
     * all validations are valid, the function is applied. Otherwise, errors are accumulated.
     *
     * @param <R> type of the result
     * @param f the function to apply
  ...
  /**
   * A builder that holds five Validation instances, used for combining validations and applying
  ...
  final class Builder5<E, T1, T2, T3, T4, T5> {
    ...
    /**
     * Applies a quinary function to the values of the five validations held by this builder. If all
     * validations are valid, the function is applied. Otherwise, errors are accumulated.
     *
     * @param <R> type of the result
     * @param f the function to apply
  ...
  /**
   * A builder that holds six Validation instances, used for combining validations and applying
  ...
  final class Builder6<E, T1, T2, T3, T4, T5, T6> {
    ...
    /**
     * Applies a senary function to the values of the six validations held by this builder. If all
     * validations are valid, the function is applied. Otherwise, errors are accumulated.
     *
     * @param <R> type of the result
     * @param f the function to apply
  ...
  /**
   * A builder that holds seven Validation instances, used for combining validations and applying
  ...
  final class Builder7<E, T1, T2, T3, T4, T5, T6, T7> {
    ...
    /**
     * Applies a septenary function to the values of the seven validations held by this builder. If
     * all validations are valid, the function is applied. Otherwise, errors are accumulated.
     *
     * @param <R> type of the result
     * @param f the function to apply
  ...
  /**
   * A builder that holds eight Validation instances, used for combining validations and applying
  ...
  final class Builder8<E, T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    /**
     * Applies an octonary function to the values of the eight validations held by this builder. If
     * all validations are valid, the function is applied. Otherwise, errors are accumulated.
     *
     * @param <R> type of the result
     * @param f the function to apply
