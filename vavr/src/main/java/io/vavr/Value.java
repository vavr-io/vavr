 ...
 *
 * <p>A {@code Value} models the outcome of a computation that may or may not produce a result. It
 * can be present or absent (empty), where the meaning of "empty" depends on the concrete
 * implementation - it may represent an undefined value, a failed computation, or absence of
 * elements.
 *
 * <p>This interface provides methods for:
 *
 * <ul>
 *   <li>Accessing and retrieving the wrapped value safely, with defaults or exceptions.
 *   <li>Transforming the value with functional operations such as {@code map} and {@code flatMap}.
 *   <li>Checking equality and correspondence with other values or collections.
 *   <li>Iterating over the value or performing side-effects.
 *   <li>Testing characteristics like emptiness, laziness, or single-valuedness.
 *   <li>Converting to other types, including Java collections, streams, {@code Option}, {@code
 *       Try}, {@code Either}, and validation types.
 * </ul>
 *
...
public interface Value<T> extends Iterable<T> {
  ...
  /**
   * Narrows a widened {@code Value<? extends T>} to {@code Value<T>} by performing a type-safe
   * cast. This is eligible because immutable/read-only collections are covariant.
   *
  ...
  /**
   * Collects the underlying value(s) (if present) using the given {@code supplier}, {@code
   * accumulator} and {@code combiner}.
   *
   * @param <R> type of the result
   * @param supplier provide unit value for reduction
   * @param accumulator perform reduction with unit value
   * @param combiner function for combining two values, which must be compatible with the
   *     accumulator.
   * @return R reduction result
   */
  default <R> R collect(
      @NonNull Supplier<R> supplier,
      @NonNull BiConsumer<R, ? super T> accumulator,
  ...
  /**
   * Tests whether every element of this iterable relates to the corresponding element of another
   * iterable by satisfying a test predicate.
   *
   ...
   * @return {@code true} if both iterables have the same length and {@code predicate(x, y)} is
   *     {@code true} for all corresponding elements {@code x} of this iterable and {@code y} of
   *     {@code that}, otherwise {@code false}.
   */
  default <U> boolean corresponds(
      @NonNull Iterable<U> that, @NonNull BiPredicate<? super T, ? super U> predicate) {
  ...
  /**
   * A <em>smoothing</em> replacement for {@code equals}. It is similar to Scala's {@code ==} but
   * better in the way that it is not limited to collection types, e.g. {@code Some(1) eq List(1)},
   * {@code None eq Failure(x)} etc.
   *
   * <p>In a nutshell: eq checks <strong>congruence of structures</strong> and <strong>equality of
   * contained values</strong>.
   *
   * <p>Example:
   *
   * <pre>{@code
   ...
   *
   * <p>Because the 'empty' state indicates that there is no value present that can be returned,
   ...
   *
   * @return the underlying value if this is not empty, otherwise {@code get()} throws a {@code
   *     Throwable}
   */
  T get();
  ...
  /**
   * Returns the underlying value if present, otherwise returns the result of {@code
   * Try.of(supplier).get()}.
   *
   * @param supplier An alternative value supplier.
   * @return A value of type {@code T}.
  ...
  /**
   * Sends the string representations of this to the {@link PrintStream}. If this value consists of
   * multiple elements, each element is displayed in a new line.
   *
   * @param out The PrintStream to write to
   * @throws IllegalStateException if {@code PrintStream.checkError()} is true after writing to
   *     stream.
   */
  ...
  /**
   * Sends the string representations of this to the {@link PrintWriter}. If this value consists of
   * multiple elements, each element is displayed in a new line.
   *
   * @param writer The PrintWriter to write to
   * @throws IllegalStateException if {@code PrintWriter.checkError()} is true after writing to
   *     writer.
   */
   ...
   * @return A new {@link Validation.Valid} containing the given {@code value} if this is empty,
   ...
   * @return A new {@link Validation.Valid} containing the result of {@code valueSupplier} if this
   *     is empty, otherwise a new {@link Validation.Invalid} containing this value.
   ...
   * }</pre>
   *
   * @param arrayFactory an <code>int</code> argument function that creates an array of the correct
   *     component type with the specified size
  ...
  /**
   * Converts this to a specific mutable {@link java.util.Collection} of type {@code C}. Elements
   ...
   * }</pre>
   *
   * @param factory A factory that returns an empty mutable {@code java.util.Collection} with the
   *     specified initial capacity
   * @param <C> a sub-type of {@code java.util.Collection}
   * @return a new {@code java.util.Collection} of type {@code C}
   */
  default <C extends java.util.Collection<T>> C toJavaCollection(
      @NonNull Function<Integer, C> factory) {
    return ValueModule.toJavaCollection(this, factory);
  }

  /**
   * Converts this to a mutable {@link java.util.List}. Elements are added by calling {@link
  ...
  /**
   * Converts this to a specific mutable {@link java.util.List}. Elements are added by calling
   ...
   * }</pre>
   *
   * @param factory A factory that returns an empty mutable {@code java.util.List} with the
   *     specified initial capacity
   * @param <LIST> A sub-type of {@code java.util.List}
   * @return a new {@code java.util.List} of type {@code LIST}
   */
  default <LIST extends java.util.List<T>> LIST toJavaList(
      @NonNull Function<Integer, LIST> factory) {
    return ValueModule.toJavaCollection(this, factory);
  }

  /**
   * Converts this to a mutable {@link java.util.Map}. Elements are added by calling {@link
  ...
  default <K, V> java.util.Map<K, V> toJavaMap(
      @NonNull Function<? super T, ? extends Tuple2<? extends K, ? extends V>> f) {
    return toJavaMap(java.util.HashMap::new, f);
  }

  /**
   * Converts this to a specific mutable {@link java.util.Map}. Elements are added by calling {@link
   * java.util.Map#put(Object, Object)}.
   *
   * <pre>{@code
   * // = {}
   ...
   */
  default <K, V, MAP extends java.util.Map<K, V>> MAP toJavaMap(
      @NonNull Supplier<MAP> factory,
  ...
  /**
   * Converts this to a mutable {@link java.util.Set}. Elements are added by calling {@link
  ...
  /**
   * Converts this to a specific {@link java.util.Set}. Elements are added by calling {@link
   * java.util.Set#add(Object)}.
   *
   * <pre>{@code
   * // = []
   ...
   * }</pre>
   *
   * @param factory A factory that returns an empty mutable {@code java.util.Set} with the specified
   *     initial capacity
  ...
  /**
   * Converts this to a sequential {@link java.util.stream.Stream} by calling {@code
  ...
  /**
   * Converts this to a parallel {@link java.util.stream.Stream} by calling {@code
   ...
   * @return A new {@link Either.Right} containing the value of {@code right} if this is empty,
   *     otherwise a new {@link Either.Left} containing this value.
   ...
   * @return A new {@link Either.Right} containing the result of {@code right} if this is empty,
   *     otherwise a new {@link Either.Left} containing this value.
  ...
  default <K, V> Map<K, V> toMap(
    ...
    final Function<Iterable<Tuple2<? extends K, ? extends V>>, Map<K, V>> ofAll =
        HashMap::ofEntries;
   ...
   */
  default <K, V> Map<K, V> toLinkedMap(
      @NonNull Function<? super T, ? extends K> keyMapper,
      @NonNull Function<? super T, ? extends V> valueMapper) {
    Objects.requireNonNull(keyMapper, "keyMapper is null");
    Objects.requireNonNull(valueMapper, "valueMapper is null");
  ...
  default <K, V> SortedMap<K, V> toSortedMap(
    ...
    Objects.requireNonNull(comparator, "comparator is null");
    Objects.requireNonNull(f, "f is null");
    final Function<Tuple2<? extends K, ? extends V>, SortedMap<K, V>> ofElement =
        t -> TreeMap.of(comparator, t);
  ...
  default PriorityQueue<T> toPriorityQueue(@NonNull Comparator<? super T> comparator) {
    ...
    final Function<Iterable<T>, PriorityQueue<T>> ofAll =
        values -> PriorityQueue.ofAll(comparator, values);
   ...
   * @return A new {@link Either.Left} containing the value of {@code left} if this is empty,
   *     otherwise a new {@link Either.Right} containing this value.
   * @deprecated Use {@link #toEither(Object)} instead.
   */
  @Deprecated
   ...
   * @return A new {@link Either.Left} containing the result of {@code left} if this is empty,
   *     otherwise a new {@link Either.Right} containing this value.
  ...
  default Set<T> toLinkedSet() {
    return ValueModule.toTraversable(
        this, LinkedHashSet.empty(), LinkedHashSet::of, LinkedHashSet::ofAll);
  }

  /**
   * Converts this to a {@link SortedSet}. Current items must be comparable
   *
  ...
  default SortedSet<T> toSortedSet(@NonNull Comparator<? super T> comparator) {
    ...
    return ValueModule.toTraversable(
        ...
        value -> TreeSet.of(comparator, value),
        values -> TreeSet.ofAll(comparator, values));
  }
   ...
   *
   * <p>If this value is undefined, i.e. empty, then a new {@code Failure(NoSuchElementException)}
   * is returned, otherwise a new {@code Success(value)} is returned.
   *
   ...
   * Converts this to a {@link Try}.
   *
   * <p>If this value is undefined, i.e. empty, then a new {@code Failure(ifEmpty.get())} is
   * returned, otherwise a new {@code Success(value)} is returned.
   *
   ...
   * @param parentMapper A mapper from source item to unique identifier of parent item. Need return
   *     null for root items
   * @return A new {@link Tree}.
   * @see Tree#build(Iterable, Function, Function)
   */
  default <ID> List<Tree.Node<T>> toTree(
      @NonNull Function<? super T, ? extends ID> idMapper,
      @NonNull Function<? super T, ? extends ID> parentMapper) {
   ...
   * @return A new {@link Validation.Invalid} containing the given {@code error} if this is empty,
   ...
   * @return A new {@link Validation.Invalid} containing the result of {@code errorSupplier} if this
   *     is empty, otherwise a new {@link Validation.Valid} containing this value.
   * @throws NullPointerException if {@code valueSupplier} is null
   * @deprecated Use {@link #toValidation(Supplier)} instead.
   */
  @Deprecated
...
interface ValueModule {
  ...
  static <T, R extends java.util.Collection<T>> R toJavaCollection(
    ...
    if (value instanceof Traversable
        && ((Traversable<?>) value).isTraversableAgain()
        && !value.isLazy()) {
