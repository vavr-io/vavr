...
public class HashMultimapTest extends AbstractMultimapTest {
  ...
  @SafeVarargs
  @Override
  protected final <K extends Comparable<K>, V> HashMultimap<K, V> mapOfTuples(
  ...
  @SafeVarargs
  @Override
  protected final <K extends Comparable<K>, V> HashMultimap<K, V> mapOfEntries(
  ...
  @Override
  protected <K extends Comparable<K>, V> HashMultimap<K, V> mapOfPairs(
  ...
  @Override
  protected <K extends Comparable<? super K>, V> HashMultimap<K, V> mapOf(
  ...
  @Override
  protected <T, K extends Comparable<? super K>, V> HashMultimap<K, V> mapOf(
  ...
  @Override
  protected <K extends Comparable<K>, V> HashMultimap<K, V> mapTabulate(
  ...
  @Override
  protected <K extends Comparable<K>, V> HashMultimap<K, V> mapFill(
  ...
  public void shouldNarrowMap() {
    final HashMultimap<Integer, Number> int2doubleMap =
        (HashMultimap<Integer, Number>) this.<Integer, Number>emptyMap().put(1, 1.0d);
