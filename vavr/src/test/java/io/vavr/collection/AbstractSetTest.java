...
public abstract class AbstractSetTest extends AbstractTraversableRangeTest {
  ...
  @Override
  protected abstract <T> Set<T> empty();

  protected abstract <T> Set<T> emptyWithNull();

  @Override
  protected abstract <T> Set<T> of(T element);

  @SuppressWarnings("unchecked")
  @Override
  protected abstract <T> Set<T> of(T... elements);
  ...
  public void shouldPartitionInOneIteration() {
    ...
    final Tuple2<? extends Set<Integer>, ? extends Set<Integer>> results =
        of(1, 2, 3)
            .partition(
                i -> {
