...
public abstract class AbstractMultimapTest extends AbstractTraversableTest {
  ...
  private static Collection<Multimap.ContainerType> types() {
    return asList(
        Multimap.ContainerType.SEQ, Multimap.ContainerType.SET, Multimap.ContainerType.SORTED_SET);
  }
  ...
  public static class TestTemplateProvider implements TestTemplateInvocationContextProvider {
    ...
    public java.util.stream.Stream<TestTemplateInvocationContext>
      ...
      if (!extensionContext
          .getTestClass()
          .map(AbstractMultimapTest.class::isAssignableFrom)
          .orElse(false)) {
                    ...
                    public java.util.List<Extension> getAdditionalExtensions() {
                      return java.util.Collections.singletonList(
                          (BeforeTestExecutionCallback)
                              context -> {
                                AbstractMultimapTest instance =
                                    (AbstractMultimapTest) context.getRequiredTestInstance();
  ...
  protected <T> IterableAssert<T> assertThat(Iterable<T> actual) {
    return new IterableAssert<T>(actual) {
      ...
      public IterableAssert<T> isEqualTo(Object obj) {
        ...
        actualMap.forEach(
            (k, v) -> AbstractMultimapTest.super.assertThat(v).isEqualTo(expectedMap.get(k)));
        return this;
      }
  ...
  protected <T> Collector<T, ArrayList<T>, IntMultimap<T>> collector() {
    final Collector<
            Tuple2<Integer, T>, ArrayList<Tuple2<Integer, T>>, ? extends Multimap<Integer, T>>
    ...
    return new Collector<T, ArrayList<T>, IntMultimap<T>>() {
      ...
      public BinaryOperator<ArrayList<T>> combiner() {
        return (left, right) ->
            fromTuples(mapCollector.combiner().apply(toTuples(left), toTuples(right)));
      }
  ...
  protected abstract <T1 extends Comparable<T1>, T2> Multimap<T1, T2> emptyMap(
      Comparator<? super T2> comparator);

  protected abstract <T>
      Collector<Tuple2<Integer, T>, ArrayList<Tuple2<Integer, T>>, ? extends Multimap<Integer, T>>
          mapCollector();

  @SuppressWarnings("unchecked")
  protected abstract <K extends Comparable<K>, V> Multimap<K, V> mapOfTuples(
      Tuple2<? extends K, ? extends V>... entries);

  @SuppressWarnings("unchecked")
  protected abstract <K extends Comparable<K>, V> Multimap<K, V> mapOfEntries(
      java.util.Map.Entry<? extends K, ? extends V>... entries);

  protected abstract <K extends Comparable<K>, V> Multimap<K, V> mapOfPairs(
      K k1, V v1, K k, V v2, K k3, V v3);

  protected abstract <K extends Comparable<K>, V> Multimap<K, V> mapOf(K key, V value);

  protected abstract <K extends Comparable<? super K>, V> Multimap<K, V> mapOf(
      java.util.Map<? extends K, ? extends V> map);

  protected abstract <T, K extends Comparable<? super K>, V> Multimap<K, V> mapOf(
  ...
  protected abstract <K extends Comparable<K>, V> Multimap<K, V> mapTabulate(
      int n, Function<? super Integer, ? extends Tuple2<? extends K, ? extends V>> f);

  protected abstract <K extends Comparable<K>, V> Multimap<K, V> mapFill(
      int n, Supplier<? extends Tuple2<? extends K, ? extends V>> s);

  protected abstract <K extends Comparable<K>, V> Multimap<K, V> mapFill(
      int n, Tuple2<? extends K, ? extends V> element);
  ...
  @Override
  protected <T extends Comparable<? super T>> IntMultimap<T> ofJavaStream(
  ...
  public void shouldApplyExistingKey() {
    assertThat(emptyIntInt().put(1, 2).asPartialFunction().apply(1))
        .isEqualTo(io.vavr.collection.HashSet.of(2));
  }

  @TestTemplate
  public void shouldApplyNonExistingKey() {
    assertThrows(
        NoSuchElementException.class, () -> emptyIntInt().put(1, 2).asPartialFunction().apply(3));
  }
  ...
  public void shouldBiMapNonEmpty() {
    ...
    final Seq<Tuple2<Integer, String>> actual =
        emptyInt().put(1, "1").put(2, "2").bimap(i -> i + 1, s -> s + "!").toStream();
  ...
  public void shouldComputeDistinctOfNonEmptyTraversable() {
    final Multimap<Integer, Object> testee =
        this.<Integer, Object>emptyMap().put(1, 1).put(2, 2).put(3, 3);
  ...
  public void shouldObeyEqualityConstraints() {
    ...
    assertThat(
            mapOfPairs(1, "a", 2, "b", 3, "c")
                .equals(HashMultimap.withSeq().of(1, "a", 2, "b", 3, "c")))
        .isTrue();
    assertThat(
            mapOfPairs(1, "a", 2, "b", 3, "c")
                .equals(HashMultimap.withSeq().of(3, "c", 2, "b", 1, "a")))
        .isTrue();
  ...
  public void shouldBiFilterWork() throws Exception {
    final Multimap<Integer, String> src =
        mapTabulate(20, n -> Tuple.of(n % 10, Integer.toHexString(n)));
    final Pattern isDigits = Pattern.compile("^\\d+$");
    final Multimap<Integer, String> dst =
  ...
  public void shouldValueFilterWork() throws Exception {
    final Multimap<Integer, String> src =
        mapTabulate(10, n -> Tuple.of(n % 5, Integer.toHexString(n)));
    final Pattern isDigits = Pattern.compile("^\\d+$");
  ...
  public void shouldFlatMapUsingBiFunction() {
    final Multimap<Integer, Integer> testee =
        mapOfTuples(Tuple.of(1, 11), Tuple.of(2, 22), Tuple.of(3, 33));
    final Multimap<String, String> actual =
        testee.flatMap(
            (k, v) ->
                io.vavr.collection.List.of(
                    Tuple.of(String.valueOf(k), String.valueOf(v)),
                    Tuple.of(String.valueOf(k * 10), String.valueOf(v * 10))));
    final Multimap<String, String> expected =
        mapOfTuples(
            Tuple.of("1", "11"),
            Tuple.of("10", "110"),
            Tuple.of("2", "22"),
  ...
  public void shouldFoldRightNonNil() {
    ...
    final io.vavr.collection.List<String> expected =
  ...
  public void shouldReturnDefaultValue() {
    ...
    assertThat(map.getOrElse("3", io.vavr.collection.List.of("3")))
        .isEqualTo(io.vavr.collection.List.of("3"));
  }
  ...
  public void shouldReturnListWithMappedValues() {
    assertThat(emptyIntInt().put(1, 1).put(2, 2).iterator((a, b) -> a + b))
        .isEqualTo(io.vavr.collection.List.of(2, 4));
  }
  ...
  public void shouldReturnsKeySet() {
    final Set<Integer> actual =
        mapOfTuples(Tuple.of(1, 11), Tuple.of(2, 22), Tuple.of(3, 33)).keySet();
  ...
  public void shouldMapComparableValues() {
    final Multimap<Integer, String> map =
        this.<Integer, String>emptyMap().put(1, "1").put(1, "2").put(2, "3");
    assertThat(map.map(v -> v))
        .isEqualTo(
            io.vavr.collection.List.of(Tuple.of(1, "1"), Tuple.of(1, "2"), Tuple.of(2, "3")));
  }

  @TestTemplate
  public void shouldMapIncomparableValues() {
    final Multimap<Integer, Incomparable> map =
        this.<Integer, Incomparable>emptyMap(Comparator.comparing(Incomparable::getS))
  ...
  public void shouldFillTheSeqCallingTheSupplierInTheRightOrder() {
    ...
    assertThat(actual)
        .isEqualTo(mapOfTuples(new Tuple2<>(0L, 0f), new Tuple2<>(1L, 1f), new Tuple2<>(2L, 2f)));
  }
  ...
  public void shouldTabulateTheSeq() {
    final Function<Number, Tuple2<Long, Float>> f =
        i -> new Tuple2<>(i.longValue(), i.floatValue());
  ...
  public void shouldReturnModifiedValuesMap() {
    assertThat(emptyIntString().put(1, "1").put(2, "2").mapValues(Integer::parseInt))
        .isEqualTo(emptyIntInt().put(1, 1).put(2, 2));
  }
  ...
  public void shouldMergeCollisions() {
    ...
    final Multimap<Integer, Integer> m3 = emptyIntInt().put(3, 3).put(4, 4);
    assertThat(emptyIntInt().merge(m2, (s1, s2) -> io.vavr.collection.Iterator.concat(s1, s2)))
        .isEqualTo(m2);
    assertThat(m2.merge(emptyIntInt(), (s1, s2) -> io.vavr.collection.Iterator.concat(s1, s2)))
        .isEqualTo(m2);
    assertThat(m1.merge(m2, (s1, s2) -> io.vavr.collection.Iterator.concat(s1, s2)))
        .isEqualTo(emptyIntInt().put(1, 1).put(1, 2).put(2, 2).put(4, 4));
    assertThat(m1.merge(m3, (s1, s2) -> io.vavr.collection.Iterator.concat(s1, s2)))
  ...
  public void shouldPartitionIntsInOddAndEvenHavingOddAndEvenNumbers() {
    assertThat(of(1, 2, 3, 4).partition(i -> i % 2 != 0))
        .isEqualTo(
            Tuple.of(
                mapOfTuples(Tuple.of(0, 1), Tuple.of(2, 3)),
  ...
  public void shouldPartitionInOneIteration() {
    ...
    final Multimap<String, Integer> map =
        mapOfTuples(Tuple.of("1", 1), Tuple.of("2", 2), Tuple.of("3", 3));
    final Tuple2<? extends Multimap<String, Integer>, ? extends Multimap<String, Integer>> results =
        map.partition(
            entry -> {
              count.incrementAndGet();
              return true;
            });
    assertThat(results._1)
        .isEqualTo(mapOfTuples(Tuple.of("1", 1), Tuple.of("2", 2), Tuple.of("3", 3)));
  ...
  public void shouldReplaceEntity() {
    final Multimap<Integer, Object> actual =
        emptyInt().put(1, "a").put(1, "b").replace(Tuple.of(1, "a"), Tuple.of(1, "c"));
  ...
  public void shouldSpanNonNil() {
    assertThat(of(0, 1, 2, 3).span(i -> i < 2))
        .isEqualTo(
            Tuple.of(
                mapOfTuples(Tuple.of(0, 0), Tuple.of(1, 1)),
  ...
  public void shouldSpanAndNotTruncate() {
    assertThat(of(1, 1, 2, 2, 3, 3).span(x -> x % 2 == 1))
        .isEqualTo(
            Tuple.of(
                mapOfTuples(Tuple.of(0, 1), Tuple.of(1, 1)),
                mapOfTuples(Tuple.of(2, 2), Tuple.of(3, 2), Tuple.of(4, 3), Tuple.of(5, 3))));
    assertThat(of(1, 1, 2, 2, 4, 4).span(x -> x == 1))
        .isEqualTo(
            Tuple.of(
                mapOfTuples(Tuple.of(0, 1), Tuple.of(1, 1)),
                mapOfTuples(Tuple.of(2, 2), Tuple.of(3, 2), Tuple.of(4, 4), Tuple.of(5, 4))));
  }
  ...
  public void shouldReturnTuple2SetOfANonEmptyMap() {
    assertThat(emptyInt().put(1, "1").put(2, "2").toSet())
        .isEqualTo(io.vavr.collection.HashSet.of(Tuple.of(1, "1"), Tuple.of(2, "2")));
  }
  ...
  public void shouldMakeString() {
    ...
    assertThat(emptyIntInt().put(1, 2).toString())
        .isEqualTo(className() + "(" + Tuple.of(1, 2) + ")");
  }
  ...
  public void shouldUnzipNil() {
    assertThat(emptyMap().unzip(x -> Tuple.of(x, x)))
  ...
  public void shouldUnzip3Nil() {
    assertThat(emptyMap().unzip3(x -> Tuple.of(x, x, x)))
        .isEqualTo(Tuple.of(Stream.empty(), Stream.empty(), Stream.empty()));
    assertThat(
            emptyMap().unzip3((k, v) -> Tuple.of(Tuple.of(k, v), Tuple.of(k, v), Tuple.of(k, v))))
        .isEqualTo(Tuple.of(Stream.empty(), Stream.empty(), Stream.empty()));
  }
  ...
  public void shouldZipNils() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Object>> actual =
        emptyIntInt().zip(io.vavr.collection.List.empty());
    assertThat(actual).isEqualTo(Stream.empty());
  }

  @TestTemplate
  public void shouldZipEmptyAndNonNil() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Integer>> actual =
        emptyIntInt().zip(io.vavr.collection.List.of(1));
    assertThat(actual).isEqualTo(Stream.empty());
  }
  ...
  public void shouldZipNonEmptyAndNil() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Object>> actual =
        emptyIntInt().put(0, 1).zip(io.vavr.collection.List.empty());
    assertThat(actual).isEqualTo(Stream.empty());
  }
  ...
  public void shouldZipNonNilsIfThisIsSmaller() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Integer>> actual =
        emptyIntInt().put(0, 0).put(1, 1).zip(io.vavr.collection.List.of(5, 6, 7));
    assertThat(actual)
        .isEqualTo(Stream.of(Tuple.of(Tuple.of(0, 0), 5), Tuple.of(Tuple.of(1, 1), 6)));
  }

  @TestTemplate
  public void shouldZipNonNilsIfThatIsSmaller() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Integer>> actual =
        emptyIntInt().put(0, 0).put(1, 1).put(2, 2).zip(io.vavr.collection.List.of(5, 6));
    assertThat(actual)
        .isEqualTo(Stream.of(Tuple.of(Tuple.of(0, 0), 5), Tuple.of(Tuple.of(1, 1), 6)));
  }
  ...
  public void shouldZipNonNilsOfSameSize() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Integer>> actual =
        emptyIntInt().put(0, 0).put(1, 1).put(2, 2).zip(io.vavr.collection.List.of(5, 6, 7));
    assertThat(actual)
        .isEqualTo(
            Stream.of(
                Tuple.of(Tuple.of(0, 0), 5),
                Tuple.of(Tuple.of(1, 1), 6),
                Tuple.of(Tuple.of(2, 2), 7)));
  }
  ...
  public void shouldZipNonNilWithIndex() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Integer>> actual =
        emptyIntInt().put(0, 0).put(1, 1).put(2, 2).zipWithIndex();
    assertThat(actual)
        .isEqualTo(
            Stream.of(
                Tuple.of(Tuple.of(0, 0), 0),
                Tuple.of(Tuple.of(1, 1), 1),
                Tuple.of(Tuple.of(2, 2), 2)));
  }
  ...
  public void shouldZipAllNils() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Object>> actual =
        emptyIntInt().zipAll(empty(), null, null);
    assertThat(actual).isEqualTo(Stream.empty());
  }
  ...
  public void shouldZipAllEmptyAndNonNil() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Object>> actual =
        emptyIntInt().zipAll(io.vavr.collection.List.of(1), null, null);
  ...
  public void shouldZipAllNonEmptyAndNil() {
    final Seq<Tuple2<Tuple2<Integer, Integer>, Object>> actual =
        emptyIntInt().put(0, 1).zipAll(empty(), null, null);
    assertThat(actual).isEqualTo(Stream.of(Tuple.of(Tuple.of(0, 1), null)));
  }

  @TestTemplate
  public void shouldZipAllNonNilsIfThisIsSmaller() {
    final Seq<Tuple2<Tuple2<Integer, Object>, String>> actual =
        this.<Integer, Object>emptyMap()
            .put(1, 1)
            .put(2, 2)
            .zipAll(of("a", "b", "c"), Tuple.of(9, 10), "z");
    final Seq<Tuple2<Tuple2<Object, Object>, String>> expected =
        Stream.of(
            Tuple.of(Tuple.of(1, 1), "a"),
            Tuple.of(Tuple.of(2, 2), "b"),
            Tuple.of(Tuple.of(9, 10), "c"));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldPreserveSingletonInstanceOnDeserialization() {
    // The empty Multimap encapsulates a container type and map type and therefore cannot be a
    // singleton
  }
  ...
  public void shouldCollectUsingMultimap() {
    // this Traversable test is not suited for Multimaps:
    //   java.lang.ClassCastException: io.vavr.collection.List$Cons cannot be cast to
