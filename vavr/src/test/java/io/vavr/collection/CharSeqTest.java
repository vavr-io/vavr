...
public class CharSeqTest {
  ...
  public void shouldThrowWhenCreatingCharSeqFromIterableThatContainsNull() {
    assertThatThrownBy(() -> CharSeq.ofAll(Arrays.asList('1', null)))
  ...
  public void shouldReturnSelfWhenIterableIsInstanceOfListView() {
    final ListView<Character, CharSeq> source =
        JavaConverters.asJava(CharSeq.ofAll(asList('a', 'b', 'c')), ChangePolicy.IMMUTABLE);
    final CharSeq target = CharSeq.ofAll(source);
  ...
  public void shouldThrowWhenPadToAddingNulls() {
    assertThatThrownBy(() -> CharSeq.of('a').padTo(2, null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldThrowWhenLeftPadToAddingNulls() {
    assertThatThrownBy(() -> CharSeq.of('a').leftPadTo(2, null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldPartitionInOneIteration() {
    ...
    final Tuple2<CharSeq, CharSeq> results =
        CharSeq.of('1', '2', '3')
            .partition(
                c -> {
  ...
  public void shouldThrowWhenPatchingWithNulls() {
    assertThatThrownBy(() -> CharSeq.of('1').patch(0, List.of((Character) null), 1))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldCreateRangeClosedWhereFromAndToEqualMIN_VALUE() {
    assertThat(CharSeq.rangeClosed(Character.MIN_VALUE, Character.MIN_VALUE))
        .isEqualTo(CharSeq.of(Character.MIN_VALUE));
  }

  @Test
  public void shouldCreateRangeClosedWhereFromAndToEqualMAX_VALUE() {
    assertThat(CharSeq.rangeClosed(Character.MAX_VALUE, Character.MAX_VALUE))
        .isEqualTo(CharSeq.of(Character.MAX_VALUE));
  }
  ...
  public void shouldCreateRangeClosedByWhereFromIsLessThanToAndStepCorrectDirection() {
    ...
    assertThat(CharSeq.rangeClosedBy((char) (Character.MAX_VALUE - 2), Character.MAX_VALUE, 3))
        .isEqualTo(CharSeq.of((char) (Character.MAX_VALUE - 2)));
    assertThat(CharSeq.rangeClosedBy((char) (Character.MAX_VALUE - 3), Character.MAX_VALUE, 3))
        .isEqualTo(CharSeq.of((char) (Character.MAX_VALUE - 3), Character.MAX_VALUE));
    ...
    assertThat(CharSeq.rangeClosedBy('e', (char) ('a' - 1), -2))
        .isEqualTo(CharSeq.of('e', 'c', 'a'));
    assertThat(CharSeq.rangeClosedBy((char) (Character.MIN_VALUE + 2), Character.MIN_VALUE, -3))
        .isEqualTo(CharSeq.of((char) (Character.MIN_VALUE + 2)));
    assertThat(CharSeq.rangeClosedBy((char) (Character.MIN_VALUE + 3), Character.MIN_VALUE, -3))
        .isEqualTo(CharSeq.of((char) (Character.MIN_VALUE + 3), Character.MIN_VALUE));
  }

  @Test
  public void shouldCreateRangeClosedByWhereFromAndToEqualMIN_VALUE() {
    assertThat(CharSeq.rangeClosedBy(Character.MIN_VALUE, Character.MIN_VALUE, 1))
        .isEqualTo(CharSeq.of(Character.MIN_VALUE));
    assertThat(CharSeq.rangeClosedBy(Character.MIN_VALUE, Character.MIN_VALUE, 3))
        .isEqualTo(CharSeq.of(Character.MIN_VALUE));
    assertThat(CharSeq.rangeClosedBy(Character.MIN_VALUE, Character.MIN_VALUE, -1))
        .isEqualTo(CharSeq.of(Character.MIN_VALUE));
    assertThat(CharSeq.rangeClosedBy(Character.MIN_VALUE, Character.MIN_VALUE, -3))
  ...
  public void shouldCreateRangeClosedByWhereFromAndToEqualMAX_VALUE() {
    assertThat(CharSeq.rangeClosedBy(Character.MAX_VALUE, Character.MAX_VALUE, 1))
        .isEqualTo(CharSeq.of(Character.MAX_VALUE));
    assertThat(CharSeq.rangeClosedBy(Character.MAX_VALUE, Character.MAX_VALUE, 3))
        .isEqualTo(CharSeq.of(Character.MAX_VALUE));
    assertThat(CharSeq.rangeClosedBy(Character.MAX_VALUE, Character.MAX_VALUE, -1))
        .isEqualTo(CharSeq.of(Character.MAX_VALUE));
    assertThat(CharSeq.rangeClosedBy(Character.MAX_VALUE, Character.MAX_VALUE, -3))
  ...
  public void shouldCreateRangeByWhereFromIsLessThanToAndStepCorrectDirection() {
    ...
    assertThat(CharSeq.rangeBy((char) (Character.MAX_VALUE - 3), Character.MAX_VALUE, 3))
        .isEqualTo(CharSeq.of((char) (Character.MAX_VALUE - 3)));
    assertThat(CharSeq.rangeBy((char) (Character.MAX_VALUE - 4), Character.MAX_VALUE, 3))
        .isEqualTo(CharSeq.of((char) (Character.MAX_VALUE - 4), (char) (Character.MAX_VALUE - 1)));
    assertThat(CharSeq.rangeBy((char) (Character.MIN_VALUE + 3), Character.MIN_VALUE, -3))
        .isEqualTo(CharSeq.of((char) (Character.MIN_VALUE + 3)));
    assertThat(CharSeq.rangeBy((char) (Character.MIN_VALUE + 4), Character.MIN_VALUE, -3))
        .isEqualTo(CharSeq.of((char) (Character.MIN_VALUE + 4), (char) (Character.MIN_VALUE + 1)));
  }
  ...
  public void shouldComputeDistinctOfNonEmptyTraversable() {
    assertThat(CharSeq.of('1', '1', '2', '2', '3', '3').distinct())
        .isEqualTo(CharSeq.of('1', '2', '3'));
  }
  ...
  public void shouldDropUntilNoneIfPredicateIsTrue() {
    assertThat(CharSeq.of('1', '2', '3').dropUntil(ignored -> true))
        .isEqualTo(CharSeq.of('1', '2', '3'));
  }
  ...
  public void shouldDropRightUntilAllIfPredicateIsFalse() {
    assertThat(CharSeq.of('1', '2', '3').dropRightUntil(ignored -> false))
        .isSameAs(CharSeq.empty());
  }

  @Test
  public void shouldDropRightUntilCorrect() {
    assertThat(CharSeq.of('1', '2', '3').dropRightUntil(i -> i == '2'))
        .isEqualTo(CharSeq.of('1', '2'));
  }
  ...
  public void shouldDropRightWhileAccordingToPredicate() {
    assertThat(CharSeq.of('1', '2', '3').dropRightWhile(i -> i != '2'))
        .isEqualTo(CharSeq.of('1', '2'));
  }
  ...
  public void shouldFilterNonEmptyTraversable() {
    assertThat(CharSeq.of('1', '2', '3', '4').filter(i -> i == '2' || i == '4'))
        .isEqualTo(CharSeq.of('2', '4'));
  }
  ...
  public void shouldRejectNonEmptyTraversable() {
    assertThat(CharSeq.of('1', '2', '3', '4').reject(i -> i == '2' || i == '4'))
        .isEqualTo(CharSeq.of('1', '3'));
  }
  ...
  public void shouldFlatMapElementsToSequentialValuesInTheRightOrder() {
    ...
    final IndexedSeq<Character> actualInts =
        CharSeq.of('0', '1', '2')
            .flatMap(
  ...
  public void shouldFlatMapChars() {
    ...
    assertThat(CharSeq.of('1', '2', '3').flatMapChars(c -> c == '1' ? "*" : "-"))
        .isEqualTo(CharSeq.of("*--"));
  }
  ...
  public void shouldMapNonNil() {
    assertThat(CharSeq.of('1', '2', '3').map(i -> (char) (i + 1)))
        .isEqualTo(Vector.of('2', '3', '4'));
  }
  ...
  public void shouldMapElementsToSequentialValuesInTheRightOrder() {
    ...
    final Traversable<Character> actualInts =
        expectedInts.map(ignored -> (char) seq.getAndIncrement());
    assertThat(actualInts).isEqualTo(expectedInts);
  }
  ...
  public void shouldMapToCharSeqWhenMapCharsIsUsed() {
    ...
    assertThat(CharSeq.of('a', 'b', 'c').mapChars(c -> (char) (c + 1)))
        .isEqualTo(CharSeq.of("bcd"));
  }
  ...
  public void shouldPartitionNil() {
    assertThat(CharSeq.empty().partition(e -> true))
        .isEqualTo(Tuple.of(CharSeq.empty(), CharSeq.empty()));
  }
  ...
  public void shouldPartitionIntsInOddAndEvenHavingOnlyOddNumbers() {
    assertThat(CharSeq.of('1', '3').partition(i -> i % 2 != 0))
        .isEqualTo(Tuple.of(CharSeq.of('1', '3'), CharSeq.empty()));
  }

  @Test
  public void shouldPartitionIntsInOddAndEvenHavingOnlyEvenNumbers() {
    assertThat(CharSeq.of('2', '4').partition(i -> i % 2 != 0))
        .isEqualTo(Tuple.of(CharSeq.empty(), CharSeq.of('2', '4')));
  }
  ...
  public void shouldThrowWhenMaxByWithNullComparator() {
    assertThrows(
        NullPointerException.class, () -> CharSeq.of('1').maxBy((Comparator<Character>) null));
  }
  ...
  public void shouldCalculateMaxByOfInts() {
    assertThat(CharSeq.of('1', '2', '3').maxBy(Comparator.comparingInt(i -> i)))
  ...
  public void shouldThrowWhenMinByWithNullComparator() {
    assertThrows(
        NullPointerException.class, () -> CharSeq.of('1').minBy((Comparator<Character>) null));
  }
  ...
  public void shouldCalculateMinByOfInts() {
    assertThat(CharSeq.of('1', '2', '3').minBy(Comparator.comparingInt(i -> i)))
  ...
  public void shouldPeekNonNilPerformingAnAction() {
    ...
    assertThat(actual)
        .isEqualTo(CharSeq.of('1', '2', '3')); // traverses all elements in the lazy case
    assertThat(effect[0]).isEqualTo('1');
  }
  ...
  public void shouldReplaceElementOfNonNilUsingCurrNew() {
    assertThat(CharSeq.of('0', '1', '2', '1').replace('1', '3'))
        .isEqualTo(CharSeq.of('0', '3', '2', '1'));
  }
  ...
  public void shouldThrowWhenReplacingNonNullCharWithNullChar() {
    assertThatThrownBy(() -> CharSeq.of('a').replace('a', (Character) null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldReplaceAllElementsOfNonNilUsingCurrNew() {
    assertThat(CharSeq.of('0', '1', '2', '1').replaceAll('1', '3'))
        .isEqualTo(CharSeq.of('0', '3', '2', '3'));
  }
  ...
  public void shouldThrowWhenReplacingAllNonNullCharWithNullChar() {
    assertThatThrownBy(() -> CharSeq.of('a').replaceAll('a', (Character) null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldSlideSingularByClassifier() {
    final io.vavr.collection.List<Traversable<Character>> actual =
        CharSeq.of('1').slideBy(Function.identity()).toList().map(Vector::ofAll);
    final io.vavr.collection.List<Traversable<Character>> expected =
        io.vavr.collection.List.of(Vector.of('1'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldSlideNonNilByIdentityClassifier() {
    final io.vavr.collection.List<Traversable<Character>> actual =
        CharSeq.of('1', '2', '3').slideBy(Function.identity()).toList().map(Vector::ofAll);
    final io.vavr.collection.List<Traversable<Character>> expected =
        io.vavr.collection.List.of(Vector.of('1'), Vector.of('2'), Vector.of('3'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldSlideNonNilByConstantClassifier() {
    final io.vavr.collection.List<Traversable<Character>> actual =
        CharSeq.of('1', '2', '3').slideBy(e -> "same").toList().map(Vector::ofAll);
    final io.vavr.collection.List<Traversable<Character>> expected =
        io.vavr.collection.List.of(Vector.of('1', '2', '3'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldSlideNonNilBySomeClassifier() {
    final io.vavr.collection.List<Traversable<Character>> actual =
        CharSeq.of('1', '1', '1', '2', '2', '3', '4')
            .slideBy(Function.identity())
            .toList()
            .map(Vector::ofAll);
    final io.vavr.collection.List<Traversable<Character>> expected =
        io.vavr.collection.List.of(
            Vector.of('1', '1', '1'), Vector.of('2', '2'), Vector.of('3'), Vector.of('4'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldSlide5ElementsBySize2AndStep5() {
    assertThat(CharSeq.of('1', '2', '3', '4', '5').sliding(2, 5).toList())
        .isEqualTo(io.vavr.collection.List.of(CharSeq.of('1', '2')));
  }
  ...
  public void shouldSpanNil() {
    assertThat(CharSeq.empty().span(i -> i < 2))
        .isEqualTo(Tuple.of(CharSeq.empty(), CharSeq.empty()));
  }
  ...
  public void shouldHaveImmutableSpliterator() {
    assertThat(CharSeq.of('1', '2', '3').spliterator().hasCharacteristics(Spliterator.IMMUTABLE))
        .isTrue();
  }
  ...
  public void shouldHandleStdoutIOException() {
    assertThrows(
        IllegalStateException.class, () -> CharSeq.of('0').out(OutputTester.failingPrintStream()));
  }
  ...
  public void shouldThrowWhenTabulatingNullValues() {
    assertThatThrownBy(() -> CharSeq.tabulate(1, i -> null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldTakeUntilAsExpected() {
    assertThat(CharSeq.of('2', '4', '5', '6').takeUntil(x -> x % 2 != 0))
        .isEqualTo(CharSeq.of('2', '4'));
  }
  ...
  public void shouldTakeWhileAsExpected() {
    assertThat(CharSeq.of('2', '4', '5', '6').takeWhile(x -> x % 2 == 0))
        .isEqualTo(CharSeq.of('2', '4'));
  }
  ...
  public void shouldTakeRightUntilAsExpected() {
    assertThat(CharSeq.of('2', '3', '4', '6').takeRightUntil(x -> x % 2 != 0))
        .isEqualTo(CharSeq.of('4', '6'));
  }
  ...
  public void shouldTakeRightWhileAsExpected() {
    assertThat(CharSeq.of('2', '3', '4', '6').takeRightWhile(x -> x % 2 == 0))
        .isEqualTo(CharSeq.of('4', '6'));
  }
  ...
  public void shouldPreserveSingletonInstanceOnDeserialization() {
    final boolean actual =
        Serializables.deserialize(Serializables.serialize(CharSeq.empty())) == CharSeq.empty();
    assertThat(actual).isTrue();
  }
  ...
  public void shouldSerializeDeserializeNonNil() {
    final Object actual =
        Serializables.deserialize(Serializables.serialize(CharSeq.of('1', '2', '3')));
  ...
  public void shouldThrowWhenAppendingAllIterableThatContainsNull() {
    assertThatThrownBy(() -> CharSeq.empty().appendAll(Arrays.asList('1', null)))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldComputeCombinationsOfNonEmptyList() {
    assertThat(CharSeq.of("123").combinations())
        .isEqualTo(
            Vector.of(
                CharSeq.empty(),
                CharSeq.of("1"),
  ...
  public void shouldComputeKCombinationsOfNonEmptyList() {
    assertThat(CharSeq.of("123").combinations(2))
        .isEqualTo(Vector.of(CharSeq.of("12"), CharSeq.of("13"), CharSeq.of("23")));
  }
  ...
  public void shouldRecognizeNonNilDoesNotContainSlice() {
    final boolean actual =
        CharSeq.of('1', '2', '3', '4', '5').containsSlice(CharSeq.of('2', '1', '4'));
    assertThat(actual).isFalse();
  }
  ...
  public void shouldCalculateCrossProductOfNonNil() {
    final io.vavr.collection.List<Tuple2<Character, Character>> actual =
        CharSeq.of('1', '2', '3').crossProduct().toList();
    final io.vavr.collection.List<Tuple2<Character, Character>> expected =
        Iterator.of(
                Tuple.of('1', '1'),
                Tuple.of('1', '2'),
                Tuple.of('1', '3'),
  ...
  public void shouldCalculateCrossProductPower() {
    ...
    final io.vavr.collection.List<CharSeq> expected =
        Iterator.of(
                CharSeq.of('1', '1'),
                CharSeq.of('1', '2'),
                CharSeq.of('2', '1'),
  ...
  public void shouldCalculateCrossProductOfNilAndNil() {
    final Traversable<Tuple2<Character, Object>> actual =
        CharSeq.empty().crossProduct(CharSeq.empty());
    assertThat(actual).isEmpty();
  }
  ...
  public void shouldCalculateCrossProductOfNilAndNonNil() {
    final Traversable<Tuple2<Character, Object>> actual =
        CharSeq.empty().crossProduct(CharSeq.of('1', '2', '3'));
    assertThat(actual).isEmpty();
  }
  ...
  public void shouldCalculateCrossProductOfNonNilAndNil() {
    final Traversable<Tuple2<Character, Character>> actual =
        CharSeq.of('1', '2', '3').crossProduct(CharSeq.empty());
    assertThat(actual).isEmpty();
  }
  ...
  public void shouldCalculateCrossProductOfNonNilAndNonNil() {
    final io.vavr.collection.List<Tuple2<Character, Character>> actual =
        CharSeq.of('1', '2', '3').crossProduct(CharSeq.of('a', 'b')).toList();
    final io.vavr.collection.List<Tuple2<Character, Character>> expected =
        Vector.of(
                Tuple.of('1', 'a'),
                Tuple.of('1', 'b'),
  ...
  public void shouldGroupedTraversableWithEqualSizedBlocks() {
    final io.vavr.collection.List<CharSeq> actual =
        CharSeq.of('1', '2', '3', '4').grouped(2).toList();
    final io.vavr.collection.List<CharSeq> expected =
        io.vavr.collection.List.of(CharSeq.of('1', '2'), CharSeq.of('3', '4'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldGroupedTraversableWithRemainder() {
    final io.vavr.collection.List<CharSeq> actual =
        CharSeq.of('1', '2', '3', '4', '5').grouped(2).toList();
    final io.vavr.collection.List<CharSeq> expected =
        io.vavr.collection.List.of(CharSeq.of('1', '2'), CharSeq.of('3', '4'), CharSeq.of('5'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldGroupedWhenTraversableLengthIsSmallerThanBlockSize() {
    final io.vavr.collection.List<CharSeq> actual =
        CharSeq.of('1', '2', '3', '4').grouped(5).toList();
    final io.vavr.collection.List<CharSeq> expected =
        io.vavr.collection.List.of(CharSeq.of('1', '2', '3', '4'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldFindIndexOfFirstElement() {
    ...
    assertThat(CharSeq.of('1', '2', '3').indexOfOption(Character.valueOf('1')))
  ...
  public void shouldFindIndexOfInnerElement() {
    ...
    assertThat(CharSeq.of('1', '2', '3').indexOfOption(Character.valueOf('2')))
        .isEqualTo(Option.some(1));
  }
  ...
  public void shouldFindIndexOfLastElement() {
    ...
    assertThat(CharSeq.of('1', '2', '3').indexOfOption(Character.valueOf('3')))
  ...
  public void shouldNotFindIndexOfSliceWhenStartIsGreater() {
    ...
    assertThat(CharSeq.of('1', '2', '3', '4').indexOfSliceOption(CharSeq.of('2', '3'), 2))
  ...
  public void shouldFindIndexOfFirstSlice() {
    ...
    assertThat(CharSeq.of('1', '2', '3', '4').indexOfSliceOption(CharSeq.of('1', '2')))
        .isEqualTo(Option.some(0));
  }
  ...
  public void shouldFindIndexOfInnerSlice() {
    ...
    assertThat(CharSeq.of('1', '2', '3', '4').indexOfSliceOption(CharSeq.of('2', '3')))
        .isEqualTo(Option.some(1));
  }
  ...
  public void shouldFindIndexOfLastSlice() {
    ...
    assertThat(CharSeq.of('1', '2', '3').indexOfSliceOption(CharSeq.of('2', '3')))
        .isEqualTo(Option.some(1));
  }
  ...
  public void shouldFindLastIndexOfElement() {
    ...
    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOf(Character.valueOf('1')))
        .isEqualTo(3);

    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOfOption('1'))
        .isEqualTo(Option.some(3));
    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOfOption(Character.valueOf('1')))
        .isEqualTo(Option.some(3));
  }
  ...
  public void shouldFindLastIndexOfElementWithEnd() {
    ...
    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOf(Character.valueOf('1'), 1))
        .isEqualTo(0);

    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOfOption('1', 1))
        .isEqualTo(Option.some(0));
    assertThat(
            CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOfOption(Character.valueOf('1'), 1))
        .isEqualTo(Option.some(0));
  }
  ...
  public void shouldNotFindLastIndexOfSliceWhenSeqIsEmpty() {
    ...
    assertThat(CharSeq.empty().lastIndexOfSliceOption(CharSeq.of('2', '3')))
        .isEqualTo(Option.none());
  }

  @Test
  public void shouldNotFindLastIndexOfSliceWhenEndIdLess() {
    assertThat(CharSeq.of('1', '2', '3', '4', '5').lastIndexOfSlice(CharSeq.of('3', '4'), 1))
        .isEqualTo(-1);

    assertThat(CharSeq.of('1', '2', '3', '4', '5').lastIndexOfSliceOption(CharSeq.of('3', '4'), 1))
        .isEqualTo(Option.none());
  }
  ...
  public void shouldFindLastIndexOfSlice() {
    ...
    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3', '4').lastIndexOfSlice(CharSeq.of('2', '3')))
        .isEqualTo(4);

    assertThat(CharSeq.of('1', '2', '3', '1', '2').lastIndexOfSliceOption(CharSeq.empty()))
        .isEqualTo(Option.some(5));
    assertThat(CharSeq.of('1', '2', '3', '1', '2').lastIndexOfSliceOption(CharSeq.of('2')))
        .isEqualTo(Option.some(4));
    assertThat(
            CharSeq.of('1', '2', '3', '1', '2', '3', '4')
                .lastIndexOfSliceOption(CharSeq.of('2', '3')))
        .isEqualTo(Option.some(4));
  }

  @Test
  public void shouldFindLastIndexOfSliceWithEnd() {
    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOfSlice(CharSeq.empty(), 2))
        .isEqualTo(2);
    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOfSlice(CharSeq.of('2'), 2))
        .isEqualTo(1);
    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOfSlice(CharSeq.of('2', '3'), 2))
        .isEqualTo(1);
    assertThat(
            CharSeq.of('1', '2', '3', '1', '2', '3', '4').lastIndexOfSlice(CharSeq.of('2', '3'), 2))
        .isEqualTo(1);

    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOfSliceOption(CharSeq.empty(), 2))
        .isEqualTo(Option.some(2));
    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').lastIndexOfSliceOption(CharSeq.of('2'), 2))
        .isEqualTo(Option.some(1));
    assertThat(
            CharSeq.of('1', '2', '3', '1', '2', '3')
                .lastIndexOfSliceOption(CharSeq.of('2', '3'), 2))
        .isEqualTo(Option.some(1));
    assertThat(
            CharSeq.of('1', '2', '3', '1', '2', '3', '4')
                .lastIndexOfSliceOption(CharSeq.of('2', '3'), 2))
  ...
  public void shouldThrowWhenInsertingNull() {
    assertThatThrownBy(() -> CharSeq.empty().insert(0, null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldThrowWhenInsertOnNonNilAllWithNegativeIndex() {
    assertThrows(
        IndexOutOfBoundsException.class, () -> CharSeq.of('1').insertAll(-1, CharSeq.empty()));
  }

  @Test
  public void shouldThrowWhenInsertOnNilAllWithNegativeIndex() {
    assertThrows(
        IndexOutOfBoundsException.class, () -> CharSeq.empty().insertAll(-1, CharSeq.empty()));
  }
  ...
  public void shouldThrowWhenInsertingAllIterableContainingNull() {
    assertThatThrownBy(() -> CharSeq.empty().insertAll(0, Arrays.asList(null, null)))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldThrowWhenInterspersingWillNullSeparator() {
    assertThatThrownBy(() -> CharSeq.of('a', 'b').intersperse(null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldFullyIterateNonNilStartingAtIndex() {
    int actual = -1;
    for (final java.util.Iterator<Character> iter = CharSeq.of('1', '2', '3').iterator(1);
        iter.hasNext(); ) {
      actual = iter.next();
    }
  ...
  public void shouldThrowWhenPrependingNull() {
    assertThatThrownBy(() -> CharSeq.empty().prepend(null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldThrowWhenPrependingIterableContainingNull() {
    assertThatThrownBy(() -> CharSeq.empty().prependAll(List.of((Character) null)))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldRemoveFirstElementByPredicateBegin() {
    assertThat(CharSeq.of('1', '2', '3').removeFirst(v -> v == '1'))
        .isEqualTo(CharSeq.of('2', '3'));
  }

  @Test
  public void shouldRemoveFirstElementByPredicateBeginM() {
    assertThat(CharSeq.of('1', '2', '1', '3').removeFirst(v -> v == '1'))
        .isEqualTo(CharSeq.of('2', '1', '3'));
  }

  @Test
  public void shouldRemoveFirstElementByPredicateEnd() {
    assertThat(CharSeq.of('1', '2', '3').removeFirst(v -> v == '3'))
        .isEqualTo(CharSeq.of('1', '2'));
  }
  ...
  public void shouldRemoveLastElementByPredicateEndM() {
    assertThat(CharSeq.of('1', '3', '2', '3').removeLast(v -> v == '3'))
        .isEqualTo(CharSeq.of('1', '3', '2'));
  }
  ...
  public void shouldRemoveAllExistingObjectsFromNonNil() {
    assertThat(CharSeq.of('1', '2', '3', '1', '2', '3').removeAll('1'))
        .isEqualTo(CharSeq.of('2', '3', '2', '3'));
  }
  ...
  public void shouldRotateLeftForNegativeLessThatLen() {
    assertThat(CharSeq.of('1', '2', '3', '4', '5').rotateLeft(-2))
        .isEqualTo(CharSeq.of('4', '5', '1', '2', '3'));
  }

  @Test
  public void shouldRotateLeftForPositiveLessThatLen() {
    assertThat(CharSeq.of('1', '2', '3', '4', '5').rotateLeft(2))
        .isEqualTo(CharSeq.of('3', '4', '5', '1', '2'));
  }

  @Test
  public void shouldRotateLeftForPositiveGreaterThatLen() {
    assertThat(CharSeq.of('1', '2', '3', '4', '5').rotateLeft(5 + 2))
        .isEqualTo(CharSeq.of('3', '4', '5', '1', '2'));
  }
  ...
  public void shouldRotateRightForNegativeLessThatLen() {
    assertThat(CharSeq.of('1', '2', '3', '4', '5').rotateRight(-2))
        .isEqualTo(CharSeq.of('3', '4', '5', '1', '2'));
  }
  ...
  public void shouldRotateRightForPositiveGreaterThatLen() {
    assertThat(CharSeq.of('1', '2', '3', '4', '5').rotateRight(5 + 2))
        .isEqualTo(CharSeq.of('4', '5', '1', '2', '3'));
  }
  ...
  public void shouldThrowWhenUpdateWithNegativeIndexOnNil() {
    assertThrows(
        IndexOutOfBoundsException.class, () -> CharSeq.empty().update(-1, (Character) null));
  }
  ...
  public void shouldThrowWhenUpdateOnNil() {
    assertThrows(
        IndexOutOfBoundsException.class, () -> CharSeq.empty().update(0, (Character) null));
  }
  ...
  public void shouldThrowWhenUpdatingCharAtIndexWithNullChar() {
    assertThatThrownBy(() -> CharSeq.of('a').update(0, (Character) null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldThrowWhenUpdatingCharAtIndexWithNullCharUsingFunction() {
    assertThatThrownBy(() -> CharSeq.of('a').update(0, c -> (Character) null))
        .isInstanceOf(NullPointerException.class);
  }
  ...
  public void shouldSortNonNilUsingComparator() {
    assertThat(CharSeq.of('3', '4', '1', '2').sorted((i, j) -> j - i))
        .isEqualTo(CharSeq.of('4', '3', '2', '1'));
  }
  ...
  public void shouldSplitPredicateAtNil() {
    assertThat(CharSeq.empty().splitAt(e -> true))
        .isEqualTo(Tuple.of(CharSeq.empty(), CharSeq.empty()));
  }
  ...
  public void shouldSplitInclusivePredicateAtNil() {
    assertThat(CharSeq.empty().splitAtInclusive(e -> true))
        .isEqualTo(Tuple.of(CharSeq.empty(), CharSeq.empty()));
  }
  ...
  public void shouldRemoveIndxOutOfBoundsLeft() {
    assertThrows(
        ...
        () ->
            assertThat(CharSeq.of('1', '2', '3').removeAt(-1))
                .isEqualTo(CharSeq.of('1', '2', '3')));
  }
  ...
  public void shouldThrowOnSubSequenceOnNonNilWhenBeginIndexExceedsLowerBound() {
    assertThrows(
        IndexOutOfBoundsException.class, () -> CharSeq.of('1', '2', '3').subSequence(-1, 2));
  }
  ...
  public void shouldUnzipNil() {
    assertThat(CharSeq.empty().unzip(x -> Tuple.of(x, x)))
  ...
  public void shouldUnzip3Nil() {
    assertThat(CharSeq.empty().unzip3(x -> Tuple.of(x, x, x)))
        .isEqualTo(Tuple.of(Vector.empty(), Vector.empty(), Vector.empty()));
  }

  @Test
  public void shouldUnzip3NonNil() {
    final Tuple actual =
        CharSeq.of('0', '1').unzip3(i -> Tuple.of(i, i == '0' ? 'a' : 'b', i == '0' ? 'b' : 'a'));
  ...
  public void shouldZipNonNilsIfThisIsSmaller() {
    final IndexedSeq<Tuple2<Character, Character>> actual =
        CharSeq.of('1', '2').zip(CharSeq.of('a', 'b', 'c'));
    final IndexedSeq<Tuple2<Character, Character>> expected =
        Vector.of(Tuple.of('1', 'a'), Tuple.of('2', 'b'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldZipNonNilsIfThatIsSmaller() {
    final IndexedSeq<Tuple2<Character, Character>> actual =
        CharSeq.of('1', '2', '3').zip(CharSeq.of('a', 'b'));
    final IndexedSeq<Tuple2<Character, Character>> expected =
        Vector.of(Tuple.of('1', 'a'), Tuple.of('2', 'b'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldZipNonNilsOfSameSize() {
    final IndexedSeq<Tuple2<Character, Character>> actual =
        CharSeq.of('1', '2', '3').zip(CharSeq.of('a', 'b', 'c'));
    final IndexedSeq<Tuple2<Character, Character>> expected =
        Vector.of(Tuple.of('1', 'a'), Tuple.of('2', 'b'), Tuple.of('3', 'c'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldZipAllNonNilsIfThisIsSmaller() {
    final IndexedSeq<Tuple2<Character, Character>> actual =
        CharSeq.of('1', '2').zipAll(CharSeq.of('a', 'b', 'c'), '9', 'z');
    final IndexedSeq<Tuple2<Character, Character>> expected =
        Vector.of(Tuple.of('1', 'a'), Tuple.of('2', 'b'), Tuple.of('9', 'c'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldZipAllNonNilsIfThatIsSmaller() {
    final IndexedSeq<Tuple2<Character, Character>> actual =
        CharSeq.of('1', '2', '3').zipAll(CharSeq.of('a', 'b'), '9', 'z');
    final IndexedSeq<Tuple2<Character, Character>> expected =
        Vector.of(Tuple.of('1', 'a'), Tuple.of('2', 'b'), Tuple.of('3', 'z'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldZipAllNonNilsOfSameSize() {
    final IndexedSeq<Tuple2<Character, Character>> actual =
        CharSeq.of('1', '2', '3').zipAll(CharSeq.of('a', 'b', 'c'), '9', 'z');
    final IndexedSeq<Tuple2<Character, Character>> expected =
        Vector.of(Tuple.of('1', 'a'), Tuple.of('2', 'b'), Tuple.of('3', 'c'));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldZipNonNilWithIndex() {
    ...
    final IndexedSeq<Tuple2<Character, Integer>> expected =
        Vector.of(Tuple.of('a', 0), Tuple.of('b', 1), Tuple.of('c', 2));
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldParallelStreamAndCollectNil() {
    final Seq<?> actual =
        java.util.stream.Stream.<Character>empty().parallel().collect(CharSeq.collector());
    assertThat(actual).isSameAs(CharSeq.empty());
  }
  ...
  public void shouldParallelStreamAndCollectNonNil() {
    final Seq<?> actual =
        java.util.stream.Stream.of('1', '2', '3').parallel().collect(CharSeq.collector());
    assertThat(actual).isEqualTo(CharSeq.of('1', '2', '3'));
  }
  ...
  public void shouldUnfoldRightSimpleCharSeq() {
    this.<CharSeq>assertThat(
            CharSeq.unfoldRight(
                'j', x -> x == 'a' ? Option.none() : Option.of(new Tuple2<>(x, (char) (x - 1)))))
  ...
  public void shouldUnfoldLeftSimpleCharSeq() {
    this.<CharSeq>assertThat(
            CharSeq.unfoldLeft(
                'j', x -> x == 'a' ? Option.none() : Option.of(new Tuple2<>((char) (x - 1), x))))
