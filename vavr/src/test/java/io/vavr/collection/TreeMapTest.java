...
public class TreeMapTest extends AbstractSortedMapTest {
  ...
  @Override
  protected <K extends Comparable<? super K>, V, T>
  ...
  @Override
  protected <K extends Comparable<? super K>, V> TreeMap<K, V> mapOf(
      K k1, V v1, K k2, V v2, K k3, V v3) {
    return TreeMap.of(k1, v1, k2, v2, k3, v3);
  }

  @Override
  protected <K extends Comparable<? super K>, V> TreeMap<K, V> mapOfNullKey(
      K k1, V v1, K k2, V v2) {
  ...
  @Override
  protected <T, K extends Comparable<? super K>, V> TreeMap<K, V> mapOf(
      Stream<? extends T> stream, Function<? super T, Tuple2<? extends K, ? extends V>> f) {
  ...
  public void shouldBiMapNonEmpty() {
    final TreeMap<String, Integer> actual =
        TreeMap.of(1, "1", 2, "2")
            .bimap(Comparators.naturalComparator(), String::valueOf, Integer::parseInt);
  ...
  public void shouldCollectFromJavaStream() {
    final TreeMap<Integer, String> actual =
        java.util.stream.Stream.of(Tuple.of(1, "1"), Tuple.of(2, "2"))
  ...
  public void shouldConstructFromJavaStreamWithKeyMapperAndValueMapper() {
    ...
    final TreeMap<Integer, String> actual =
        TreeMap.ofAll(
            Comparators.naturalComparator(), javaStream, Function.identity(), String::valueOf);
  ...
  public void shouldConstructFromJavaStreamWithEntryMapper() {
    ...
    final Map<Integer, String> actual =
        TreeMap.ofAll(
            Comparators.naturalComparator(), javaStream, i -> Tuple.of(i, String.valueOf(i)));
    final TreeMap<Integer, String> expected = TreeMap.of(1, "1", 2, "2", 3, "3");
    assertThat(actual).isEqualTo(expected);
  }
  ...
  public void shouldReturnSingletonFromTupleUsingComparator() {
    final TreeMap<Integer, String> actual =
        TreeMap.of(Comparators.naturalComparator(), Tuple.of(1, "1"));
  ...
  public void shouldConstructFrom2EntriesWithComparator() {
    ...
    final java.util.Map<Integer, String> expected =
        asJavaMap(asJavaEntry(1, "1"), asJavaEntry(2, "2"));
    assertThat(actual.toJavaMap()).isEqualTo(expected);
  }
  ...
  public void shouldConstructFrom3EntriesWithComparator() {
    final Map<Integer, String> actual =
        TreeMap.of(Comparators.naturalComparator(), 1, "1", 2, "2", 3, "3");
    final java.util.Map<Integer, String> expected =
        asJavaMap(asJavaEntry(1, "1"), asJavaEntry(2, "2"), asJavaEntry(3, "3"));
    assertThat(actual.toJavaMap()).isEqualTo(expected);
  }
  ...
  public void shouldConstructFrom4EntriesWithComparator() {
    final Map<Integer, String> actual =
        TreeMap.of(Comparators.naturalComparator(), 1, "1", 2, "2", 3, "3", 4, "4");
    final java.util.Map<Integer, String> expected =
        asJavaMap(
            asJavaEntry(1, "1"), asJavaEntry(2, "2"), asJavaEntry(3, "3"), asJavaEntry(4, "4"));
    assertThat(actual.toJavaMap()).isEqualTo(expected);
  }
  ...
  public void shouldCreateOfEntriesUsingNaturalComparator() {
    final List<Tuple2<Integer, String>> expected = List(Tuple(1, "a"), Tuple(2, "b"));
    final TreeMap<Integer, String> actual =
        TreeMap.ofEntries(Comparators.naturalComparator(), expected);
    assertThat(actual.toList()).isEqualTo(expected);
  }
  ...
  public void shouldCreateOfEntriesUsingKeyComparator() {
    final TreeMap<Integer, String> actual =
        TreeMap.ofEntries(
            Comparators.naturalComparator(), asJavaEntry(1, "a"), asJavaEntry(2, "b"));
    final List<Tuple2<Integer, String>> expected = List(Tuple(1, "a"), Tuple(2, "b"));
    assertThat(actual.toList()).isEqualTo(expected);
  }
  ...
  public void shouldScan() {
    ...
    final TreeMap<String, Integer> result =
        tm.scan(Tuple.of("z", 0), (t1, t2) -> Tuple.of(t1._1 + t2._1, t1._2 + t2._2));
    assertThat(result)
        .isEqualTo(
            TreeMap.ofEntries(Tuple.of("z", 0), Tuple.of("zone", 1), Tuple.of("zonetwo", 3)));
  }

  @Test
  public void shouldScanLeft() {
    final TreeMap<String, Integer> tm = TreeMap.ofEntries(Tuple.of("one", 1), Tuple.of("two", 2));
    final Seq<Tuple2<String, Integer>> result =
        tm.scanLeft(Tuple.of("z", 0), (t1, t2) -> Tuple.of(t1._1 + t2._1, t1._2 + t2._2));
    assertThat(result)
        .isEqualTo(List.of(Tuple.of("z", 0), Tuple.of("zone", 1), Tuple.of("zonetwo", 3)));
  }
  ...
  public void shouldCreateKeyComparatorForJavaUtilMap() {
    final TreeMap<String, Integer> actual =
        TreeMap.ofAll(
            mapOfTuples(Tuple.of("c", 0), Tuple.of("a", 0), Tuple.of("b", 0)).toJavaMap());
  ...
  public void shouldReturnATreeMapWithCorrectComparatorWhenFlatMappingToEmpty() {
    ...
    final TreeMap<Integer, String> actual =
        testee.flatMap(Comparator.reverseOrder(), (k, v) -> List.empty());
  ...
  public void shouldReturnModifiedKeysMapWithNonUniqueMapperAndPredictableOrder() {
    final TreeMap<Integer, String> actual =
        TreeMap.of(3, "3", 1, "1", 2, "2").mapKeys(Integer::toHexString).mapKeys(String::length);
