...
public class TreeTest extends AbstractTraversableTest {
    ...
    return new IterableAssert<T>(actual) {
      ...
      public IterableAssert<T> isEqualTo(Object expected) {
        if (actual instanceof Option) {
          ...
          TreeTest.super
              .assertThat(Stream.ofAll(actual))
              .isEqualTo(Stream.ofAll((Tree<?>) expected));
        } else {
      ...
      private Map<?, ?> convMap(Map<?, ?> map) {
        return map.map(
            (k, v) -> Tuple.of(k, v instanceof Iterable ? Stream.ofAll((Iterable<?>) v) : v));
      }
    };
  }
  ...
  @Override
  protected <T extends Comparable<? super T>> Tree<T> ofJavaStream(
                ...
                p == 0
                    ...
                    : p == 1
                        ...
                        : p == 2
                            ...
                            : p == 3
                                ? List.of(6)
                                : p == 4 ? List.of(7) : p == 6 ? List.of(8, 9) : List.empty());
  ...
  public void shouldBuildTreeFromFlatSource() {
    // List[(id, parent)]
    Iterable<Tuple2<Integer, Integer>> flatSourceOfTreeStructure =
        List.of(
            Tuple.of(1, null),
            Tuple.of(2, 1),
            Tuple.of(3, 1),
            ...
            Tuple.of(8, 6),
            Tuple.of(9, 6));
    List<Tree.Node<Tuple2<Integer, Integer>>> roots =
        Tree.build(flatSourceOfTreeStructure, Tuple2::_1, Tuple2::_2);
  ...
  public void shouldBuildEmptyRootListFromFlatSourceWithoutRoot() {
    // List[(id, parent)]
    Iterable<Tuple2<Integer, Integer>> flatSourceOfTreeStructure =
        List.of(Tuple.of(1, 1), Tuple.of(2, 1), Tuple.of(3, 1));
    List<Tree.Node<Tuple2<Integer, Integer>>> roots =
        Tree.build(flatSourceOfTreeStructure, Tuple2::_1, Tuple2::_2);
  ...
  public void shouldInstantiateTreeBranchWithOf() {
    ...
    final Tree<Integer> expected =
        new Tree.Node<>(
            1, List.of(new Tree.Node<>(2, List.empty()), new Tree.Node<>(3, List.empty())));
  ...
  public void shouldFlatMapNonEmptyInTheRightOrder() {
    ...
    final Tree<Integer> actualInts =
        $(0, $(1), $(2)).flatMap(ignored -> of(seq.getAndIncrement(), seq.getAndIncrement()));
  ...
  public void shouldMapTree() {
    assertThat(tree.map(i -> (char) (i + 64)).toLispString())
        .isEqualTo("(A (B (D G) E) (C (F H I)))");
  }
  ...
  public void shouldUnzipEmptyTree() {
    assertThat(Tree.empty().unzip(t -> Tuple.of(t, t)))
        .isEqualTo(Tuple.of(Tree.empty(), Tree.empty()));
  }
  ...
  public void shouldUnzipNonEmptyTree() {
    ...
    final Tuple2<Tree<Integer>, Tree<Integer>> expected =
  ...
  public void shouldUnzip3EmptyTree() {
    assertThat(Tree.empty().unzip3(t -> Tuple.of(t, t, t)))
        .isEqualTo(Tuple.of(Tree.empty(), Tree.empty(), Tree.empty()));
  }

  @Test
  public void shouldUnzip3NonEmptyTree() {
    final Tree<Integer> testee = $(1, $(2), $(3));
    final Tuple3<Tree<Integer>, Tree<Integer>, Tree<Integer>> actual =
        testee.unzip3(i -> Tuple.of(i, -i, -i - 1));
    final Tuple3<Tree<Integer>, Tree<Integer>, Tree<Integer>> expected =
        Tuple.of($(1, $(2), $(3)), $(-1, $(-2), $(-3)), $(-2, $(-3), $(-4)));
    assertThat(actual).isEqualTo(expected);
  }
