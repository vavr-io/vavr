...
public class PriorityQueueTest extends AbstractTraversableTest {
  private final io.vavr.collection.List<Integer> values =
  ...
  protected <T> PriorityQueue<T> of(T element) {
    return PriorityQueue.ofAll(
        Comparators.naturalComparator(), io.vavr.collection.List.of(element));
  }
  ...
  protected final <T> PriorityQueue<T> of(T... elements) {
    return PriorityQueue.ofAll(
        Comparators.naturalComparator(), io.vavr.collection.List.of(elements));
  }
  ...
  @Override
  protected <T extends Comparable<? super T>> Traversable<T> ofJavaStream(
