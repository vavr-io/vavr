...
public class TreeMultimapTest extends AbstractMultimapTest {
  ...
  @SafeVarargs
  @Override
  protected final <K extends Comparable<K>, V> TreeMultimap<K, V> mapOfTuples(
  ...
  @SafeVarargs
  @Override
  protected final <K extends Comparable<K>, V> TreeMultimap<K, V> mapOfEntries(
  ...
  @Override
  protected <K extends Comparable<K>, V> TreeMultimap<K, V> mapOfPairs(
  ...
  @Override
  protected <K extends Comparable<? super K>, V> TreeMultimap<K, V> mapOf(
  ...
  @Override
  protected <T, K extends Comparable<? super K>, V> TreeMultimap<K, V> mapOf(
  ...
  @Override
  protected <K extends Comparable<K>, V> TreeMultimap<K, V> mapTabulate(
  ...
  @Override
  protected <K extends Comparable<K>, V> TreeMultimap<K, V> mapFill(
  ...
  public void shouldReturnJavaMapSortedUsingSameComparator() {
    final TreeMultimap<String, String> vavrMap =
        TreeMultimap.withSeq().of(Comparator.comparing(String::length), "aa", "aa", "b", "b");
  ...
  public void shouldNarrowMap() {
    final TreeMultimap<Integer, Number> int2doubleMap =
        (TreeMultimap<Integer, Number>) this.<Integer, Number>emptyMap().put(1, 1.0d);
