...
public class Euler34Test {
   ...
   *
   * <p>F Note: as 1! = 1 and 2! = 2 are not sums they are not included.
   *
   * <p>See also <a href="https://projecteuler.net/problem=34">projecteuler.net problem 34</a>.
   */
  @Test
  ...
  private static int sumOfOfAllNumbersWhichAreEqualToSumOfDigitFactorial() {
    return Stream.rangeClosed(
            3,
            2_540_160) // 9! * 7 = 2 540 160 is a seven digit number, as is 9! * 8, therefore 9! * 7
        // is the definitive upper limit we have to investigate.
