...
public class Euler15Test {
   ...
   *
   * <p>Starting in the top left corner of a 2x2 grid, and only being able to move to the right and
   * down, there are exactly 6 routes to the bottom right corner.
   *
   * <p>How many such routes are there through a 20×20 grid?
   *
   * <p>See also <a href="https://projecteuler.net/problem=15">projecteuler.net problem 15</a>.
   */
  @Test
