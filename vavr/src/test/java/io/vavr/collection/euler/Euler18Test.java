...
public class Euler18Test {
   ...
   * That is, 3 + 7 + 4 + 9 = 23.
   *
   * <p>Find the maximum total from top to bottom in p018_triangle.txt.
   *
   ...
   *
   * <p>See also <a href="https://projecteuler.net/problem=18">projecteuler.net problem 18</a>.
   */
  @Test
  ...
  private static final Function3<Vector<Vector<Integer>>, Integer, Integer, Integer> naive =
      Function3.of(
          (Vector<Vector<Integer>> tr, Integer row, Integer col) -> {
            ...
            if (row == tr.length() - 1) {
              ...
              return value
                  + Math.max(
                      Euler18Test.naive.apply(tr, row + 1, col),
                      Euler18Test.naive.apply(tr, row + 1, col + 1));
            }
          });
}
