...
public class Euler32Test {
   ...
   *
   * <p>Find the sum of all products whose multiplicand/multiplier/product identity can be written
   * as a 1 through 9 pandigital.
   *
   * <p>HINT: Some products can be obtained in more than one way so be sure to only include it once
   * in your sum.
   *
   * <p>See also <a href="https://projecteuler.net/problem=32">projecteuler.net problem 32</a>.
   */
  @Test
                    ...
                    .flatMap(
                        multiplicand ->
                            DIGITS_1_9
                                ...
                                .map(
                                    multiplier ->
                                        Tuple.of(multiplicand.mkString(), multiplier.mkString()))))
