 ...
 * digits.
 *
 * <p>See also <a href="https://projecteuler.net/problem=30">projecteuler.net problem 30 </a>.
 */
public class Euler30Test {
  ...
  public void shouldSolveProblem26() {
    ...
    assertThat(sumOfAllTheNumbersThatCanBeWrittenAsTheSumOfPowersOfTheirDigits(5))
        .isEqualTo(443_839);
  }
