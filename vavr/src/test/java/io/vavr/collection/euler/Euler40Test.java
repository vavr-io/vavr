...
public class Euler40Test {
   ...
   *
   * <p>0.12345678910<b>1</b>112131415161718192021...
   *
   * <p>It can be seen that the 12<sup>th</sup> digit of the fractional part is 1.
   *
   * <p>If <i>d</i><sub>n</sub> represents the <i>n</i><sup>th</sup> digit of the fractional part,
   ...
   * </pre>
   *
   * <p>See also <a href="https://projecteuler.net/problem=40">projecteuler.net problem 40</a>.
   */
  @Test
  ...
  private static final Stream<Character> FIRST_1_000_000_DECIMALS =
      Stream.from(1).map(i -> i.toString()).flatMap(CharSeq::of).take(1_000_000);
}
