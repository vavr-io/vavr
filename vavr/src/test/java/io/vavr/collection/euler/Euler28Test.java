 ...
 * way?
 *
 * <p>See also <a href="https://projecteuler.net/problem=28">projecteuler.net problem 28 </a>.
 */
public class Euler28Test {
  ...
  private static Stream<Long> nextRoundOfCorners(long previousCorner, int currentSideLength) {
    return Stream.iterate(previousCorner, n -> n + currentSideLength - 1).drop(1).take(4);
  }
}
