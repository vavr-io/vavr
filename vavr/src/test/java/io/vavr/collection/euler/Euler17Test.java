...
public class Euler17Test {
   ...
   *
   * <p>If all the numbers from 1 to 1000 (one thousand) inclusive were written out in words, how
   * many letters would be used?
   *
   * <p>NOTE: Do not count spaces or hyphens. For example, 342 (three hundred and forty-two)
  ...
  static final Map<Integer, String> LENGTHS =
      List.of(
              1, "one",
              2, "two",
              3, "three",
