 ...
 *
 * <p>Fn = Fn−1 + Fn−2, where F1 = 1 and F2 = 1. Hence the first 12 terms will be:
 *
 * <pre>
 * F1 = 1
 * F2 = 1
 ...
 *
 * <p>See also <a href="https://projecteuler.net/problem=25">projecteuler.net problem 25</a>.
 */
public class Euler25Test {
  ...
  private static int firstFibonacciTermContaining(int digits) {
    return fibonacci().zipWithIndex().find(t -> t._1.toString().length() == digits).get()._2;
  }
}
