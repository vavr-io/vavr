...
public class Euler09Test {
   ...
   *
   * <p>A Pythagorean triplet is a set of three natural numbers, a < b < c, for which, a<sup>2</sup>
   * + b<sup>2</sup> = c<sup>2</sup>
   *
   * <p>For example, 3<sup>2</sup> + 4<sup>2</sup> = 9 + 16 = 25 = 5<sup>2</sup>.
   *
   * <p>There exists exactly one Pythagorean triplet for which a + b + c = 1000. Find the product
   * abc.
   *
   * <p>See also <a href="https://projecteuler.net/problem=9">projecteuler.net problem 9</a>.
   */
  @Test
