...
public class Euler45Test {
   ...
   *
   * <p>It can be verified that T285 = P165 = H143 = 40755. Find the next triangle number that is
   * also pentagonal and hexagonal. See also <a
   * href="https://projecteuler.net/problem=45">projecteuler.net problem 45</a>.
   */
  @Test
