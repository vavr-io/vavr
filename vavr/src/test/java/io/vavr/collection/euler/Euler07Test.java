...
public class Euler07Test {
   ...
   *
   * <p>By listing the first six prime numbers: 2, 3, 5, 7, 11, and 13, we can see that the 6th
   * prime is 13.
   *
   * <p>What is the 10 001st prime number?
   *
   * <p>See also <a href="https://projecteuler.net/problem=7">projecteuler.net problem 7</a>.
   */
  @Test
