...
public class Euler57Test {
   ...
   *
   * <p>It is possible to show that the square root of two can be expressed as an infinite continued
   * fraction.
   *
   ...
   * <ul>
   *   <li>1 + 1/2 = 3/2 = 1.5
   *   <li>1 + 1/(2 + 1/2) = 7/5 = 1.4
   *   <li>1 + 1/(2 + 1/(2 + 1/2)) = 17/12 = 1.41666...
   *   <li>1 + 1/(2 + 1/(2 + 1/(2 + 1/2))) = 41/29 = 1.41379...
   * </ul>
   *
   ...
   * in the denominator.
   *
   * <p>In the first one-thousand expansions, how many fractions contain a numerator with more
   * digits than denominator?
   *
   * <p>See also <a href="https://projecteuler.net/problem=57">projecteuler.net problem 57</a>.
   */
  @Test
