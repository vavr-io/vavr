...
public class Euler14Test {
   ...
   *
   * <p>See also <a href="https://projecteuler.net/problem=14">projecteuler.net problem 14</a>.
   */
  @Test
  public void shouldSolveProblem14() {
    // equivalent to from(1L).take(1_000_000)
    Assertions.assertThat(Stream.from(500_000L).take(500_000).maxBy(collatzSequenceLength).get())
        .isEqualTo(837799);
  }

  private static final Function1<Long, Long> collatzRecursive =
      n -> {
        if (n == 1) {
          return 1L;
        } else {
  ...
  private static final Function1<Long, Long> collatzSequenceLength = collatzRecursive.memoized();
}
