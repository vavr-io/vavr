 ...
 * <p>n² + n + 41
 *
 * <p>It turns out that the formula will produce 40 primes for the consecutive values n = 0 to 39.
 * However, when n = 40, 40^2 + 40 + 41 = 40(40 + 1) + 41 is divisible by 41, and certainly when n =
 * 41, 41² + 41 + 41 is clearly divisible by 41.
 *
 * <p>The incredible formula n² − 79n + 1601 was discovered, which produces 80 primes for the
 ...
 *
 * <p>where |n| is the modulus/absolute value of n e.g. |11| = 11 and |−4| = 4
 *
 * <p>Find the product of the coefficients, a and b, for the quadratic expression that produces the
 * maximum number of primes for consecutive values of n, starting with n = 0.
 *
 * <p>See also <a href="https://projecteuler.net/problem=27">projecteuler.net problem 27 </a>.
 */
public class Euler27Test {
  ...
  private static int productOfCoefficientsWithMostConsecutivePrimes(
    ...
    final List<Integer> coefficients =
        List.rangeClosed(coefficientsLowerBound, coefficientsUpperBound);
        ...
        .map(
            c ->
                Tuple.of(
                    c._1,
                    c._2,
                    numberOfConsecutivePrimesProducedByFormulaWithCoefficients(c._1, c._2)))
