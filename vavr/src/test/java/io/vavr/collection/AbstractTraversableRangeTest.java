...
public abstract class AbstractTraversableRangeTest extends AbstractTraversableTest {
  ...
  protected abstract Traversable<Character> range(char from, char toExclusive);

  protected abstract Traversable<Character> rangeBy(char from, char toExclusive, int step);

  protected abstract Traversable<Double> rangeBy(double from, double toExclusive, double step);

  protected abstract Traversable<Integer> range(int from, int toExclusive);

  protected abstract Traversable<Integer> rangeBy(int from, int toExclusive, int step);

  protected abstract Traversable<Long> range(long from, long toExclusive);

  protected abstract Traversable<Long> rangeBy(long from, long toExclusive, long step);

  protected abstract Traversable<Character> rangeClosed(char from, char toInclusive);

  protected abstract Traversable<Character> rangeClosedBy(char from, char toInclusive, int step);

  protected abstract Traversable<Double> rangeClosedBy(
      double from, double toInclusive, double step);

  protected abstract Traversable<Integer> rangeClosed(int from, int toInclusive);

  protected abstract Traversable<Integer> rangeClosedBy(int from, int toInclusive, int step);

  protected abstract Traversable<Long> rangeClosed(long from, long toInclusive);

  protected abstract Traversable<Long> rangeClosedBy(long from, long toInclusive, long step);
  ...
  public void shouldCreateRangeClosedWhereFromAndToEqualMIN_VALUE() {
    assertThat(rangeClosed(Character.MIN_VALUE, Character.MIN_VALUE))
  ...
  public void shouldCreateRangeClosedWhereFromAndToEqualMAX_VALUE() {
    assertThat(rangeClosed(Character.MAX_VALUE, Character.MAX_VALUE))
  ...
  public void shouldCreateRangeClosedByWhereFromIsLessThanToAndStepCorrectDirection() {
    ...
    assertThat(rangeClosedBy(Long.MAX_VALUE - 2, Long.MAX_VALUE, 3))
        .isEqualTo(of(Long.MAX_VALUE - 2));
    ...
    assertThat(rangeClosedBy(Long.MIN_VALUE + 2, Long.MIN_VALUE, -3))
        .isEqualTo(of(Long.MIN_VALUE + 2));
  ...
  public void shouldCreateRangeClosedByWhereFromAndToEqualMIN_VALUE() {
    ...
    // double
    assertThat(rangeClosedBy(-Double.MAX_VALUE, -Double.MAX_VALUE, 1))
        .isEqualTo(of(-Double.MAX_VALUE));
    assertThat(rangeClosedBy(-Double.MAX_VALUE, -Double.MAX_VALUE, 3))
        .isEqualTo(of(-Double.MAX_VALUE));
    assertThat(rangeClosedBy(-Double.MAX_VALUE, -Double.MAX_VALUE, -1))
        .isEqualTo(of(-Double.MAX_VALUE));
    assertThat(rangeClosedBy(-Double.MAX_VALUE, -Double.MAX_VALUE, -3))
    ...
    // int
    assertThat(rangeClosedBy(Integer.MIN_VALUE, Integer.MIN_VALUE, 1))
        .isEqualTo(of(Integer.MIN_VALUE));
    assertThat(rangeClosedBy(Integer.MIN_VALUE, Integer.MIN_VALUE, 3))
        .isEqualTo(of(Integer.MIN_VALUE));
    assertThat(rangeClosedBy(Integer.MIN_VALUE, Integer.MIN_VALUE, -1))
        .isEqualTo(of(Integer.MIN_VALUE));
    assertThat(rangeClosedBy(Integer.MIN_VALUE, Integer.MIN_VALUE, -3))
  ...
  public void shouldCreateRangeClosedByWhereFromAndToEqualMAX_VALUE() {
    ...
    // int
    assertThat(rangeClosedBy(Integer.MAX_VALUE, Integer.MAX_VALUE, 1))
        .isEqualTo(of(Integer.MAX_VALUE));
    assertThat(rangeClosedBy(Integer.MAX_VALUE, Integer.MAX_VALUE, 3))
        .isEqualTo(of(Integer.MAX_VALUE));
    assertThat(rangeClosedBy(Integer.MAX_VALUE, Integer.MAX_VALUE, -1))
        .isEqualTo(of(Integer.MAX_VALUE));
    assertThat(rangeClosedBy(Integer.MAX_VALUE, Integer.MAX_VALUE, -3))
  ...
  public void shouldCreateRangeByWhereFromIsLessThanToAndStepCorrectDirection() {
    ...
    assertThat(rangeBy(Integer.MAX_VALUE - 3, Integer.MAX_VALUE, 3))
        .isEqualTo(of(Integer.MAX_VALUE - 3));
    assertThat(rangeBy(Integer.MAX_VALUE - 4, Integer.MAX_VALUE, 3))
        .isEqualTo(of(Integer.MAX_VALUE - 4, Integer.MAX_VALUE - 1));
    assertThat(rangeBy(Integer.MIN_VALUE + 3, Integer.MIN_VALUE, -3))
        .isEqualTo(of(Integer.MIN_VALUE + 3));
