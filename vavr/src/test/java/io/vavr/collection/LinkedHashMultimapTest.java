...
public class LinkedHashMultimapTest extends AbstractMultimapTest {
  ...
  @SafeVarargs
  @Override
  protected final <K extends Comparable<K>, V> LinkedHashMultimap<K, V> mapOfTuples(
  ...
  @SafeVarargs
  @Override
  protected final <K extends Comparable<K>, V> LinkedHashMultimap<K, V> mapOfEntries(
  ...
  @Override
  protected <K extends Comparable<K>, V> LinkedHashMultimap<K, V> mapOfPairs(
    ...
    switch (containerType) {
      ...
      case SORTED_SET:
        return LinkedHashMultimap.withSortedSet(Comparators.naturalComparator())
  ...
  @Override
  protected <K extends Comparable<? super K>, V> LinkedHashMultimap<K, V> mapOf(
  ...
  @Override
  protected <T, K extends Comparable<? super K>, V> LinkedHashMultimap<K, V> mapOf(
  ...
  @Override
  protected <K extends Comparable<K>, V> LinkedHashMultimap<K, V> mapTabulate(
  ...
  @Override
  protected <K extends Comparable<K>, V> LinkedHashMultimap<K, V> mapFill(
  ...
  @Override
  protected <K extends Comparable<K>, V> Multimap<K, V> mapFill(
  ...
  public void shouldNarrowMap() {
    final LinkedHashMultimap<Integer, Number> int2doubleMap =
        (LinkedHashMultimap<Integer, Number>) this.<Integer, Number>emptyMap().put(1, 1.0d);
    final LinkedHashMultimap<Number, Number> number2numberMap =
        LinkedHashMultimap.narrow(int2doubleMap);
    final int actual =
