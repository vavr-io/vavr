...
public class HashSetTest extends AbstractSetTest {
    ...
    return new IterableAssert<T>(actual) {
      ...
      public IterableAssert<T> isEqualTo(Object obj) {
        ...
        actualMap
            .keySet()
            .forEach(
                k -> HashSetTest.super.assertThat(actualMap.get(k)).isEqualTo(expectedMap.get(k)));
        return this;
      }
  ...
  public void shouldZipNonNilsOfSameSize() {
    ...
    final HashSet<Tuple2<Integer, String>> expected =
  ...
  public void shouldZipNonNilWithIndex() {
    ...
    final HashSet<Tuple2<String, Integer>> expected =
  ...
  public void shouldMkStringWithDelimiterAndPrefixAndSuffixNonNil() {
    ...
    final List<String> expected =
        List.of('a', 'b', 'c').permutations().map(l -> l.mkString("[", ",", "]"));
    assertThat(actual).isIn(expected);
  }
