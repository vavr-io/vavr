...
public class TryTest extends AbstractValueTest {
  ...
  public void shouldCreateSuccessWhenCallingTryRunRunnable() {
    assertThat(Try.runRunnable(() -> {}) instanceof Try.Success).isTrue();
  }
  ...
  public void shouldThrowNullPointerExceptionWhenCallingTryRunRunnable() {
    assertThatThrownBy(() -> Try.runRunnable(null))
        .isInstanceOf(NullPointerException.class)
        .hasMessage("runnable is null");
  }
  ...
  public void shouldCreateSuccessTryWithResources2() {
    ...
    final Try<String> actual =
        Try.withResources(() -> closeable1, () -> closeable2)
  ...
  public void shouldCreateSuccessTryWithResources3() {
    ...
    final Try<String> actual =
        Try.withResources(() -> closeable1, () -> closeable2, () -> closeable3)
  ...
  public void shouldCreateSuccessTryWithResources4() {
    ...
    final Try<String> actual =
        Try.withResources(() -> closeable1, () -> closeable2, () -> closeable3, () -> closeable4)
  ...
  public void shouldCreateSuccessTryWithResources6() {
    ...
    final Try<String> actual =
        Try.withResources(
            ...
            .of(
                (i1, i2, i3, i4, i5, i6) ->
                    "" + i1.value + i2.value + i3.value + i4.value + i5.value + i6.value);
        ...
        Try.withResources(
            ...
            .of(
                (i1, i2, i3, i4, i5, i6, i7, i8) ->
                    "" + i1.value + i2.value + i3.value + i4.value + i5.value + i6.value + i7.value
                        + i8.value);
  ...
  public void shouldCreateFailureOnNonFatalException() {
    assertThat(failure().failed().get().getClass().getName())
  ...
  public void shouldNotTryToRecoverWhenItIsNotNeeded() {
    assertThat(Try.of(() -> OK).recoverWith(RuntimeException.class, x -> failure()).get())
        .isEqualTo(OK);
  }
  ...
  public void shouldReturnRecoveredValue() {
    assertThat(
            Try.of(
                ...
                .recoverWith(RuntimeException.class, x -> success())
                .get())
        .isEqualTo(OK);
  }
  ...
  public void shouldReturnRecoveredValueOnFailure() {
    assertThat(
            Try.of(
                ...
                .recoverWith(IllegalStateException.class, success())
                .get())
        .isEqualTo(OK);
  }
  ...
  public void shouldNotRecoverFailureWhenExceptionTypeIsntAssignable() {
    ...
    assertThat(
            Try.of(
                ...
                .recoverWith(Error.class, success())
                .getCause())
        .isSameAs(error);
  }
  ...
  public void shouldRecoverFailure() {
    assertThat(failure().recoverAllAndTry(() -> OK)).isEqualTo(Try.success(OK));
  }
  ...
  public void shouldNotRecoverSuccess() {
    ...
    assertThat(Try.success(initialValue).recoverAllAndTry(() -> attemptValue))
  ...
  public void shouldRecoverCorrectTypeOfFailure() {
    assertThat(Try.failure(new RuntimeException()).recoverAndTry(RuntimeException.class, () -> OK))
  ...
  public void shouldNotRecoverIncorrectTypeOfFailure() {
    ...
    assertThat(initialFailure.recoverAndTry(IllegalStateException.class, () -> OK))
  ...
  public void shouldNotRecoverSuccessForRecoverAndTry() {
    final String initialValue = "INITIAL";
    final String attemptValue = "RECOVERY";
    assertThat(Try.success(initialValue).recoverAndTry(Throwable.class, () -> attemptValue))
        .isEqualTo(Try.success(initialValue));
  }
  ...
  @Test
  public void
      shouldNotConsumeThrowableWhenCallingOnFailureWithNonMatchingExceptionTypeGivenFailure() {
  ...
  public void shouldConvertFailureToEitherUsingMapper() {
    Either<String, Object> converted = failure().toEither(exception -> "error string");
  ...
  public void shouldConvertSuccessToEitherUsingMapper() {
    Either<String, String> converted = success().toEither(exception -> "another error");
  ...
  public void shouldExecuteToEitherMapperLazilyOnlyWhenFailure() {
    Either<String, String> converted =
        success()
            .toEither(
                exception -> {
                  throw new RuntimeException();
    ...
    final Try<Integer> actual =
        testee.mapFailure(
            Case(
                ...
                (Function<RuntimeException, Error>) Error::new));
  ...
  public void shouldConvertFailureToString() {
    assertThat(Try.failure(error()).toString())
        .isEqualTo("Failure(java.lang.RuntimeException: error)");
  }
  ...
  public void shouldConvertListOfSuccessToTryOfList() {
    final List<Try<String>> tries =
        Arrays.asList(Try.success("a"), Try.success("b"), Try.success("c"));
  ...
  public void shouldConvertListOfMixedTryToTryOfList() {
    final Throwable t = new RuntimeException("failure");
    final List<Try<String>> tries =
        Arrays.asList(Try.success("a"), Try.failure(t), Try.success("c"));
    final Try<Seq<String>> reducedTry = Try.sequence(tries);
    assertThat(reducedTry instanceof Try.Failure).isTrue();
  }
  ...
  public void shouldTraverseListOfMixedTryToTryOfList() {
    final Throwable t = new RuntimeException("failure");
    final List<String> tries = Arrays.asList("a", "b", "c");
    final Try<Seq<String>> reducedTry =
        Try.traverse(tries, x -> x.equals("b") ? Try.failure(t) : Try.success(x));
    assertThat(reducedTry instanceof Try.Failure).isTrue();
  }
  ...
  public void shouldFilterMatchingPredicateWithErrorProviderOnSuccess() {
    assertThat(success().filter(s -> true, s -> new IllegalArgumentException(s)).get())
        .isEqualTo(OK);
  }
