...
public interface Function7<T1, T2, T3, T4, T5, T6, T7, R> extends Serializable {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, R> Function7<T1, T2, T3, T4, T5, T6, T7, R> of(@NonNull Function7<T1, T2, T3, T4, T5, T6, T7, R> methodReference) {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, R> Function7<T1, T2, T3, T4, T5, T6, T7, Option<R>> lift(@NonNull Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> partialFunction) {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, R> Function7<T1, T2, T3, T4, T5, T6, T7, Try<R>> liftTry(@NonNull Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> partialFunction) {
     ...
     */
    default <V> Function7<T1, T2, T3, T4, T5, T6, T7, V> andThen(@NonNull Function<? super R, ? extends V> after) {
     ...
     */
    default <S> Function7<S, T2, T3, T4, T5, T6, T7, R> compose1(@NonNull Function1<? super S, ? extends T1> before) {
     ...
     * @throws NullPointerException if before is null
     */
    default <S> Function7<T1, S, T3, T4, T5, T6, T7, R> compose2(@NonNull Function1<? super S, ? extends T2> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> Function7<T1, T2, S, T4, T5, T6, T7, R> compose3(@NonNull Function1<? super S, ? extends T3> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> Function7<T1, T2, T3, S, T5, T6, T7, R> compose4(@NonNull Function1<? super S, ? extends T4> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> Function7<T1, T2, T3, T4, S, T6, T7, R> compose5(@NonNull Function1<? super S, ? extends T5> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> Function7<T1, T2, T3, T4, T5, S, T7, R> compose6(@NonNull Function1<? super S, ? extends T6> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> Function7<T1, T2, T3, T4, T5, T6, S, R> compose7(@NonNull Function1<? super S, ? extends T7> before) {
        Objects.requireNonNull(before, "before is null");
