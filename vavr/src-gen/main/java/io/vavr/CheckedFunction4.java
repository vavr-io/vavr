...
public interface CheckedFunction4<T1, T2, T3, T4, R> extends Serializable {
     ...
     */
    static <T1, T2, T3, T4, R> CheckedFunction4<T1, T2, T3, T4, R> of(@NonNull CheckedFunction4<T1, T2, T3, T4, R> methodReference) {
     ...
     */
    static <T1, T2, T3, T4, R> Function4<T1, T2, T3, T4, Option<R>> lift(@NonNull CheckedFunction4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> partialFunction) {
     ...
     */
    static <T1, T2, T3, T4, R> Function4<T1, T2, T3, T4, Try<R>> liftTry(@NonNull CheckedFunction4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> partialFunction) {
     ...
     */
    default Function4<T1, T2, T3, T4, R> recover(@NonNull Function<? super Throwable, ? extends Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R>> recover) {
     ...
     */
    default <V> CheckedFunction4<T1, T2, T3, T4, V> andThen(@NonNull CheckedFunction1<? super R, ? extends V> after) {
     ...
     */
    default <S> CheckedFunction4<S, T2, T3, T4, R> compose1(@NonNull Function1<? super S, ? extends T1> before) {
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction4<T1, S, T3, T4, R> compose2(@NonNull Function1<? super S, ? extends T2> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction4<T1, T2, S, T4, R> compose3(@NonNull Function1<? super S, ? extends T3> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction4<T1, T2, T3, S, R> compose4(@NonNull Function1<? super S, ? extends T4> before) {
        Objects.requireNonNull(before, "before is null");
