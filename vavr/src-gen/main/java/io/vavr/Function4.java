...
public interface Function4<T1, T2, T3, T4, R> extends Serializable {
     ...
     */
    static <T1, T2, T3, T4, R> Function4<T1, T2, T3, T4, R> of(@NonNull Function4<T1, T2, T3, T4, R> methodReference) {
     ...
     */
    static <T1, T2, T3, T4, R> Function4<T1, T2, T3, T4, Option<R>> lift(@NonNull Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> partialFunction) {
     ...
     */
    static <T1, T2, T3, T4, R> Function4<T1, T2, T3, T4, Try<R>> liftTry(@NonNull Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> partialFunction) {
     ...
     */
    default <V> Function4<T1, T2, T3, T4, V> andThen(@NonNull Function<? super R, ? extends V> after) {
     ...
     */
    default <S> Function4<S, T2, T3, T4, R> compose1(@NonNull Function1<? super S, ? extends T1> before) {
     ...
     * @throws NullPointerException if before is null
     */
    default <S> Function4<T1, S, T3, T4, R> compose2(@NonNull Function1<? super S, ? extends T2> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> Function4<T1, T2, S, T4, R> compose3(@NonNull Function1<? super S, ? extends T3> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> Function4<T1, T2, T3, S, R> compose4(@NonNull Function1<? super S, ? extends T4> before) {
        Objects.requireNonNull(before, "before is null");
