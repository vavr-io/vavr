...
public interface CheckedFunction8<T1, T2, T3, T4, T5, T6, T7, T8, R> extends Serializable {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, R> CheckedFunction8<T1, T2, T3, T4, T5, T6, T7, T8, R> of(@NonNull CheckedFunction8<T1, T2, T3, T4, T5, T6, T7, T8, R> methodReference) {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function8<T1, T2, T3, T4, T5, T6, T7, T8, Option<R>> lift(@NonNull CheckedFunction8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> partialFunction) {
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function8<T1, T2, T3, T4, T5, T6, T7, T8, Try<R>> liftTry(@NonNull CheckedFunction8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> partialFunction) {
     ...
     */
    default Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> recover(@NonNull Function<? super Throwable, ? extends Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R>> recover) {
     ...
     */
    default <V> CheckedFunction8<T1, T2, T3, T4, T5, T6, T7, T8, V> andThen(@NonNull CheckedFunction1<? super R, ? extends V> after) {
     ...
     */
    default <S> CheckedFunction8<S, T2, T3, T4, T5, T6, T7, T8, R> compose1(@NonNull Function1<? super S, ? extends T1> before) {
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction8<T1, S, T3, T4, T5, T6, T7, T8, R> compose2(@NonNull Function1<? super S, ? extends T2> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction8<T1, T2, S, T4, T5, T6, T7, T8, R> compose3(@NonNull Function1<? super S, ? extends T3> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction8<T1, T2, T3, S, T5, T6, T7, T8, R> compose4(@NonNull Function1<? super S, ? extends T4> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction8<T1, T2, T3, T4, S, T6, T7, T8, R> compose5(@NonNull Function1<? super S, ? extends T5> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction8<T1, T2, T3, T4, T5, S, T7, T8, R> compose6(@NonNull Function1<? super S, ? extends T6> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction8<T1, T2, T3, T4, T5, T6, S, T8, R> compose7(@NonNull Function1<? super S, ? extends T7> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S> CheckedFunction8<T1, T2, T3, T4, T5, T6, T7, S, R> compose8(@NonNull Function1<? super S, ? extends T8> before) {
        Objects.requireNonNull(before, "before is null");
